...
<h5>Instructions</h5>
Please start by completing the 3 first steps of the instructions in <code><a href=\"modelica://OpenIPSL.Data.PowerPlant.GenerationGroup.Generator1\">GenerationGroup.Generator1</a></code>. A <code>OpenIPSL.Data.PowerPlant.GUDynamics</code> record must be dragged and dropped into that model and its <code>GUnitDynamics</code> parameter must be propagated before continuing with the following steps:
<ol>
<li>Open the parameter window of the generation group component.</li>
<li>Choose the appropriate parameter data set for the generating unit dynamics from the <code>GUnitDynamics</code> dropdown list. To do this, double-click the <code>generator1</code> component. Then, expand the drop-down list of the <code>GUnitDynamics</code> parameter. Finally, choose the <em>IEEE421.5 ST1A Type Excitation System Model Data Set 1</em> option.</li>
...
<li>Go back to the instructions in <code><a href=\"modelica://OpenIPSL.Data.PowerPlant.GenerationGroup.Generator1\">GenerationGroup.Generator1</a></code> and follow step 4.</li>
</ol>
<h5>Source</h5>
<ul>

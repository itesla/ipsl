...
<p>This system is tests the fourth order machine with a type 3 AVR, from PSAT. Simulate the system for 20 seconds using the <code>Rkfix2</code> integrator.</p>

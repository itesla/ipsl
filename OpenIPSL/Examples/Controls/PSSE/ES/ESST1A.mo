...
equation
  ...
  connect(eSST1A.EFD, gENROE.EFD) annotation (Line(points={{-86.7,-45.5556},{-112,
          -45.5556},{-112,-10},{-99.6,-10}}, color={0,0,127}));
  connect(gENROE.ETERM, eSST1A.ECOMP) annotation (Line(points={{-58.4,10},{-52,
          10},{-52,-45.5556},{-58,-45.5556}}, color={0,0,127}));
  ...
  connect(eSST1A.EFD0, gENROE.EFD0) annotation (Line(points={{-58,-54.9444},{-50,
          -54.9444},{-50,-14},{-58.4,-14}}, color={0,0,127}));

...
model IEEEX1 "SMIB system with one load and GENROE model"
  ...
  Modelica.Blocks.Sources.Constant const(k=0) annotation (Placement(transformation(extent={{-30,-58},{-40,-48}})));
...
equation
  ...
  connect(iEEEX1_1.VOTHSG, const.y) annotation (Line(points={{-68,-42.2778},{-48.1116,-42.2778},{-48.1116,-53},{-40.5,-53}}, color={0,0,127}));
  ...
  connect(iEEEX1_1.VOEL, const.y) annotation (Line(points={{-75.8,-60},{-48,-60},{-48,-53},{-40.5,-53}}, color={0,0,127}));
  connect(iEEEX1_1.VUEL, const.y) annotation (Line(points={{-72.2,-60},{-48,-60},{-48,-53},{-40.5,-53}}, color={0,0,127}));

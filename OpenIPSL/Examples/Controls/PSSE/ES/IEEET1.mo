...
equation
  ...
  connect(iEEET1.EFD, gENROE.EFD) annotation (Line(points={{-106.8,-43.5556},{-118,-43.5556},{-118,-10},{-112,-10}},
                                                 color={0,0,127}));
  connect(iEEET1.ECOMP, gENROE.ETERM) annotation (Line(points={{-74,-43.5556},{-58,-43.5556},{-58,-6},{-66,-6}},
                                             color={0,0,127}));
  connect(iEEET1.EFD0, gENROE.EFD0) annotation (Line(points={{-74,-52.9444},{-56,-52.9444},{-56,-10},{-66,-10}},
                                              color={0,0,127}));
  connect(iEEET1.VOTHSG, const.y) annotation (Line(points={{-74,-37.0556},{-55.3333,-37.0556},{-55.3333,-40},{-49,-40}},
                                               color={0,0,127}));
  ...
  connect(gENROE.XADIFD, iEEET1.XADIFD) annotation (Line(points={{-66.4,-18},{-62,-18},{-62,-66},{-97.2,-66},{-97.2,-57.7111}}, color={0,0,127}));
  annotation (

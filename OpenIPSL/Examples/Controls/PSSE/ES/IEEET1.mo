...
equation
  connect(gENROE.PMECH, gENROE.PMECH0) annotation (Line(points={{-107.6,10},{-118,
          10},{-118,26},{-56,26},{-56,-6},{-66.4,-6}}, color={0,0,127}));
  connect(iEEET2_1.EFD, gENROE.EFD) annotation (Line(points={{-106.8,-43.5556},
          {-118,-43.5556},{-118,-10},{-107.6,-10}}, color={0,0,127}));
  connect(iEEET2_1.ECOMP, gENROE.ETERM) annotation (Line(points={{-74,-43.5556},
          {-58,-43.5556},{-58,10},{-66.4,10}}, color={0,0,127}));
  connect(iEEET2_1.EFD0, gENROE.EFD0) annotation (Line(points={{-74,-52.9444},{
          -56,-52.9444},{-56,-14},{-66.4,-14}}, color={0,0,127}));
  ...
  connect(gENROE.p, GEN1.p)
    annotation (Line(points={{-66,0},{-54,0},{-40,0}}, color={0,0,255}));

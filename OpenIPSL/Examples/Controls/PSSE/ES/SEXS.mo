...
equation
  ...
  connect(gENROU.EFD0, sEXS.EFD0) annotation (Line(points={{-68,-10},{-60,-10},{-60,-48.5556},{-70,-48.5556}},
                                         color={0,0,127}));
  connect(gENROU.ETERM, sEXS.ECOMP) annotation (Line(points={{-68,-6},{-64,-6},{-64,-38.4444},{-70,-38.4444}},
                                         color={0,0,127}));
  ...
  connect(sEXS.EFD, gENROU.EFD) annotation (Line(points={{-108.95,-38.4444},{-114,-38.4444},{-114,-10},{-114,-10}},
                                            color={0,0,127}));
  connect(gENROU.p, GEN1.p)
    annotation (Line(points={{-70,0},{-40,0},{-40,0}}, color={0,0,255}));
  connect(gENROU.XADIFD, sEXS.XADIFD) annotation (Line(points={{-68.4,-18},{-62,-18},{-62,-60},{-97.55,-60},{-97.55,-53.6889}}, color={0,0,127}));
  annotation (

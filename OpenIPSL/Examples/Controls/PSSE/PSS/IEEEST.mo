...
equation
  connect(gENROE.PMECH, gENROE.PMECH0) annotation (Line(points={{-101.6,10},{-112,
          10},{-112,26},{-50,26},{-50,-6},{-60.4,-6}}, color={0,0,127}));
  connect(eSST1A.ECOMP, gENROE.ETERM) annotation (Line(points={{-58,-73.3333},{
          -54,-73.3333},{-54,10},{-60.4,10}}, color={0,0,127}));
  ...
  connect(iEEEST.V_CT, gENROE.ETERM) annotation (Line(points={{-95.7667,-35},{-102,
          -35},{-102,-28},{-54,-28},{-54,10},{-60.4,10}}, color={0,0,127}));
  connect(iEEEST.V_S, gENROE.PELEC) annotation (Line(points={{-95.7667,-41},{-102,
          -41},{-102,-52},{-56,-52},{-56,-10},{-60.4,-10}}, color={0,0,127}));
  ...
  connect(gENROE.p, GEN1.p)
    annotation (Line(points={{-60,0},{-50,0},{-40,0}}, color={0,0,255}));

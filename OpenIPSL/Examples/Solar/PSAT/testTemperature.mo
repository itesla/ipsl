...
model testTemperature
  ...
  OpenIPSL.Electrical.Solar.KTH.PFmodelmpptCorrected05MW PFmodel1(
    ...
    v0=1.0003436) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  inner OpenIPSL.Electrical.SystemBase SysData annotation (Placement(transformation(extent={{50,50},{70,70}})));
equation
  ...
  connect(const.y, PFmodel1.E)
    annotation (Line(
      ...
      points={{-35.7544,3.3007},{10.9182,3.3007},{10.9182,-3.3006},{13.9182,
          -3.3006}},
      color={0,0,127}));
  connect(PFmodel1.pwPin1, pwLine13.p) annotation (Line(
      visible=true,
      origin={32.2688,0.1454},
      points={{-29.2563,-0.1454},{9.7437,-0.1454},{9.7437,-0.143},{5.10213,
          -0.143}}));

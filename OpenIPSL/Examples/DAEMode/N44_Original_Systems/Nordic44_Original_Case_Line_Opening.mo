...
<p>Simulation of the Nordic 44 test system with line opening, which does not trigger a state event. The system is simulated using the DAE mode when in Dymola.</p>

...
model Nordic44_Base_Case_StateEvents
    ...
    OpenIPSL.Examples.DAEMode.N44_Base_Case_Systems.Generators.GenEventTest genEventTest(
    V_b=300000,
      v_0=PF_results.voltages.V5610,
      angle_0=PF_results.voltages.A5610,
    P_0=1500000000,
...
equation
    ...
    connect(twoWindingTransformer8.p, bus_5603.n[2])
      annotation (Line(points={{206.6,-72},{220,-72},{220,-76}},
                                                               color={0,0,255}));
...
<p>Compare with the results obtained in <strong>Nordic44_Base_Case_Bus_StateEvents2</strong>. Note that this test system takes a lot of time to simulate.</p>
</html>"),
    experiment(
      StopTime=5,
      Interval=0.001,

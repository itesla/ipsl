...
model IEEE13 "Initial conditions (power-flow) calculation of IEEE4 bus system, in full three-phase formulation"
  ...
  inner OpenIPSL.Electrical.SystemBase SysData(fn=60) annotation (Placement(
        ...
        origin={470,282},
        extent={{-12,-10},{12,10}})));
  Electrical.ThreePhase.Buses.InfiniteBus InfBus(
    P_A=1,
    P_B=1,
    P_C=1,
    Q_A=0,
    ...
    angle_A=0,
    angle_B=-120,
    angle_C=120) annotation (Placement(transformation(
        origin={38,88},
        extent={{-10,-10},{10,10}})));
  ...
  Electrical.ThreePhase.Buses.Bus_3Ph Bus671
    annotation (Placement(transformation(
        origin={364,88},
        extent={{-10,-10},{10,10}})));
  Electrical.ThreePhase.Branches.Lines.Line_3Ph L632_671(
    Bseraa=-0.5712,
    Bserab=0.2112,
    Bserac=0.1579,
    Bserbb=-0.5413,
    ...
    Gserbb=0.1735,
    Gserbc=-0.0219,
    Gsercc=0.1535) annotation (Placement(transformation(
        origin={272,88},
        extent={{-14,-10},{14,10}})));
  Electrical.ThreePhase.Buses.Bus_3Ph Bus633
    annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Electrical.ThreePhase.Branches.Lines.Line_3Ph L632_633(
    Bseraa=-1.2346,
    Bserab=0.2606,
    Bserac=0.2925,
    Bserbb=-1.2224,
    ...
    Gserbb=0.8495,
    Gserbc=-0.1883,
    Gsercc=0.8980) annotation (Placement(transformation(
        origin={204,144},
        extent={{-14,-10},{14,10}},
        rotation=90)));
  Electrical.ThreePhase.Loads.WyeLoad_3Ph SpotLoad634(
    ModelType=0,
    P_a=0.160,
    P_b=0.120,
    P_c=0.12,
    Q_a=0.110,
    Q_b=0.09,
    Q_c=0.09) annotation (Placement(transformation(
        origin={204,268},
        extent={{-10,-10},{10,10}},
        rotation=180)));
  Electrical.ThreePhase.Buses.Bus_3Ph Bus675
    annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Electrical.ThreePhase.Branches.Lines.Line_3Ph L692_675(
    Bseraa=-1.3443,
    Bserab=0.5197,
    Bserac=0.4255,
    Bserbb=-1.4001,
    ...
    Gserbb=1.9810,
    Gserbc=-0.4189,
    Gsercc=1.7857) annotation (Placement(transformation(
        origin={382,184},
        extent={{-14,-10},{14,10}},
        rotation=90)));
  Electrical.ThreePhase.Loads.WyeLoad_3Ph SpotLoad675(
    ModelType=0,
    P_a=0.485,
    P_b=0.068,
    P_c=0.290,
    Q_a=0.19,
    Q_b=0.06,
    Q_c=0.212) annotation (Placement(transformation(
        origin={382,256},
        extent={{-10,-10},{10,10}},
        rotation=180)));
  Electrical.ThreePhase.Loads.WyeLoad_3Ph DistLoad671(
    ModelType=0,
    P_a=0.0085,
    P_b=0.033,
    P_c=0.0585,
    Q_a=0.005,
    Q_b=0.019,
    Q_c=0.034) annotation (Placement(transformation(
        origin={310,50},
        extent={{-10,-10},{10,10}})));
  Electrical.ThreePhase.Loads.WyeLoad_3Ph DisLoad632(
    ModelType=0,
    P_a=0.0085,
    P_b=0.033,
    P_c=0.0585,
    ...
    Q_c=0.034) annotation (Placement(transformation(
        origin={226,50},
        extent={{-10,-10},{10,10}})));
  Electrical.ThreePhase.Banks.CapacitorBank_3Ph CapBank675(
    Q_a=0.2,
    Q_b=0.2,
    Q_c=0.2) annotation (Placement(transformation(
        origin={420,226},
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Electrical.ThreePhase.Buses.Bus_3Ph Bus634
    annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Electrical.ThreePhase.Branches.Transformer.Transformer_3Ph XFM1(
    Connection=0,
    R=2.2,
    X=4,
    tap=1) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  OpenIPSL.Electrical.Events.Breaker breaker annotation (Placement(transformation(
        origin={374,116},
        extent={{-4,-4},{4,4}},
        rotation=90)));
  OpenIPSL.Electrical.Events.Breaker breaker2 annotation (Placement(transformation(
        origin={382,122},
        extent={{-4,-4},{4,4}},
        rotation=90)));
  OpenIPSL.Electrical.Events.Breaker breaker3 annotation (Placement(transformation(
        origin={390,116},
        extent={{-4,-4},{4,4}},
        rotation=90)));
  Electrical.ThreePhase.Buses.Bus_3Ph Bus692
    annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Electrical.ThreePhase.Branches.Lines.Line_2Ph L632_645(
    Bseraa=-0.69,
    Bserab=0.1038,
    Bserbb=-0.6931,
    Gseraa=0.7502,
    Gserab=-0.25,
    Gserbb=0.7450) annotation (Placement(transformation(
        origin={166,48},
        extent={{-14,-10},{14,10}},
        rotation=-90)));
  Electrical.ThreePhase.Buses.Bus_2Ph Bus645(
    V_1=1,
    V_2=1,
    angle_1=-120,
    angle_2=120) annotation (Placement(transformation(
        origin={166,16},
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  Electrical.ThreePhase.Branches.Lines.Line_2Ph L645_646(
    Bseraa=-1.1499,
    Bserab=0.1729,
    Bserbb=-1.1552,
    Gseraa=1.2503,
    Gserab=-0.4167,
    Gserbb=1.2417) annotation (Placement(transformation(
        origin={166,-20},
        extent={{-14,-10},{14,10}},
        rotation=-90)));
  Electrical.ThreePhase.Buses.Bus_2Ph Bus646(
    V_1=1,
    V_2=1,
    angle_1=-120,
    angle_2=120) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  Electrical.ThreePhase.Loads.WyeLoad_1Ph SpotLoad645(
    AngA=-120,
    P_a=0.17,
    Q_a=0.125,
    VA=1) annotation (Placement(transformation(
        origin={200,6},
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Electrical.ThreePhase.Buses.Bus_3Ph Bus680
    annotation (Placement(transformation(
        origin={456,88},
        extent={{-10,-10},{10,10}})));
  Electrical.ThreePhase.Branches.Lines.Line_3Ph L671_680(
    Bseraa=-1.1424,
    Bserab=0.4224,
    Bserac=0.3157,
    Bserbb=-1.0825,
    ...
    Gserbb=0.3471,
    Gserbc=-0.0437,
    Gsercc=0.3069) annotation (Placement(transformation(
        origin={422,88},
        extent={{-14,-10},{14,10}})));
  Electrical.ThreePhase.Buses.Bus_2Ph Bus684(angle_2=120) annotation (Placement(
        transformation(
        origin={390,12},
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  Electrical.ThreePhase.Branches.Lines.Line_2Ph L671_684(
    Bseraa=-1.1552,
    Bserab=0.1729,
    Bserbb=-1.1499,
    Gseraa=1.2417,
    Gserab=-0.4167,
    Gserbb=1.2503) annotation (Placement(transformation(
        origin={390,44},
        extent={{-14,-10},{14,10}},
        rotation=-90)));
  Electrical.ThreePhase.Branches.Lines.Line_1Ph L684_652(Bser=-0.2834, Gser=
        0.7426) annotation (Placement(transformation(
        origin={422,-10},
        extent={{-14,-10},{14,10}})));
  Electrical.ThreePhase.Buses.Bus_1Ph Bus652 annotation (Placement(transformation(
        origin={454,-10},
        extent={{-10,-10},{10,10}})));
  Electrical.ThreePhase.Loads.WyeLoad_1Ph SpotLoad652(
    C_pa=100,
    ModelType=1,
    P_a=0.128,
    Q_a=0.086) annotation (Placement(transformation(
        origin={484,-10},
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Electrical.ThreePhase.Buses.Bus_1Ph Bus611(angle_1=120) annotation (Placement(
        transformation(
        origin={386,-62},
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  Electrical.ThreePhase.Branches.Lines.Line_1Ph L684_611(Bser=-1.1456, Gser=
        1.1301) annotation (Placement(transformation(
        origin={386,-32},
        extent={{-14,-10},{14,10}},
        rotation=-90)));
  Electrical.ThreePhase.Loads.WyeLoad_1Ph SpotLoad611(
    AngA=120,
    B_pa=100,
    ModelType=1,
    P_a=0.17,
    Q_a=0.08) annotation (Placement(transformation(
        origin={386,-88},
        extent={{-10,-10},{10,10}})));
  Electrical.ThreePhase.Banks.CapacitorBank_1Ph CapacitorBank611(AngA=120, Q_a=
        0.1) annotation (Placement(transformation(
        origin={420,-78},
        extent={{-10,-10},{10,10}})));
  Electrical.ThreePhase.Branches.Lines.Line_3Ph LRG60_632(
    Bseraa=-0.5712,
    Bserab=0.2112,
    Bserac=0.1579,
    Bserbb=-0.5413,
  ...
  Electrical.ThreePhase.Buses.Bus_3Ph BusRG60(
    V_A=1.0625,
    V_B=1.05,
    V_C=1.0687) annotation (Placement(transformation(
        origin={76,88},
        extent={{-10,-10},{10,10}})));
  Electrical.ThreePhase.Loads.DeltaLoad_3Ph SpotLoad671(
    P_ab=0.385,
    P_bc=0.385,
    P_ca=0.385,
    Q_ab=0.22,
    Q_bc=0.22,
    Q_ca=0.22) annotation (Placement(transformation(
        origin={344,50},
        extent={{-10,-10},{10,10}})));
  Electrical.ThreePhase.Loads.DeltaLoad_2Ph SpotLoad692(
    AngA=120,
    AngB=0,
    B_ab=100,
    ModelType=1,
    ...
    Q_ab=0.151,
    VA=1,
    VB=1) annotation (Placement(transformation(
        origin={420,154},
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Electrical.ThreePhase.Loads.DeltaLoad_2Ph SpotLoad646(
    AngA=-120,
    AngB=120,
    C_ab=100,
    ModelType=1,
    P_ab=0.23,
    Q_ab=0.132) annotation (Placement(transformation(
        origin={166,-88},
        extent={{-10,-10},{10,10}})));
equation

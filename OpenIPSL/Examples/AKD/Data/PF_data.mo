...
record PF_data "PSSE complete data record"
  ...
  replaceable record Voltages = Data.AKD_PF_voltages constrainedby Data.AKD_PF_voltages
                         "PSSE voltages from power flow solution" annotation (choicesAllMatching);
  Voltages voltages;
  /* PSSE powers from power flow solution */
  replaceable record Powers = Data.AKD_PF_powers constrainedby Data.AKD_PF_powers "PSSE powers from power flow solution"

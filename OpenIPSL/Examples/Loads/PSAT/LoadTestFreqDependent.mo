...
model LoadTestFreqDependent
  ...
  OpenIPSL.Electrical.Loads.PSAT.FrequencyDependentLoad frequencyDependentLoad(
    alpha_p=0,
    beta_p=1,
    beta_q=1,
    Sn=10000000,
...
equation
  ...
  connect(frequencyDependentLoad.p, pwLine3.n) annotation (Line(points={{80,-20},{80,0},{62,0},{62,-10},{59,-10}}, color={0,0,255}));

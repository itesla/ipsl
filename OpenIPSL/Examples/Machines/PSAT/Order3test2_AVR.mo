...
equation
  ...
  connect(AVRtypeIII1.vf, order3_Inputs_Outputs1.vf) annotation (Line(points={{-57.1667,0},{-50.5,0},{-50.5,5},{-41.9999,5}},
                                                         color={0,0,127}));
  connect(AVRtypeIII1.v, order3_Inputs_Outputs1.v) annotation (Line(points={{-77.1667,5},{-88,5},{-88,22},{-15,22},{-15,3},{-19,3}},
                                                         color={0,0,127}));
  connect(order3_Inputs_Outputs1.pm0, order3_Inputs_Outputs1.pm) annotation (
      Line(points={{-37.9999,-11},{-37.9999,-14},{-47,-14},{-47,-5},{-41.9999,-5}},
        color={0,0,127}));
  connect(AVRtypeIII1.vf0, order3_Inputs_Outputs1.vf0) annotation (Line(points={{-68,9.16667},{-68,16},{-37.9999,16},{-37.9999,11}},
                                                               color={0,0,127}));
  connect(AVRtypeIII1.vs, const.y) annotation (Line(points={{-77.1667,-5},{-86,-5},{-86,0},{-89.6,0}},
                                  color={0,0,127}));

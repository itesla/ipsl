...
equation
  connect(Generator.vf0, Generator.vf) annotation (Line(points={{-58,22},{-58,
          28},{-76,28},{-76,10},{-64,10}}, color={0,0,127}));
  connect(Generator.pm, Generator.pm0) annotation (Line(points={{-64.0038,-10.0714},
          {-72,-10.0714},{-72,-18},{-72,-28},{-58,-28},{-58,-22}}, color={0,0,
          127}));

...
equation
  connect(order6Type2_1.vf0, order6Type2_1.vf) annotation (Line(points={{-59,22},
          {-59,25},{-71,25},{-71,10},{-65,10}}, color={0,0,127}));
  connect(order6Type2_1.pm, order6Type2_1.pm0) annotation (Line(points={{-65.0038,
          -10.0714},{-71,-10.0714},{-71,-25},{-59,-25},{-59,-22}}, color={0,0,
          127}));

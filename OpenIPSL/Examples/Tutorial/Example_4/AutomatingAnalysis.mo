...
model AutomatingAnalysis
  ...
  <ol>
    ...
    <li>In the package browser, go to the <font color=\"blue\"><code>Experiments</code></font> package, create a new model by duplicating <font color=\"blue\"><code>SMIB</code></font> and name it <font color=\"blue\"><code>SMIB_VarLoad</code></font>.
    <p style=\"margin-left:10px;\">
      <img src=\"modelica://OpenIPSL/Resources/images/example_4/image47.png\" alt=\"Image47\" />
    </p>
    </li>
    <li>Now right-click the load component of the <font color=\"blue\"><code>SMIB_VarLoad</code></font> model and change the class to <em><font color=\"blue\"><code>PSS/E Load with variation</code></font></em> as indicated in the following picture:
    <p style=\"margin-left:10px;\">
    ...
    <li>Change the class of the genunit component of the <font color=\"blue\"><code>SMIB_VarLoad</code></font> model to the <font color=\"blue\"><code>Generator_TurbGov_AVR_PSS</code></font> model. You will find it as &quot;<em>Machine with Turbine, Governor, Excitation System and PSS</em>&quot;.
    <p style=\"margin-left:10px;\">

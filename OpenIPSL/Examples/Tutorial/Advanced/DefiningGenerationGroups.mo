...
model DefiningGenerationGroups
  ...
  <ol type=\"1\" start=\"1\">
    <li>Expand your <font color=\"blue\"><code>GenerationUnits</code></font> package and duplicate the <font color=\"blue\"><code>Generator_Only</code></font> model to create a new model called <font color=\"blue\"><code>Generator_TurbGov</code></font> that also has a turbine/governor block. </li>
  </ol>
  <p style=\"margin-left: 50px;\">
    <img src=\"modelica://OpenIPSL/Resources/images/example_4/image1.png\" alt=\"Image1\" />
  </p>
  <ol type=\"1\" start=\"2\" style=\"line-height:175%;\">
  ...
  <ol type=\"1\" start=\"5\">
    <li>Provide the following values for the <font color=\"blue\"><code>IEEEG1</code></font> parameters: </li>
  </ol>
  <p style=\"margin-left: 50px;\">
    <img src=\"modelica://OpenIPSL/Resources/images/example_4/image38.png\" alt=\"Image38\" />
  </p>
  <ol type=\"1\" start=\"6\" style=\"line-height:175%;\">
    ...
    <li>Go to the <strong>Attributes</strong> tab and click the replaceable option. Then click the <strong>Constraining Clause</strong> checkbox and select <font color=\"blue\"><code>OpenIPSL.Interfaces.Generator</code></font> from the drop-down list. </li>
  </ol>
  <p style=\"margin-left: 50px;\">
    <img src=\"modelica://OpenIPSL/Resources/images/example_4/image92.png\" alt=\"Image92\" />
  </p>
  <hr>
  <p style=\"margin-left: 40px;\">&#x1F4CC; The <font color=\"blue\"><code>GenerationUnit</code></font> icon should now turn into </p>
  <p style=\"margin-left: 90px;\">
    <img src=\"modelica://OpenIPSL/Resources/images/example_4/image24.png\" alt=\"Image24\" />
  </p>
  <hr>
  <ol type=\"1\" start=\"9\">
    <li>In <strong>Simulation Setup</strong> go to the <strong>Output</strong> tab and make sure that you are keeping at least 10 results:</li>
  </ol>
  <p style=\"margin-left: 50px;\">
    <img src=\"modelica://OpenIPSL/Resources/images/example_4/image93.png\" alt=\"Image93\" />
  </p>
  <ol type=\"1\" start=\"10\">
    <li>Go back to the diagram layer for the <font color=\"blue\"><code>SMIB</code></font> model and right-click the <em>genunit</em> block to change the class to the \" <em>Machine with Turbine and Governor</em>\" option. </li>
  </ol>
  <p style=\"margin-left: 50px;\">
    <img src=\"modelica://OpenIPSL/Resources/images/example_4/image34.png\" alt=\"Image34\" />
  </p>
  <ol type=\"1\" start=\"11\" style=\"line-height:175%;\">
    ...
    <li>Create a new generation unit model including the electrical machine, the turbine/governor and an excitation system. Name the new model <font color=\"blue\"><code>Generator_TurbGov_AVR</code></font>. For this to be done make sure you duplicate the <font color=\"blue\"><code>Generator_TurbGov</code></font> model. </li>
  </ol>
  <p style=\"margin-left: 50px;\">
    <img src=\"modelica://OpenIPSL/Resources/images/example_4/image49.png\" alt=\"Image49\" />
  </p>
  <ol type=\"1\" start=\"14\" style=\"line-height:175%;\">
  ...
  <ol type=\"1\" start=\"16\" style=\"line-height:175%;\">
  ...
  <table cellspacing=\"0\" cellpadding=\"1\" border=\"1\" style=\"margin-left: 110px;\">
    <thead>
      <tr>
  ...
  <ol type=\"1\" start=\"18\">
    <li>Use the <code>Constant</code> blocks to set the excitation system inputs to the values indicated in the following table:</li>
  </ol>
  <table cellspacing=\"0\" cellpadding=\"1\" border=\"1\" style=\"margin-left: 100px;\">
    <thead>
      <tr>
  ...
  <ol type=\"1\" start=\"20\" style=\"line-height:175%;\">
    ...
    <li>In the diagram layer of the <font color=\"blue\"><code>SMIB</code></font> model when right-clicking the <em>genunit</em> component, you should now be able to see the new generation unit model among the options for class change. Update the component class so that it uses the most recent generation unit model. </li>
  </ol>
  <p style=\"margin-left: 50px;\">
    <img src=\"modelica://OpenIPSL/Resources/images/example_4/image16.png\" alt=\"Image16\" />
  </p>
  <ol type=\"1\" start=\"22\" style=\"line-height:175%;\">
  ...
  <ol type=\"1\" start=\"25\" style=\"line-height:175%;\">
    ...
    <li>Connect the <font color=\"blue\"><code>V_S1</code></font> and <font color=\"blue\"><code>V_S2</code></font> inputs of the <font color=\"blue\"><code>PSS2A</code></font> block to the <font color=\"blue\"><code>SPEED_HP</code></font> and <font color=\"blue\"><code>PELEC</code></font> outputs of the machine component, respectively. </li>
  </ol>
  ...
  <ol type=\"1\" start=\"28\">
    <li>Double-click the <font color=\"blue\"><code>PSS2A</code></font> component in order to update the parameters as indicated below: </li>
  </ol>
  <p style=\"margin-left: 50px;\">

...
model SMIBSystemAssembly "Assembling a SMIB System"
  ...
  <ol style=\"line-height:175%;\">
    ...
    <li>Create a new package called <font color=\"blue\"><code>SMIB</code></font>. Make sure to unselect the option to save the contents of the package in one file. </li>
  </ol>
  ...
  <ol start=\"4\" style=\"line-height:175%;\">
    ...
    <li>To follow the structure and appearance convention of packages in Modelica, we can add an icon to the <font color=\"blue\"><code>Experiments</code></font> package. Double-click the <font color=\"blue\"><code>Experiments</code></font> package and go to the text layer to add the following line of class extension: </li>
  </ol>
  <blockquote><pre>
  ...
  <ol start=\"6\" style=\"line-height:175%;\">
    ...
    <li>Go to the Package Browser, navigate to <font color=\"blue\"><code>OpenIPSL.Interfaces.Generator</code></font>, and right-click the icon to create a new model by class extension. Name the new model <font color=\"blue\"><code>InfiniteBus</code></font> and place it inside <font color=\"blue\"><code>GenerationUnits</code></font>. </li>
  </ol>
  <p style=\"margin-left:50px;\">
    <img src=\"modelica://OpenIPSL/Resources/images/example_4//image3.png\" alt=\"Image3\" />
  </p>
  <ol start=\"8\">
    <li>Repeat the procedure to create a new model called <font color=\"blue\"><code>Generator_Only</code></font>. Your package should look as follows: </li>
  </ol>
  <p style=\"margin-left:50px;\">
  ...
  <ol start=\"9\" style=\"line-height:175%;\">
    ...
    <li>Now drag and drop a <font color=\"blue\"><code>GENROE</code></font> generator model from <font color=\"blue\"><code>OpenIPSL.Electrical.Machines.PSSE</code></font> to <font color=\"blue\"><code>Generator_Only</code></font>. </li>
  </ol>
  <p style=\"margin-left:50px;\">
  ...
  <ol start=\"13\">
    <li>Double click the <font color=\"blue\"><code>GENCLS</code></font> block inside the <font color=\"blue\"><code>InfiniteBus</code></font> model. Be sure to enter all the machine parameters in the figure below: </li>
  </ol>
  <p style=\"margin-left:50px;\">
    <img src=\"modelica://OpenIPSL/Resources/images/example_4//image62.png\" alt=\"Image62\" />
  </p>
  <ol start=\"14\">
    <li>Switch to the Modelica Text of the <font color=\"blue\"><code>InfiniteBus</code></font> model. Propagate the power flow parameters one layer up as indicated in the highlighted text of the following code chunk: </li>
  </ol>
  <blockquote><pre>
  ...
  <ol start=\"17\" style=\"line-height:175%;\">
    <li>Go now to the diagram layer of the <font color=\"blue\"><code>SMIB_Partial</code></font> model. Drag and drop the following components: <ul style=\"line-height:175%;\">
  ...
  <ol start=\"20\" style=\"line-height:175%;\">
    ...
    <li>Double click the <font color=\"blue\"><code>pwFault</code></font> block and fill in the parameters as indicated below: </li>
  </ol>
  <p style=\"margin-left:50px;\">
    <img src=\"modelica://OpenIPSL/Resources/images/example_4//image66.png\" alt=\"Image66\" />
  </p>
  <ol start=\"22\">
    <li>Inside <font color=\"blue\"><code>Experiments</code></font> create a new model named SMIB by extending the <font color=\"blue\"><code>SMIB_Partial</code></font> model. Although not entirely required, add the following line to the Modelica text to include an icon to the model: </li>
  </ol>
  <blockquote><pre>
  ...
  <hr>
  <p style=\"margin-left:50px;\">&#x1F4CC; You should have a package structure similar to this:</p>
  ...
  <ol start=\"23\" style=\"line-height:175%;\">
    ...
    <li>Connect <font color=\"blue\"><code>genunit</code></font> to bus <font color=\"blue\"><code>B01</code></font>. The model should look as follows: </li>
  </ol>
  <p style=\"margin-left:50px;\">

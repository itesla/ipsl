...
model WT3G1_WT3E
  ...
  OpenIPSL.Electrical.Banks.PSSE.Shunt shunt1(B=-0.25, G=0) annotation (Placement(transformation(extent={{46,-36},{66,-16}})));
  OpenIPSL.Electrical.Events.PwFault pwFault(
    R=0.5,
    X=0.5,
    t1=1,
    t2=1.5) annotation (Placement(transformation(extent={{32,-34},{48,-18}})));
  OpenIPSL.Electrical.SystemBase SysData annotation (Placement(transformation(extent={{-126,48},{-102,68}})));
  OpenIPSL.Electrical.Wind.PSSE.WT3G.WT3G1 wT3G1_pt(
    eterm=V5,
    anglev0=A5,
    pelec=P5,
    qelec=Q5,
    ...
    wbase=2*pi*50) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={102,7})));
  OpenIPSL.Electrical.Wind.PSSE.WT3G.WT3E1 wT3E1_1(
    VARFLG=1,
    v0=V5,
    p0=P5/1.5,
    q0=Q5/1.5,

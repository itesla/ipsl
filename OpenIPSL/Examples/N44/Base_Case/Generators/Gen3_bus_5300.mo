...
equation
  connect(gENSAL.p, p)
    annotation (Line(points={{1.1,8},{82,8},{82,0},{110,0}}, color={0,0,255}));
  connect(sTAB2A.VOTHSG, sCRX.VOTHSG) annotation (Line(points={{-17.9091,-44},{
          -17.9091,-43.3333},{22,-43.3333}}, color={0,0,127}));
  connect(cte.y, sCRX.VOEL) annotation (Line(points={{-9.4,-64},{-6,-64},{-2,-64},
          {-2,-82},{40.85,-82}}, color={0,0,127}));
  connect(sCRX.EFD, gENSAL.EFD) annotation (Line(points={{81.45,-55.3333},{84,-55.3333},
          {84,-86},{-78,-86},{-78,-8},{-63.38,-8}}, color={0,0,127}));
  ...
  connect(gENSAL.XADIFD, sCRX.XADIFD) annotation (Line(points={{0.48,-20.8},{8,
          -20.8},{8,-64.6667},{22,-64.6667}}, color={0,0,127}));
  connect(gENSAL.EFD0, sCRX.EFD0) annotation (Line(points={{0.48,-14.4},{12,-14.4},
          {12,-72.6667},{22,-72.6667}}, color={0,0,127}));
  connect(hYGOV.PMECH, gENSAL.PMECH) annotation (Line(points={{11.8,76},{18,76},
          {18,46},{-76,46},{-76,24},{-63.38,24}}, color={0,0,127}));
  connect(gENSAL.SPEED, hYGOV.SPEED) annotation (Line(points={{0.48,36.8},{24,
          36.8},{24,92},{-66,92},{-66,83},{-61.1,83}}, color={0,0,127}));
  connect(gENSAL.PMECH0, hYGOV.PMECH0) annotation (Line(points={{0.48,-1.6},{32,
          -1.6},{32,96},{-78,96},{-78,69},{-61.1,69}}, color={0,0,127}));
  connect(gENSAL.ETERM, sCRX.ECOMP) annotation (Line(points={{0.48,24},{16,24},
          {16,-55.3333},{22,-55.3333}}, color={0,0,127}));
  connect(sCRX.VUEL, cte.y) annotation (Line(points={{32.15,-82},{-2,-82},{-2,-64},
          {-9.4,-64}}, color={0,0,127}));
  annotation (

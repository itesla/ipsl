...
<li> <b>Electrical</b>: contains many different models that represent devices that form the grid or that are part of equipments which are connected to the grid. A more detailed overview is presented below.</li>

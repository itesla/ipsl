...
model PwLoadwithVariation "Load with a power variation event.
  ...
  OpenIPSL.Connectors.PwPin p annotation (Placement(transformation(extent={{-80,0},{-60,20}}), iconTransformation(extent={{-80,0},{-60,20}})));
...
equation
  ...
  p.vr = R*p.ir - X*p.ii;
  p.vi = X*p.ir + R*p.ii;
  annotation (Diagram(graphics),Icon(graphics={Rectangle(extent={{-60,60},{40,-40}}, lineColor={0,0,255}),Rectangle(extent={{-40,40},{20,-20}}, lineColor={0,0,255}),Line(
          points={{-40,40},{20,-20}},
          color={0,0,255},

...
model Controller
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax=id_max, uMin=id_min)
    annotation (Placement(transformation(
        origin={-11.5403,-65.0},
        extent={{-10.0,-10.0},{10.0,10.0}})));
  Modelica.Blocks.Math.Gain gain1(k=1/ibase) annotation (Placement(transformation(
        origin={16.5869,-65.0},
        extent={{-10.0,-10.0},{10.0,10.0}})));
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter2(uMax=iq_max, uMin=iq_min)
    annotation (Placement(transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}})));
  Modelica.Blocks.Math.Gain gain2(k=1/ibase_iq) annotation (Placement(transformation(
        origin={10.0,47.3513},
        extent={{-10.0,-10.0},{10.0,10.0}})));

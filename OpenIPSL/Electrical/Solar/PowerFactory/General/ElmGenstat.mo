...
equation
  ...
  annotation(
    Icon(graphics = {Rectangle(lineColor = {118, 18, 62}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, -160}, {100, 160}}), Text(origin = {-35.7, 100.01}, fillPattern = FillPattern.Solid, extent = {{-20.3, -10.18}, {20.3, 10.18}}, textString = "id_ref", fontName = "Arial", horizontalAlignment = TextAlignment.Left), Text(origin = {-32.7, 41.82}, fillPattern = FillPattern.Solid, extent = {{-23.3, -10.18}, {23.3, 10.18}}, textString = "iq_ref", fontName = "Arial", horizontalAlignment = TextAlignment.Left), Text(origin = {24.8302, 168.735}, lineColor = {118, 18, 62}, fillPattern = FillPattern.Solid, extent = {{-122.83, -30.7345}, {75.3098, -8.89452}}, textString = "ElmStatgen", fontName = "Arial"), Ellipse(origin = {71.43, -32.67}, lineColor = {118, 18, 62}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, lineThickness = 0.5, extent = {{-71.43, 66.67}, {-1.43, -1.33}}, endAngle = 360), Line(origin = {49.9468, -19.7732}, points = {{-38, 19}, {8, 19}}, color = {118, 18, 62}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 10), Text(origin = {-30.7, -36.18}, fillPattern = FillPattern.Solid, extent = {{-21.3, -10.18}, {21.3, 10.18}}, textString = "sinref", fontName = "Arial", horizontalAlignment = TextAlignment.Left), Text(origin = {-27.7, -98.18}, fillPattern = FillPattern.Solid, extent = {{-24.3, -10.18}, {24.3, 10.18}}, textString = "cosref", fontName = "Arial", horizontalAlignment = TextAlignment.Left), Text(origin = {24.07, -122.08}, lineColor = {118, 18, 62}, fillPattern = FillPattern.Solid, extent = {{-124.07, -27.92}, {76.07, -8.08}}, textString = "%name", fontName = "Arial"), Text(origin = {74.3, 38.01}, fillPattern = FillPattern.Solid, extent = {{-20.3, -10.18}, {20.3, 10.18}}, textString = "i", fontName = "Arial", horizontalAlignment = TextAlignment.Right), Text(origin = {74.3, 98.01}, fillPattern = FillPattern.Solid, extent = {{-20.3, -10.18}, {20.3, 10.18}}, textString = "v", fontName = "Arial", horizontalAlignment = TextAlignment.Right), Line(origin = {80, 0}, points = {{-10, 0}, {10, 0}, {10, 0}}, color = {118, 18, 62}, thickness = 0.5), Text(origin = {70.3, -39.99}, fillPattern = FillPattern.Solid, extent = {{-20.3, -10.18}, {20.3, 10.18}}, textString = "P", fontName = "Arial", horizontalAlignment = TextAlignment.Right), Text(origin = {70.3, -101.99}, fillPattern = FillPattern.Solid, extent = {{-20.3, -10.18}, {20.3, 10.18}}, textString = "Q", fontName = "Arial", horizontalAlignment = TextAlignment.Right)}, coordinateSystem(initialScale = 0.1, extent = {{-100, -160}, {100, 160}})),
    Diagram,

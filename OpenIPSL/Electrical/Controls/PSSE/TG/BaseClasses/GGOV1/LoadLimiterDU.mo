...
model LoadLimiterDU
  ...
  Modelica.Blocks.Math.Gain KPLOAD(k=Kpload) annotation (Placement(visible = true, transformation(extent={{-48,-80},{-28,-60}},      rotation = 0)));
  Modelica.Blocks.Continuous.Integrator s6(
    k=1,
    y_start=s60,
    initType=Modelica.Blocks.Types.Init.InitialState) annotation (Placement(visible = true, transformation(origin={-40,-34},    extent={{10,10},{-10,-10}},  rotation = 180)));
  ...
  Modelica.Blocks.Math.Add tlim annotation (Placement(transformation(
        ...
        rotation=0,
        origin={0,36})));
  Modelica.Blocks.Math.Gain Gain(k=Kiload) annotation (Placement(visible = true, transformation(origin={-70,-34},    extent={{10,-10},{-10,10}},  rotation = 180)));
...
equation
  ...
  connect(KPLOAD.y, LoadlimiterPI.u2) annotation (
    Line(points={{-27,-70},{10,-70},{10,-46},{18,-46}},
                                            color = {0, 0, 127}));
  ...
  connect(Gain.u,diff. y) annotation (
    Line(points={{-82,-34},{-88,-34},{-88,8.88178e-16},{-11,8.88178e-16}},
                                                               color = {0, 0, 127}));
  ...
  connect(tlim.y, diff.u1) annotation (Line(points={{11,36},{20,36},{20,6},{12,6}}, color={0,0,127}));
  connect(TEXM, diff.u2) annotation (Line(points={{120,40},{80,40},{80,-6},{12,-6}}, color={0,0,127}));
  connect(diff.y, KPLOAD.u) annotation (Line(points={{-11,8.88178e-16},{-88,8.88178e-16},{-88,-70},{-50,-70}}, color={0,0,127}));
  annotation (
    Icon(graphics={Rectangle(lineColor = {0, 0, 255}, extent = {{-100, 100}, {100, -100}}),Text(lineColor = {28, 108, 200}, extent = {{-90, 12}, {-58, -10}}, textString = "LDREF"),Text(lineColor = {28, 108, 200}, extent = {{60, 62}, {92, 40}}, textString = "TEXM"),Text(lineColor = {28, 108, 200}, extent = {{68, -2}, {92, -18}}, textString = "WF"),Text(lineColor = {28, 108, 200}, extent = {{60, -50}, {92, -72}}, textString = "FSRT"),Text(lineColor = {28, 108, 200}, extent={{
              -60,20},{60,-22}},                                                                                                                                                                                                        textString = "Load

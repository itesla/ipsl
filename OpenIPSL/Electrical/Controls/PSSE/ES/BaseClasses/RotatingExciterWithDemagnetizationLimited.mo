...
model RotatingExciterWithDemagnetizationLimited
  extends RotatingExciterWithDemagnetization(redeclare replaceable Modelica.Blocks.Continuous.LimIntegrator sISO(
      outMin=0,
      k=1/T_E,
  ...
  annotation (Icon(graphics={Text(
          ...
          textString="Limited")}), Documentation(revisions="<html>
<!--DISCLAIMER-->
<p>OpenIPSL:</p>

...
model RotatingExciter
  ...
  replaceable Modelica.Blocks.Continuous.Integrator integrator(
    k=1/T_E,
    initType=Modelica.Blocks.Types.Init.InitialOutput,
    y_start=Efd0) annotation (Placement(transformation(extent={{-10,10},{10,30}})));
...
equation
  connect(feedback.y, integrator.u) annotation (Line(points={{-41,20},{-12,20}}, color={0,0,127}));
  ...
  connect(integrator.y, EFD) annotation (Line(points={{11,20},{76,20},{76,0},{90,0}}, color={0,0,127}));

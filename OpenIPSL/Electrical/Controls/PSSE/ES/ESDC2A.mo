...
model ESDC2A
  ...
  Modelica.Blocks.Continuous.Derivative imDerivativeLag(
    ...
    x_start=Efd0) annotation (Placement(transformation(extent={{0,-60},{-20,-40}})));
  ...
  NonElectrical.Continuous.LeadLag imLeadLag(
    ...
    T1=T_C,
    T2=T_B,
    y_start=V_R0/K_A) annotation (Placement(transformation(extent={{-20,-10},{0,10}})));
...
<p>If a copy of the MPL was not distributed with this file, You can obtain one at <a href=\"http://mozilla.org/MPL/2.0/\"> http://mozilla.org/MPL/2.0</a>.</p>
  ...
  BaseClasses.RotatingExciterLimited rotatingExciterLimited(
    ...
    S_EE_2=S_EE_2,
    Efd0=Efd0,
    K_E=K_E0) annotation (Placement(transformation(extent={{120,-10},{140,10}})));
  ...
  NonElectrical.Continuous.SimpleLagLimVar simpleLagLimVar(
    K=K_A,
    T=T_A,
    y_start=V_R0) annotation (Placement(transformation(extent={{80,-10},{100,10}})));

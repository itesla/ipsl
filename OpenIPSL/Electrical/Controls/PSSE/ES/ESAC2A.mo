...
model ESAC2A "AC2A Excitation System (IEEE Std 421.5-2016)"
import OpenIPSL.NonElectrical.Functions.SE;
  ...
  parameter SI.PerUnit V_RMAX=9 "Maximum exciter field output";
  parameter SI.PerUnit V_RMIN=-5.43 "Minimum exciter field output";
  parameter SI.Time T_E=0.8 "Exciter field time constant";
  parameter SI.PerUnit V_FEMAX=4.4 "Maximum exciter field current limit reference";

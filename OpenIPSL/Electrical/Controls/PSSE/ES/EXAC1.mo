...
model EXAC1
  ...
  OpenIPSL.NonElectrical.Continuous.SimpleLagLim imLimitedSimpleLag(
    ...
    outMin=V_RMIN,
    outMax=V_RMAX,
    y_start=VR0) annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  ...
  Modelica.Blocks.Continuous.Derivative imDerivativeLag(
    ...
    x_start=VFE0) annotation (Placement(transformation(extent={{20,-60},{0,-40}})));
  ...
  BaseClasses.RotatingExciterWithDemagnetizationLimited rotatingExciterWithDemagnetizationLimited(
    ...
    S_EE_2=S_EE_2,
    K_D=K_D,
    Efd0=VE0) annotation (Placement(transformation(extent={{100,-10},{120,10}})));

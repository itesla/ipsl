...
model EXAC1 "AC1 Excitation System (IEEE Std 421.5-2016)"
  ...
  parameter SI.PerUnit V_RMAX=9 "Maximum regulator output";
  parameter SI.PerUnit V_RMIN=-5.43 "Minimum regulator output";

within OpenIPSL.Electrical.Sensors.Eurostag;
model PwActivePower "Active Power sensor. This model has been built assuming that the three
  ...
  OpenIPSL.Connectors.PwPin n annotation (Placement(transformation(extent={{40,12},{60,32}}), iconTransformation(extent={{40,12},{60,32}})));
equation
  n.vr = p.vr;
  n.vi = p.vi;
  n.ir = -p.ir;

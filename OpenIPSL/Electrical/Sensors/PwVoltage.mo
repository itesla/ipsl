...
class PwVoltage "Voltage sensor"
  ...
  OpenIPSL.Interfaces.PwPin p annotation (Placement(transformation(
          extent={{-110,-10},{-90,10}})));
  Modelica.Blocks.Interfaces.RealOutput vr annotation (Placement(
        transformation(extent={{100,50},{120,70}})));
  Modelica.Blocks.Interfaces.RealOutput vi annotation (Placement(
...
equation
  ...
  connect(vr, vr) annotation (Line(points={{110,60},{110,60},{110,60}},
        color={0,0,127}));
  annotation (Icon(graphics={
        Rectangle(extent={{-100,100},{100,-100}}, lineColor={0,0,255}),

        Rectangle(extent={{-80,80},{80,-80}}, lineColor={0,0,255}),
        Rectangle(extent={{-60,60},{60,0}}, lineColor={0,0,255}),
        Text(
          extent={{-20,-20},{20,-60}},
          lineColor={0,0,255},

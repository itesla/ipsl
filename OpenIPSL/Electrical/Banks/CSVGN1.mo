...
equation
  ...
  connect(const1.y, add.u1) annotation (Line(
      points={{51,40},{60,40},{60,4},{68,4},{68,3.6},{66.8,3.6}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(product1.y, add.u2) annotation (Line(
      points={{52.6,0},{56,0},{56,-3.6},{66.8,-3.6}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(V, add1.u2) annotation (Line(
      points={{-120,0},{-90,0},{-90,-3.6},{-67.2,-3.6}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const2.y, add1.u1) annotation (Line(
      points={{-81.2,20},{-74,20},{-74,3.6},{-67.2,3.6}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const.y, product1.u1) annotation (Line(
      points={{1,40},{24,40},{24,3.6},{38.8,3.6}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(add1.y, ImSimpleLagnonwinduplimit.u) annotation (Line(
        points={{-53.4,0},{-52.65,0},{-42,0}}, color={0,0,127}));
  connect(ImSimpleLagnonwinduplimit.y, imLimited.u)
    annotation (Line(points={{-19,0},{-2,0}}, color={0,0,127}));
  connect(imLimited.y, product1.u2) annotation (Line(points={{21,0},{24,
          0},{24,-3.6},{38.8,-3.6}}, color={0,0,127}));

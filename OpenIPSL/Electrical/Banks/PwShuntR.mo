...
model PwShuntR "Shunt inductor"
  ...
  OpenIPSL.Interfaces.PwPin p annotation (Placement(transformation(extent={{-10,90},
            {10,110}})));
...
equation
  ...
  annotation (Icon(coordinateSystem(                           extent={{-100,-100},{100,100}},
          initialScale=0.1),                                                                    graphics={
                                    Rectangle(extent={{-100,100},{100,
              -100}},                                                     lineColor={0,0,255}),
 Line(points={{-15.5,-9},{-15.5,-1},{-11.5,7},{-3.5,11},{6.5,9},{12.5,
              1},{12.5,-9}},                                               color={0,0,255}, smooth=Smooth.Bezier,
          origin={-9,59.5},
          rotation=90),
 Line(points={{-15.5,-9},{-15.5,-1},{-11.5,7},{-3.5,11},{6.5,9},{12.5,
              1},{12.5,-9}},                                               color={0,0,255}, smooth=Smooth.Bezier,
 ...
 Line(points={{-15.5,-9},{-15.5,-1},{-11.5,7},{-3.5,11},{6.5,9},{12.5,
        ...
        Line(
          ...
          color={0,0,255},
          smooth=Smooth.None),
        Line(points={{0,72},{0,100}}, color={0,0,255}),
        Line(points={{0,-60},{0,-40}}, color={0,0,255}),
        Text(

...
model PhaseshiftTwoWindingTransformer_withOLTC "Two Winding Transformer with Phaseshift and OLTC"
  ...
  OpenIPSL.Connectors.PwPin F annotation (Placement(transformation(extent={{-114,-4},{-94,16}})));
  OpenIPSL.Connectors.PwPin T annotation (Placement(transformation(extent={{86,-6},{106,14}})));

...
model ThreeWinding
  ...
  OpenIPSL.Connectors.PwPin P1 annotation (Placement(transformation(extent={{-100,-2},{-80,18}}), iconTransformation(extent={{-100,-8},{-92,0}})));
  OpenIPSL.Connectors.PwPin P2 annotation (Placement(transformation(extent={{80,50},{100,70}}), iconTransformation(extent={{90,10},{98,18}})));
  OpenIPSL.Connectors.PwPin P3 annotation (Placement(transformation(extent={{80,-50},{100,-30}}), iconTransformation(extent={{90,-28},{98,-20}})));
  OpenIPSL.Electrical.Branches.PSSE.Old_transformer.TwoWindingTapRatio No_1(
    initialtapratio=1,
    angle_d=0,
    COD=1,
  ...
  OpenIPSL.Electrical.Sensors.PwVoltage V1 annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-71,-25})));
  OpenIPSL.Connectors.PwPin P1_control annotation (Placement(transformation(extent={{-100,-60},{-80,-40}}), iconTransformation(extent={{-102,24},{-94,32}})));
  OpenIPSL.Electrical.Branches.PSSE.Old_transformer.TwoWindingTapRatio No_2(
    initialtapratio=1,
    angle_d=0,
    COD=0,
    Zeq(re=0.0025, im=0.005)) annotation (Placement(transformation(
  ...
  OpenIPSL.Electrical.Sensors.PwVoltage V2 annotation (Placement(transformation(
        ...
        rotation=180,
        origin={69,-1})));
  OpenIPSL.Electrical.Branches.PSSE.Old_transformer.TwoWindingTapRatio No_3(
    initialtapratio=1,
    angle_d=0,
    COD=0,
    Zeq(re=0.0025, im=0.005)) annotation (Placement(transformation(
  ...
  OpenIPSL.Electrical.Sensors.PwVoltage V3 annotation (Placement(transformation(
        ...
        rotation=180,
        origin={71,-51})));
  OpenIPSL.Connectors.PwPin P3_control annotation (Placement(transformation(extent={{80,-82},{100,-62}}), iconTransformation(extent={{90,-60},{98,-52}})));
equation

...
model MeasurementBus
  ...
  Modelica.Blocks.Interfaces.RealOutput pa = Pa/S_b annotation (Placement(transformation(
        extent={{-24,-24},{24,24}},
        rotation=-90,
        origin={52,-124})));
  Modelica.Blocks.Interfaces.RealOutput pb = Pb/S_b  annotation (Placement(transformation(
        extent={{-24,-24},{24,24}},
        rotation=-90,
        origin={2,-124})));
  Modelica.Blocks.Interfaces.RealOutput pc = Pc/S_b  annotation (Placement(transformation(
        extent={{-24,-24},{24,24}},
        rotation=-90,
        origin={-50,-124})));

  Modelica.Blocks.Interfaces.RealOutput qa = Qa/S_b annotation (Placement(transformation(
        extent={{-24,-24},{24,24}},
        rotation=-90,
        ...
        rotation=-90,
        origin={60,110})));
  Modelica.Blocks.Interfaces.RealOutput qb = Qb/S_b  annotation (Placement(transformation(
        extent={{-24,-24},{24,24}},
        rotation=-90,
        ...
        rotation=-90,
        origin={0,110})));
  Modelica.Blocks.Interfaces.RealOutput qc = Qc/S_b  annotation (Placement(transformation(
        extent={{-24,-24},{24,24}},
        rotation=-90,

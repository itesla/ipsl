...
function D_Y "Calculation of hybrid impedance matrices for a delta-wye-connected three-phase transformer."
...
<p>The transformer that uses this function should have its primary windings connected in delta and its secondary windings connected in wye (star).

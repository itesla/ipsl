...
function D_D_FinImp "Calculation of impedance matrices for a delta-delta-connected hybrid transformer. Finite values of Norton equivalent impedances are taken into account."

...
function Y_Yg_FinImp "Calculation of impedance matrices for a wye-grounded-wye-connected hybrid transformer. Finite values of Norton equivalent impedances are taken into account."
...
protected
  ...
  parameter Real[1, 18] Yshtm=[sGshm, sBshm, mGshm, mBshm, mGshm, mBshm, mGshm,
      mBshm, sGshm, sBshm, mGshm, mBshm, mGshm, mBshm, mGshm, mBshm, sGshm,
      sBshm];
...
<p>The transformer that uses this function should have its primary windings connected in wye (star) and its secondary windings connected in grounded-wye (grounded-star).

...
model TCSC2 "Thyristor Controlled Series Compensator"
...
<a href=\"modelica://OpenIPSL.UsersGuide.References\">[Milano2010], chapter 20.2</a>.</p>
<p>
In the current implementation <code>Vs_POD</code> should normally be an input signal but 
is provided as a fixed parameter. This should be improved in a future version.
</p>
</html>", revisions="<html>

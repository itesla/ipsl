...
model QControl_Type4B "Developed by DTU"
  OpenIPSL.NonElectrical.Logical.Relay4 imReal4in annotation (Placement(transformation(extent={{-58,20},{-48,30}})));
  ...
  OpenIPSL.NonElectrical.Logical.Relay imRelay annotation (Placement(transformation(extent={{-32,24},{-24,32}})));
  ...
  OpenIPSL.NonElectrical.Logical.Relay imRelay1 annotation (Placement(transformation(extent={{30,34},{40,44}})));
  Modelica.Blocks.Sources.Constant imSetPoint5(k=0) annotation (Placement(transformation(extent={{7,41},{18,52}})));
  OpenIPSL.Electrical.Wind.DTU.LVRT lVRT(Uqdip=Uqdip, Tpost=Tpost) annotation (Placement(transformation(extent={{-54,-74},{2,-32}})));
  Modelica.Blocks.Nonlinear.Limiter imLimiter1(uMin=0.01, uMax=999) annotation (Placement(transformation(extent={{-40,-46},{-28,-34}})));
  OpenIPSL.Electrical.Wind.DTU.VoltageDepCurrent voltageDepCurrent(
    Udb1=Udb1,
    Udb2=Udb2,
  ...
  OpenIPSL.NonElectrical.Logical.Relay imRelay2 annotation (Placement(transformation(extent={{84,44},{92,52}})));
  ...
  OpenIPSL.NonElectrical.Logical.Relay imRelay4 annotation (Placement(transformation(extent={{160,56},{170,66}})));
  Modelica.Blocks.Math.Gain imGain1(k=KpU) annotation (Placement(transformation(extent={{178,36},{190,48}})));
  OpenIPSL.NonElectrical.Logical.Relay imRelay5 annotation (Placement(transformation(extent={{225,53},{236,64}})));
  ...
  OpenIPSL.Electrical.Wind.DTU.IQLVRT iQLVRT1 annotation (Placement(transformation(extent={{30,-96},{78,-52}})));
  OpenIPSL.Electrical.Wind.DTU.VoltageDrop voltageDrop(Rdroop=Rdroop, Xdroop=Xdroop) annotation (Placement(transformation(extent={{-28,-36},{20,2}})));

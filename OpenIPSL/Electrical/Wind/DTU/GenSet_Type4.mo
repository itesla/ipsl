...
model GenSet_Type4 "Generator Type 4 Set Model. Developed by DTU"
  ...
  OpenIPSL.NonElectrical.Continuous.SimpleLagRateLimVar imSimpleLag_varnonwindup(
    T=Tg,
    rmax=diPmax,
    y_start=ini_iPref,
    rmin=-999) annotation (Placement(transformation(extent={{-16,8},{0,24}})));
  OpenIPSL.NonElectrical.Continuous.SimpleLagRateLimVar imSimpleLag_varnonwindup1(
    T=Tg,
    rmin=diQmin,
    rmax=diQmax,

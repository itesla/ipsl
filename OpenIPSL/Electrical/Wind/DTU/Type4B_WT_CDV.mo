...
model Type4B_WT_CDV "IEC Type 4B Full-Scale Wind Turbine Model. Developed by DTU"
  ...
  OpenIPSL.Electrical.Wind.DTU.CurrentLimiter CurrentLimitationModel(
    i_maxdip=i_maxdip,
    i_max=i_max,
    M_Qpri=M_Qpri,
    T_Ufilt=T_Ufilt) annotation (Placement(transformation(extent={{-8,36},{62,84}})));
  OpenIPSL.Electrical.Sensors.PwPowerMeas pwPowerMeas annotation (Placement(transformation(extent={{100,-4},{120,16}})));
  OpenIPSL.Electrical.Wind.DTU.DriveTrain driveTrain(
    Hgen=Hgen,
    Hwtr=Hwtr,
    k_sh=k_sh,
    c_sh=c_sh,
  ...
  OpenIPSL.Electrical.Wind.DTU.GenSet_Type4 genSet_Type4_2(
    Tg=Tg,
    diPmax=diPmax,
    diQmin=diQmin,
    diQmax=diQmax,
  ...
  OpenIPSL.Electrical.Wind.DTU.QControl_Type4B qControl_Type4B1(
    Tpfilt=Tpfilt,
    MwttPF=MwttPF,
    MwttU=MwttU,
    MwttOL=MwttOL,
  ...
  OpenIPSL.Connectors.PwPin WTG_terminal annotation (Placement(transformation(extent={{140,-5},{150,5}})));
  OpenIPSL.Electrical.Sensors.PwVoltage pwVoltage annotation (Placement(transformation(extent={{86,-70},{66,-50}})));
  OpenIPSL.Electrical.Wind.DTU.PControl_Type4B_CDV pControl_Type4B_CDV(
    w_init=w_init,
    T_Ufilt=T_Ufilt,
    dPmax=dPmax,
    Tpord=Tpord,
    Tpaero=Tpaero) annotation (Placement(transformation(extent={{-98,-4},{-6,54}})));
  OpenIPSL.Electrical.Machines.DTU.PwdqCurrentSource pwdqCurrentSource annotation (Placement(transformation(extent={{58,-6},{92,24}})));
  OpenIPSL.Electrical.Controls.DTU.pwPLL pwPLL annotation (Placement(transformation(extent={{82,-30},{62,-10}})));
initial equation

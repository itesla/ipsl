within OpenIPSL.Electrical.Machines.DTU;
model PwdqCurrentSource "Developed by DTU"
  OpenIPSL.Connectors.PwPin n annotation (Placement(transformation(extent={{60,-6},{72,6}}), iconTransformation(extent={{60,-6},{72,6}})));

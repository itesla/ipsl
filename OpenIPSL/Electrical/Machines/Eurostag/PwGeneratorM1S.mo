...
model PwGeneratorM1S "Synchronous machine model according to Park's classical theory (Full model description).
  ...
  OpenIPSL.Connectors.PwPin sortie(vr(start=ur0), vi(start=ui0)) annotation (Placement(transformation(extent={{40,10},{60,30}}), iconTransformation(extent={{40,10},{60,30}})));

...
equation
  ...
  connect(iSource.iRe, vRe.y) annotation (Line(points={{-64,4},{-82,4},{-82,10},
          {-87.4,10}}, color={0,0,127}));
  connect(iSource.iIm, vIm.y) annotation (Line(points={{-64,-4},{-82,-4},{-82,
          -14},{-87.4,-14}}, color={0,0,127}));

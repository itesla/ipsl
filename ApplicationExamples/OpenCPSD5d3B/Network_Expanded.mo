within OpenCPSD5d3B;
model Network_Expanded
  extends Modelica.Icons.Example;
  OpenIPSL.Electrical.Buses.Bus BG1 annotation (Placement(transformation(extent={{-90,30},{-70,50}})));
  OpenIPSL.Electrical.Buses.Bus B1 annotation (Placement(transformation(extent={{-50,30},{-30,50}})));
  ...
  OpenIPSL.Electrical.Buses.Bus B2 annotation (Placement(transformation(extent={{-10,30},{10,50}})));
  OpenIPSL.Electrical.Buses.Bus B3 annotation (Placement(transformation(extent={{50,30},{70,50}})));
  ...
  OpenIPSL.Electrical.Buses.Bus B4(angle_0=-6.160101, V_0=0.9291416) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={80,-20})));
  ...
  Generators.G2 G2(
    ...
    Q_0=10.20433) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={60,-80})));
  inner OpenIPSL.Electrical.SystemBase SysData(S_b=100, fn=50) annotation (Placement(transformation(extent={{-140,100},{-80,120}})));
  ...
  Breakers.Breaker breaker1 annotation (Placement(transformation(
        ...
        origin={80,-10})));
protected
  Modelica.Blocks.Interfaces.RealOutput V_IB annotation (Placement(transformation(
        extent={{-3,-3},{3,3}},
        rotation=90,
        origin={55,-97})));
  Modelica.Blocks.Interfaces.RealOutput V_DN annotation (Placement(transformation(
        extent={{-3,-3},{3,3}},
        rotation=90,
        origin={65,-97})));
  Modelica.Blocks.Interfaces.RealOutput fi_IB annotation (Placement(transformation(
        extent={{-3,-3},{3,3}},
        rotation=0,
        origin={43,-85})));
  Modelica.Blocks.Interfaces.RealOutput fi_DN annotation (Placement(transformation(
        extent={{-3,-3},{3,3}},
        rotation=0,
        origin={43,-75})));
public
...
equation
  ...
  connect(T1.p, B1.p) annotation (Line(points={{-53,40},{-46,40},{-40,40}}, color={0,0,255}));
  connect(BG1.p, T1.n) annotation (Line(points={{-80,40},{-67,40}}, color={0,0,255}));
  connect(G1.conn, BG1.p) annotation (Line(points={{-89,40},{-89,40},{-80,40}}, color={0,0,255}));
  connect(L1.n, B2.p) annotation (Line(points={{-14.6,40},{-14.6,40},{0,40}},
                                                                           color={0,0,255}));
  ...
  connect(L2_2.p, B2.p) annotation (Line(points={{24.6,20},{4,20},{4,40},{0,40}},
                                                                                color={0,0,255}));
  connect(T2.p, B4.p) annotation (Line(points={{60,-33},{60,-24},{80,-24},{80,-20}}, color={0,0,255}));
  connect(T2.n, B5.p) annotation (Line(points={{60,-47},{60,-53.5},{60,-60}}, color={0,0,255}));
  ...
  connect(fi_IB, G2.fi_IB) annotation (Line(points={{43,-85},{46.5,-85},{46.5,
          -85},{50,-85}}, color={0,0,127}));
  connect(fi_DN, G2.fi_DN) annotation (Line(points={{43,-75},{46.5,-75},{46.5,
          -75},{50,-75}}, color={0,0,127}));

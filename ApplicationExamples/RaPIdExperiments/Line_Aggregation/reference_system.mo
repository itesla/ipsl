...
model reference_system
  ...
  OpenIPSL.Electrical.Loads.PSSE.Load_variation constantLoad(
    ...
    angle_0=-0.5755869,
    P_0=0.5,
    Q_0=0.1) annotation (Placement(transformation(extent={{36,-54},{58,-30}})));
...
equation
  connect(gENROE1.EFD0, gENROE1.EFD) annotation (Line(points={{128,0},{124,0},{
          124,-16},{176,-16},{176,0},{174,0}}, color={0,0,127}));
  connect(gENROE1.PMECH, gENROE1.PMECH0) annotation (Line(points={{174,20},{180,
          20},{180,-20},{120,-20},{120,20},{128,20}}, color={0,0,127}));
  ...
  connect(constantLoad.p, pwLine1.p) annotation (Line(points={{47,-30},{46,-30},
          {46,10},{50,10},{50,30},{63,30}}, color={0,0,255}));
  ...
  connect(gENROE.EFD, gENROE.EFD0) annotation (Line(points={{-82,0},{-90,0},{
          -90,-20},{-34,-20},{-34,0},{-36,0}}, color={0,0,127}));

...
equation
  ...
  connect(avr.v, machine.v) annotation (Line(points={{0.833333,15},{-12,
          15},{-12,-34},{90,-34},{90,6},{82,6}},                                                         color={0,0,127}));
  ...
  connect(machine.p, pwPin) annotation (Line(points={{82,0},{96,0},{96,

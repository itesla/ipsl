...
model Example_2
  ...
  Tutorial.Example_2.Generator.Generator G1(
    ...
    Q_0=967.9249699065775) annotation (Placement(transformation(
          extent={{-110,-10},{-90,10}})));
  OpenIPSL.Electrical.Branches.PSAT.TwoWindingTransformer Transformer(
    ...
    r=0,
    V_b=400,
    Vn=400) annotation (Placement(transformation(extent={{-50,-10},{-30,
            10}})));
  ...
  OpenIPSL.Electrical.Events.PwFault fault(
    ...
    t1=0.5,
    t2=0.57,
    X=0.0004504504504504504) annotation (Placement(transformation(
          extent={{20,-60},{40,-40}})));
  OpenIPSL.Electrical.Branches.PwLine line_2(
    ...
    B=0,
    S_b=100,
    X=0.041891891891892) annotation (Placement(transformation(extent={
            {20,-30},{40,-10}})));
...
equation
  connect(G1.pwPin, B1.p) annotation (Line(points={{-89,0},{-89,0},{-70,
          0}}, color={0,0,255}));
  connect(B1.p, Transformer.p) annotation (Line(points={{-70,0},{-70,0},
          {-51,0}}, color={0,0,255}));
  connect(Transformer.n, B2.p) annotation (Line(points={{-29,0},{-20,0},
          {-10,0}}, color={0,0,255}));
  connect(B2.p, line_1.p) annotation (Line(points={{-10,0},{-10,0},{10,
          0},{10,20},{21,20}}, color={0,0,255}));
  connect(B3.p, infinite_bus.p) annotation (Line(points={{70,0},{70,0},
          {90,0},{90,1.33227e-15}}, color={0,0,255}));
  connect(B3.p, line_1.n) annotation (Line(points={{70,0},{70,0},{60,0},
          {60,20},{39,20}}, color={0,0,255}));
  connect(line_2.n, line_1.n) annotation (Line(points={{39,-20},{60,-20},
          {60,20},{39,20}}, color={0,0,255}));

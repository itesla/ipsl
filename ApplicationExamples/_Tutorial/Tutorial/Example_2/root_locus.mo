...
//  Modelica.Utilities.Streams.print(String(ss));
  ...
  {Modelica_LinearSystems2.Records.ParameterVariation(Name="G1.avr.K0",
  grid=Modelica_LinearSystems2.Types.Grid.Equidistant, Value=200,
  Min=0, Max=200, nPoints=50)});

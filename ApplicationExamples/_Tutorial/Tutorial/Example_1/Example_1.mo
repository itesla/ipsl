...
model Example_1
  ...
  OpenIPSL.Electrical.Events.PwFault fault(
    ...
    t1=0.5,
    t2=0.57,
    X=0.01*100/2220) annotation (Placement(transformation(extent={{20,
            -60},{40,-40}})));
  OpenIPSL.Electrical.Branches.PwLine line_2(
    ...
    B=0,
    S_b=100,
    X=0.93*100/2220) annotation (Placement(transformation(extent={{20,
            -30},{40,-10}})));
  inner OpenIPSL.Electrical.SystemBase SysData(fn=60) annotation (
      Placement(transformation(extent={{60,-100},{120,-60}})));
equation
  ...
  connect(line_1.n, B3.p) annotation (Line(points={{39,20},{60,20},{60,
          0},{70,0}}, color={0,0,255}));
  connect(B3.p, infinite_bus.p) annotation (Line(points={{70,0},{82,0},

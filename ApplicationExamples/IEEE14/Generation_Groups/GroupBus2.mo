...
model GroupBus2
  ...
  Modelica.Blocks.Sources.Constant const1(k=1.181847826013889)
    annotation (Placement(transformation(extent={{-94,24},{-68,50}})));
...
equation
  connect(aVR1TypeII1.vf, Syn3.vf) annotation (Line(points={{-3.75,23.94},{-2.65,
          23.94},{-2.65,16.5},{20,16.5}}, color={0,0,127}));
  connect(Syn3.v, aVR1TypeII1.v) annotation (Line(points={{89.3,9.5},{116,9.5},
          {116,-88},{-82,-88},{-82,-84},{-82,14},{-82,17.1},{-45,17.1}}, color=
          {0,0,127}));
  connect(const1.y, aVR1TypeII1.vref) annotation (Line(points={{-66.7,37},{-54,
          37},{-54,29.26},{-45,29.26}}, color={0,0,127}));
  connect(Syn3.p, pwPin) annotation (Line(points={{89.3,-0.82626},{110.65,-0.82626},
          {110.65,0},{132,0}}, color={0,0,255}));
  connect(Syn3.pm0, Syn3.pm) annotation (Line(points={{26.6,-39.5},{26.6,-50},{
          2,-50},{2,-18.5},{20,-18.5}}, color={0,0,127}));
  annotation (

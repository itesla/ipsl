...
equation
  ...
  connect(Syn2.v, aVR2TypeII2.v) annotation (Line(points={{96.8,8.5},{112,8.5},
          {112,-48},{-82,-48},{-82,-5.2},{-52,-5.2}}, color={0,0,127}));
  connect(Syn2.p, pwPin) annotation (Line(points={{96.8,1.1241},{115.4,1.1241},
          {115.4,-2},{130,-2}}, color={0,0,255}));
  connect(const2.y, aVR2TypeII2.vref) annotation (Line(points={{-64.8,18},{-52,
          18},{-52,15.28}}, color={0,0,127}));
  connect(Syn2.pm0, Syn2.pm) annotation (Line(points={{43.6,-26.5},{43.6,-34},{
          2,-34},{2,-11.5},{38,-11.5}}, color={0,0,127}));
  annotation (

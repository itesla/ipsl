...
partial model BaseNetwork
  ...
  OpenIPSL.Electrical.Loads.PSAT.LOADPQ pwLoadPQ2(
    ...
    angle_0=0) annotation (Placement(visible=true, transformation(
        ...
        rotation=90)));
  OpenIPSL.Electrical.Buses.Bus bus annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  OpenIPSL.Electrical.Buses.Bus bus1 annotation (Placement(transformation(extent={{30,-10},{50,10}})));
  OpenIPSL.Electrical.Buses.Bus bus2 annotation (Placement(transformation(extent={{70,10},{90,30}})));
  OpenIPSL.Electrical.Buses.Bus bus3 annotation (Placement(transformation(extent={{70,-20},{90,0}})));
  inner OpenIPSL.Electrical.SystemBase SysData annotation (Placement(transformation(extent={{-140,80},{-80,100}})));
equation
  connect(order4_Inputs_Outputs.pm, order4_Inputs_Outputs.pm0) annotation (Line(points={{-30,-6.25},{-32,-6.25},{-32,-6},{-34,-6},{-34,-16},{-27.8,-16},{-27.8,-13.15}}, color={0,0,127}));
  ...
  connect(bus3.p, pwLoadPQ2.p) annotation (Line(points={{80,-10},{87.3972,-10},{87.3972,-10.2889}}, color={0,0,255}));
  connect(pwLine3.n, bus3.p) annotation (Line(points={{67,-10},{73.5,-10},{80,-10}}, color={0,0,255}));
  connect(order4_Inputs_Outputs.p, bus.p) annotation (Line(points={{-6.9,-0.442914},{-3.45,-0.442914},{-3.45,0},{0,0}}, color={0,0,255}));
  annotation (

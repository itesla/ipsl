...
model FourthOrder_AVRII_Continuous
  ...
  Modelica.Blocks.Sources.Constant vref2(k=1.198705028536746) annotation (
      Placement(transformation(
        ...
        origin={-149,7})));
equation
  connect(order4.vf, aVRTypeII.vf) annotation (Line(points={{-112,5},{-114,5},{
          -114,4.6},{-117.5,4.6}}, color={0,0,127}));
  connect(vref2.y, aVRTypeII.vref) annotation (Line(points={{-143.5,7},{-138.75,
          7},{-138.75,7.4},{-134,7.4}}, color={0,0,127}));
  connect(aVRTypeII.v, order4.v) annotation (Line(points={{-134,1},{-138,1},{-138,
          -14},{-88,-14},{-88,3},{-91,3}}, color={0,0,127}));
  annotation (

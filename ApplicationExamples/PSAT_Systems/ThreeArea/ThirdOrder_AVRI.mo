...
model ThirdOrder_AVRI "ABC system with 3rd-order machines and AVR Type I"
  ...
  OpenIPSL.Electrical.Controls.PSAT.AVR.AVRTypeI Exc1(
    ...
    annotation (Placement(transformation(extent={{-144,80},{-134,90}})));
  ...
  Modelica.Blocks.Sources.Constant vref1(k=1.093835147859700) annotation (
      Placement(transformation(
        ...
        origin={175,21})));
equation
  connect(Exc2.vf, order3_2.vf) annotation (Line(points={{155.5,5.1},{154.75,
          5.1},{154.75,5},{152,5}}, color={0,0,127}));
  connect(vref1.y, Exc2.vref) annotation (Line(points={{171.7,21},{170,21},{170,
          7.8},{167.1,7.8}}, color={0,0,127}));
  connect(Exc2.v, order3_2.v) annotation (Line(points={{167.2,3.2},{172,3.2},{
          172,14},{128,14},{128,3},{131,3}}, color={0,0,127}));
  connect(Exc1.vf, order3_1.vf) annotation (Line(points={{-133.5,85.1},{-131.75,
          85.1},{-131.75,85},{-130,85}}, color={0,0,127}));
  connect(vref.y, Exc1.vref) annotation (Line(points={{-157.6,88},{-145.1,88},{
          -145.1,87.8}}, color={0,0,127}));
  connect(Exc1.v, order3_1.v) annotation (Line(points={{-145.2,83.2},{-148,83.2},
          {-148,96},{-106,96},{-106,83},{-109,83}}, color={0,0,127}));
  annotation (

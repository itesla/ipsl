...
model SixthOrder_AVRI "ABC system with 6th-order machines (Syn2) and AVR Type I"
  ...
  OpenIPSL.Electrical.Controls.PSAT.AVR.AVRTypeI Exc1(
    ...
    v(start=1.091853765980820)) annotation (Placement(transformation(extent={{-152,82},{-142,92}})));
...
equation
  connect(Exc1.vf, Syn2.vf) annotation (Line(points={{-141.5,87.1},{-138.75,87.1},{-138.75,86},{-136,86}}, color={0,0,127}));
  connect(vref.y, Exc1.vref) annotation (Line(points={{-165.6,90},{-153.1,90},{-153.1,89.8}}, color={0,0,127}));
  connect(Exc1.v, Syn2.v) annotation (Line(points={{-153.2,85.2},{-158,85.2},{-158,96},{-108,96},{-108,83.6},{-110.8,83.6}}, color={0,0,127}));

...
equation
  connect(vref.y, Exc1.vref) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(Syn2.vf, Exc1.vf) annotation (Line(points={{-136,86},{-138,86},{-138,
          86.3},{-140.75,86.3}}, color={0,0,127}));
  connect(Exc1.v, Syn2.v) annotation (Line(points={{-149,84.5},{-154,84.5},{-154,
          96},{-108,96},{-108,83.6},{-110.8,83.6}}, color={0,0,127}));
  connect(order3_2.vf, Exc2.vf) annotation (Line(points={{152,5},{156,5},{156,
          4.3},{156.75,4.3}}, color={0,0,127}));
  connect(Exc2.v, order3_2.v) annotation (Line(points={{165,2.5},{168,2.5},{168,
          14},{128,14},{128,3},{131,3}}, color={0,0,127}));
  connect(vref1.y, Exc2.vref)
    annotation (Line(points={{171.6,24},{165,24},{165,5.7}}, color={0,0,127}));
  annotation (

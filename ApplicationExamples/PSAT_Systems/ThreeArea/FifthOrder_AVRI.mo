...
model FifthOrder_AVRI "ABC system with 5th-order machines Type II (Syn2) and AVR Type I"
  ...
  OpenIPSL.Electrical.Controls.PSAT.AVR.AVRTypeI Exc1(
    ...
    v(start=1.091853765980820)) annotation (Placement(transformation(extent={{-154,80},{-144,90}})));
...
equation
  connect(order3_2.vf, Exc2.vf) annotation (Line(points={{152,5},{154,5},{154,5.1},{155.5,5.1}}, color={0,0,127}));
  connect(Exc2.v, order3_2.v) annotation (Line(points={{167.2,3.2},{170,3.2},{170,14},{128,14},{128,3},{131,3}}, color={0,0,127}));
  connect(vref1.y, Exc2.vref) annotation (Line(points={{173.7,23},{172,23},{172,7.8},{167.1,7.8}}, color={0,0,127}));
  connect(Exc1.vf, Syn2.vf) annotation (Line(points={{-143.5,85.1},{-142.75,85.1},{-142.75,86},{-140,86}}, color={0,0,127}));
  connect(vref.y, Exc1.vref) annotation (Line(points={{-169.6,88},{-155.1,88},{-155.1,87.8}}, color={0,0,127}));
  connect(Exc1.v, Syn2.v) annotation (Line(points={{-155.2,83.2},{-160,83.2},{-160,98},{-110,98},{-110,83.6},{-114.8,83.6}}, color={0,0,127}));
  annotation (

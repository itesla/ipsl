...
equation
  ...
  connect(vref1.y, Exc2.vref) annotation (Line(points={{173.7,23},{168,23},{168,
  ...
  connect(Exc1.vf, order4_1.vf) annotation (Line(points={{-144.75,86.3},{-143.375,
          86.3},{-143.375,86},{-140,86}}, color={0,0,127}));
  connect(vref.y, Exc1.vref) annotation (Line(points={{-161.6,88},{-153,88},{-153,
          87.7}}, color={0,0,127}));
  connect(Exc1.v, order4_1.v) annotation (Line(points={{-153,84.5},{-156,84.5},
          {-156,96},{-112,96},{-112,83.6},{-114.8,83.6}}, color={0,0,127}));
  annotation (

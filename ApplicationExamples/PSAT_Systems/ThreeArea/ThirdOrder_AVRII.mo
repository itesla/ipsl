...
equation
  connect(Exc1.vf, order3_1.vf) annotation (Line(points={{-134.75,84.3},{-132.375,84.3},{-132.375,85},{-130,85}}, color={0,0,127}));
  connect(vref.y, Exc1.vref) annotation (Line(points={{-151.6,86},{-143,86},{-143,85.7}}, color={0,0,127}));
  connect(Exc1.v, order3_1.v) annotation (Line(points={{-143,82.5},{-146,82.5},{-146,94},{-106,94},{-106,83},{-109,83}}, color={0,0,127}));
  connect(Exc2.vf, order3_2.vf) annotation (Line(points={{156.75,4.3},{154.375,4.3},{154.375,5},{152,5}}, color={0,0,127}));
  connect(vref1.y, Exc2.vref) annotation (Line(points={{171.7,17},{168,17},{168,5.7},{165,5.7}}, color={0,0,127}));

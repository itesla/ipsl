...
model ThirdOrder_AVRII "5-bus system with 3rd-order machine and AVR Type II"
  ...
  Modelica.Blocks.Sources.Constant vref2(k=1.198705028536746) annotation (
      Placement(transformation(
        ...
        origin={-151,7})));
equation
  connect(vref2.y, aVRTypeII.vref) annotation (Line(points={{-145.5,7},{-141.75,
          7},{-141.75,7.4},{-138,7.4}}, color={0,0,127}));
  connect(aVRTypeII.vf, order3.vf) annotation (Line(points={{-121.5,4.6},{-117.75,
          4.6},{-117.75,5},{-112,5}}, color={0,0,127}));
  connect(aVRTypeII.v, order3.v) annotation (Line(points={{-138,1},{-140,1},{-140,

package ThreePhase
  package Buses
    model InfiniteBus
       ...
       parameter Real Vb=400 "Base voltage of the bus (kV)" annotation (Dialog(group="Power flow data"));
       parameter Real V_A=1 "Voltage magnitude (pu)" annotation (Dialog(group="Power flow data"));
       parameter Real angle_A=0 "Voltage angle for phase A (deg)" annotation (Dialog(group="Power flow data"));
       parameter Real V_B=1 "Voltage magnitude (pu)" annotation (Dialog(group="Power flow data"));
       parameter Real angle_B=-120 "Voltage angle for phase A (deg)" annotation (Dialog(group="Power flow data"));
       parameter Real V_C=1 "Voltage magnitude (pu)" annotation (Dialog(group="Power flow data"));
       parameter Real angle_C=120 "Voltage angle for phase A (deg)" annotation (Dialog(group="Power flow data"));

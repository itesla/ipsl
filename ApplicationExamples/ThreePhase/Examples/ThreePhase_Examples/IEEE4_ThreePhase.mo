...
equation
  ...
  connect(InfiniteBus.p2, Bus1.p2) annotation (Line(points={{-79,0},{-66,0},{
          -66,0},{-66,0}}, color={0,0,255}));
  connect(InfiniteBus.p1, Bus1.p1) annotation (Line(points={{-79,9},{-66,9},{
          -66,9},{-66,9}}, color={0,0,255}));

...
protected
    ...
    parameter Real[6,6] Y_ser=[Gseraa,-Bseraa,Gserab,-Bserab,Gserac,-Bserac; Bseraa,Gseraa,Bserab,Gserab,Bserac,Gserac; Gserab,-Bserab,Gserbb,-Bserbb,Gserbc,-Bserbc; Bserab,Gserab,Bserbb,Gserbb,Bserbc,Gserbc; Gserac,-Bserac,Gserbc,-Bserbc,Gsercc,-Bsercc; Bserac,Gserac,Bserbc,Gserbc,Bsercc,Gsercc];

    //Writing the Y_sht matrix for the pi model
    parameter Real[6,6] Y_sht=[zero,-Bshtaa,zero,-Bshtab,zero,-Bshtac; Bshtaa,zero,Bshtab,zero,Bshtac,zero; zero,-Bshtab,zero,-Bshtbb,zero,-Bshtbc; Bshtab,zero,Bshtbb,zero,Bshtbc,zero; zero,-Bshtac,zero,-Bshtbc,zero,-Bshtcc; Bshtac,zero,Bshtbc,zero,Bshtcc,zero];

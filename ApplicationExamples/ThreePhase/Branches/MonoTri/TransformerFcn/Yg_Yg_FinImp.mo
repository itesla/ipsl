...
protected
  ...
  parameter Real[1, 18] Yser=[Gser, Bser, 0, 0, 0, 0, 0, 0, Gser, Bser, 0, 0, 0,
      0, 0, 0, Gser, Bser];
  //Writing the Y_sht_k matrix according to Simulight
  parameter Real[1, 18] Yshtk=[Gshk, Bshk, 0, 0, 0, 0, 0, 0, Gshk, Bshk, 0, 0,
      0, 0, 0, 0, Gshk, Bshk];
  //Writing the Y_sht_m matrix according to Simulight
  parameter Real[1, 18] Yshtm=[Gshm, Bshm, 0, 0, 0, 0, 0, 0, Gshm, Bshm, 0, 0,
      0, 0, 0, 0, Gshm, Bshm];

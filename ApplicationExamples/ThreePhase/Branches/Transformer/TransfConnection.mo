...
protected
  ...
  parameter Real[6,6] Y_ser=[Gser,-Bser,zero,zero,zero,zero; Bser,Gser,zero,zero,zero,zero; zero,zero,Gser,-Bser,zero,zero; zero,zero,Bser,Gser,zero,zero; zero,zero,zero,zero,Gser,-Bser;zero,zero,zero,zero,Bser,Gser];

  //Writing the Y_sht_k matrix according to Simulight  
  parameter Real[6,6] Yshtk=[Gshk,-Bshk,zero,zero,zero,zero; Bshk,Gshk,zero,zero,zero,zero; zero,zero,Gshk,-Bshk,zero,zero; zero,zero,Bshk,Gshk,zero,zero; zero,zero,zero,zero,Gshk,-Bshk;zero,zero,zero,zero,Bshk,Gshk];

  //Writing the Y_sht_m matrix according to Simulight
  parameter Real[6,6] Yshtm=[Gshm,-Bshm,zero,zero,zero,zero; Bshm,Gshm,zero,zero,zero,zero; zero,zero,Gshm,-Bshm,zero,zero; zero,zero,Bshm,Gshm,zero,zero; zero,zero,zero,zero,Gshm,-Bshm;zero,zero,zero,zero,Bshm,Gshm];
...
algorithm
  ...
  protected
    ...
    sGser,-sBser,mGser,-mBser,mGser,-mBser; sBser,sGser,mBser,mGser,mBser,mGser;
    mGser,-mBser,sGser,-sBser,mGser,-mBser; mBser,mGser,sBser,sGser,mBser,mGser;
    mGser,-mBser,mGser,-mBser,sGser,-sBser; mBser,mGser,mBser,mGser,sBser,sGser];

    //Writing the Y_sht_k matrix according to Simulight
    parameter Real[6,6] Yshtk=[sGshk,-sBshk,mGshk,-mBshk,mGshk,-mBshk; sBshk,sGshk,mBshk,mGshk,mBshk,mGshk; mGshk,-mBshk,sGshk,-sBshk,mGshk,-mBshk; mBshk,mGshk,sBshk,sGshk,mBshk,mGshk; mGshk,-mBshk,mGshk,-mBshk,sGshk,-sBshk; mBshk,mGshk,mBshk,mGshk,sBshk,sGshk];
  ...
  protected  
    ...
    //Writing the Y_ser matrix according to Simulight
    parameter Real[6,6] Y_ser=[sGser,-sBser,mGser,-mBser,mGser,-mBser; sBser,sGser,mBser,mGser,mBser,mGser; mGser,-mBser,sGser,-sBser,mGser,-mBser; mBser,mGser,sBser,sGser,mBser,mGser; mGser,-mBser,mGser,-mBser,sGser,-sBser; mBser,mGser,mBser,mGser,sBser,sGser];
  ...
  protected
    ...
    parameter Real[6,6] Y_ser1=[sGser,-sBser,zero,zero,mGser,-mBser; sBser,sGser,zero,zero,mBser,mGser; mGser,-mBser,sGser,-sBser,zero,zero; mBser,mGser,sBser,sGser,zero,zero; zero,zero,mGser,-mBser,sGser,-sBser; zero,zero,mBser,mGser,sBser,sGser];
 
    //Writing the Y_ser2 matrix according to Simulight
    parameter Real[6,6] Y_ser2=[sGser,-sBser,mGser,-mBser,zero,zero; sBser,sGser,mBser,mGser,zero,zero; zero,zero,sGser,-sBser,mGser,-mBser; zero,zero,sBser,sGser,mBser,mGser; mGser,-mBser,zero,zero,sGser,-sBser; mBser,mGser,zero,zero,sBser,sGser];

    //Writing the Y_sht_k matrix according to Simulight
    parameter Real[6,6] Yshtk=[sGshk,-sBshk,mGshk,-mBshk,nGshk,-nBshk; sBshk,sGshk,mBshk,mGshk,nBshk,nGshk; nGshk,-nBshk,sGshk,-sBshk,mGshk,-mBshk; nBshk,nGshk,sBshk,sGshk,mBshk,mGshk; mGshk,-mBshk,nGshk,-nBshk,sGshk,-sBshk; mBshk,mGshk,nBshk,nGshk,sBshk,sGshk];

    //Writing the Y_sht_m matrix according to Simulight
    parameter Real[6,6] Yshtm=[sGshm,-sBshm,mGshm,-mBshm,zero,zero; sBshm,sGshm,mBshm,mGshm,zero,zero; zero,zero,sGshm,-sBshm,mGshm,-mBshm; zero,zero,sBshm,sGshm,mBshm,mGshm; mGshm,-mBshm,zero,zero,sGshm,-sBshm; mBshm,mGshm,zero,zero,sBshm,sGshm];
  ...
  protected
    ...
    //Writing the Y_ser1 matrix according to Simulight
    parameter Real[6,6] Y_ser1=[sGser,-sBser,mGser,-mBser,zero,zero; sBser,sGser,mBser,mGser,zero,zero; zero,zero,sGser,-sBser,mGser,-mBser; zero,zero,sBser,sGser,mBser,mGser; mGser,-mBser,zero,zero,sGser,-sBser; mBser,mGser,zero,zero,sBser,sGser];

    //Writing the Y_ser2 matrix according to Simulight
    parameter Real[6,6] Y_ser2=[sGser,-sBser,zero,zero,mGser,-mBser; sBser,sGser,zero,zero,mBser,mGser; mGser,-mBser,sGser,-sBser,zero,zero; mBser,mGser,sBser,sGser,zero,zero; zero,zero,mGser,-mBser,sGser,-sBser; zero,zero,mBser,mGser,sBser,sGser];

    //Writing the Y_sht_k matrix according to Simulight
    parameter Real[6,6] Yshtk=[sGshk,-sBshk,sGser,-sBser,zero,zero; sBshk,sGshk,sBser,sGser,zero,zero; zero,zero,sGshk,-sBshk,sGser,-sBser; zero,zero,sBshk,sGshk,sBser,sGser; sGser,-sBser,zero,zero,sGshk,-sBshk; sBser,sGser,zero,zero,sBshk,sGshk];

     //Writing the Y_sht_m matrix according to Simulight
    parameter Real[6,6] Yshtm=[sGshm,-sBshm,mGshm,-mBshm,nGshm,-nBshm; sBshm,sGshm,mBshm,mGshm,nBshm,nGshm; nGshm,-nBshm,sGshm,-sBshm,mGshm,-mBshm; nBshm,nGshm,sBshm,sGshm,mBshm,mGshm; mGshm,-mBshm,nGshm,-nBshm,sGshm,-sBshm; mBshm,mGshm,nBshm,nGshm,sBshm,sGshm]; 
  ...
  protected
    ...
    //Writing the Y_sht_m matrix according to Simulight
    parameter Real[6,6] Yshtm=[sGshm,-sBshm,mGshm,-mBshm,mGshm,-mBshm; sBshm,sGshm,mBshm,mGshm,mBshm,mGshm; mGshm,-mBshm,sGshm,-sBshm,mGshm,-mBshm; mBshm,mGshm,sBshm,sGshm,mBshm,mGshm; mGshm,-mBshm,mGshm,-mBshm,sGshm,-sBshm; mBshm,mGshm,mBshm,mGshm,sBshm,sGshm];

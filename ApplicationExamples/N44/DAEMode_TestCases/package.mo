...
package DAEMode_TestCases "Test cases used to verify the efficiency of the Dymola DAE mode 
  ...
  annotation (uses(OpenIPSL(version="1.5.0")), Documentation(info="<html>
...
<p><br>More information about the models and the expected results may be found in GitHub page available in this <a href=\"https://github.com/ALSETLab/2019_Modelica_Conf_DAESolvers4LargeHybridModels\">link</a>.</p>
</html>"));

...
equation
  ...
  connect(cte.y, sCRX.VOEL) annotation (Line(points={{-6.5,-48},{44.85,-48},{44.85,-90}}, color={0,0,127}));
  connect(gENSAL.EFD0, sCRX.EFD0) annotation (Line(points={{2.48,-18.7},{10,-18.7},{10,-77.9444},{26,-77.9444}}, color={0,0,127}));
  connect(gENSAL.XADIFD, sCRX.XADIFD) annotation (Line(points={{2.48,-24.9},{14,-24.9},{14,-67.6111},{26,-67.6111}}, color={0,0,127}));
  connect(gENSAL.ETERM, sCRX.ECOMP) annotation (Line(points={{2.48,18.5},{22,18.5},{22,-55.5556},{26,-55.5556}}, color={0,0,127}));
  connect(sCRX.EFD, gENSAL.EFD) annotation (Line(points={{85.45,-55.5556},{92,-55.5556},{92,-94},{-72,-94},{-72,-12.5},{-61.38,-12.5}}, color={0,0,127}));
  ...
  connect(sCRX.VOTHSG, cte.y) annotation (Line(points={{26,-40.0556},{4,-40.0556},{4,-48},{-6.5,-48}}, color={0,0,127}));
  connect(sCRX.VUEL, cte.y) annotation (Line(points={{36.15,-90},{4,-90},{4,-48},{-6.5,-48}}, color={0,0,127}));

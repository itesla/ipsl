...
model Loadtestpq
  ...
  OpenIPSL.Electrical.Machines.PSAT.Order3 order3_Inputs_Outputs1(
    ...
    xq=1.7) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  FOSSEE1.Loads.PSAT.ThermostaticallyControlledLoad2 LOADPQ1(
    Sn=10,
    P_0=0.8,
...
equation
  connect(pwLine4.n, LOADPQ1.p) annotation (Line(
      ...
      points={{-7.5768,0},{20.5772,0},{20.5772,-20}}));
  ...
  connect(pwLine2.n, pwLine4.p) annotation (Line(
      ...
      points={{-18.3525,13.6643},{4.7841,13.6643},{4.7841,0.3357},{8.7841,0.3357}}));

...
model Loadtest1
  ...
  Modelica.Blocks.Sources.Constant Tref(k=70)
    annotation (Placement(transformation(extent={{80,-45},{95,-30}})));
  Modelica.Blocks.Sources.Constant T_a(k=10)
    annotation (Placement(transformation(extent={{100,-75},{115,-60}})));
equation
  connect(pwLine4.n, ThLoad.p) annotation (Line(
      visible=true,
      origin={101.577,10},
      points={{-7.577,0},{25.577,0},{25.577,-25}}));
  ...
  connect(pwLine2.p, pwLine1.p) annotation (Line(
      ...
      points={{-2,10},{-2,5},{-5,5},{-5,0},{-2,0},{-2,-10}}));
  connect(T_a.y, ThLoad.t_a) annotation (Line(points={{115.75,-67.5},{125,-67.5},

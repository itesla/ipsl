...
class ImMult5 "Product Block.
  ...
  parameter Real a0 = 0 "Offset";
  parameter Real a1 = 1 "Entry 1 gain";
  parameter Real a2 = 1 "Entry 2 gain";
  parameter Real a3 = 1 "Entry 3 gain";
  parameter Real a4 = 1 "Entry 4 gain";
  parameter Real a5 = 1 "Entry 5 gain";
  //parameter Real nStartValue = 0;
equation

...
parameter Real CurHVRCR "Max. reactive current at VHVRCR";
  Modelica.Blocks.Interfaces.RealInput Vt
    annotation (Placement(transformation(extent={{-9,-9},{9,9}},
        ...
        rotation=90,
        origin={2,-28})));
  Modelica.Blocks.Interfaces.RealOutput Iq_HVRCL
    annotation (Placement(transformation(extent={{42,4},{60,22}}),
        iconTransformation(extent={{42,4},{60,22}})));
...
if Vt>VHVRCR then
 Iq_HVRCL=CurHVRCR;
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,
          ...
          Rectangle(extent={{-28,42},{40,-20}}, lineColor={0,0,255}), Text(
          extent={{-20,46},{38,10}},
          lineColor={0,0,255},
          textString="HVRCL "),
        Line(

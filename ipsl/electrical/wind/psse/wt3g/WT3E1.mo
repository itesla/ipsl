...
model WT3E1
 ...
 parameter Integer VARFLG
    "0 constant Q; 1 Reactive control; -1 Constant PF control"
        annotation (choices(choice=0 "0 constant Q",
...
public
  Modelica.Blocks.Interfaces.RealInput Pelec
    annotation (Placement(transformation(extent={{-120,-76},{-90,-46}}),
  ...
  Modelica.Blocks.Interfaces.RealOutput WEQCMD
    annotation (Placement(transformation(extent={{176,32},{194,50}}),
        iconTransformation(extent={{148,64},{166,82}})));
  Modelica.Blocks.Interfaces.RealOutput WNDSP1
    annotation (Placement(transformation(extent={{20,-126},{38,-108}}),
        iconTransformation(
        extent={{-9,-9},{9,9}},
        rotation=270,
        origin={-47,-113})));
  Modelica.Blocks.Interfaces.RealOutput WPCMND
    annotation (Placement(transformation(extent={{144,-104},{162,-86}}),
        iconTransformation(
        extent={{-9,-9},{9,9}},
        rotation=270,
        origin={15,-113})));
  ...
  Modelica.Blocks.Sources.Constant Qcmd0(k=Qref)
...
protected
  ...
  Modelica.Blocks.Interfaces.RealInput ShaftSpeed=sp0
    annotation (Placement(transformation(extent={{-122,-50},{-88,-16}}),
        iconTransformation(extent={{-12,-12},{12,12}},
        rotation=90,
        origin={80,-92})));
public
  ...
  Modelica.Blocks.Interfaces.RealInput WIPCMD0 annotation (Placement(
        transformation(extent={{-216,-52},{-184,-20}}),
                                                      iconTransformation(
        extent={{-12,-12},{12,12}},
        rotation=270,
        origin={54,78})));
...
"),     Rectangle(
          ...
          lineThickness=0.5),
        Line(
          points={{-86,-54},{-86,-74},{-58,-74},{-60,-72},{-60,-76},{-58,-74},{-58,
              -74}},
          color={0,0,255},
          smooth=Smooth.None,
          thickness=0.5),
...
",        textStyle={TextStyle.Bold}),
        ...
        Line(
          ...
          color={0,0,255},
          thickness=0.5,
          smooth=Smooth.None)}),          Icon(coordinateSystem(extent={{-200,-140},
            {180,140}},       preserveAspectRatio=true), graphics={
          Rectangle(extent={{-96,90},{148,-104}},  lineColor={0,0,255}),
          Text(
          extent={{-74,68},{106,-76}},
          lineColor={0,0,255},

...
equation
  ...
  connect(order6Type2_Inputs_Outputs.vf0, order6Type2_Inputs_Outputs.vf) annotation(Line(points={{-60,
          69.9},{28,69.9},{28,80},{-88,80},{-88,46.5},{-68,46.5}},                                                                                                    color = {0, 0, 127}, smooth = Smooth.None));
  connect(order6Type2_Inputs_Outputs.w, tGTypeI.w) annotation(Line(points={{16,62.1},
          {30,62.1},{30,-38.7},{-8.325,-38.7}},                                                                                   color = {0, 0, 127}, smooth = Smooth.None));
  connect(tGTypeI.pm, order6Type2_Inputs_Outputs.pm) annotation(Line(points={{-56.175,
          -39.14},{-88,-39.14},{-88,7.5},{-68,7.5}},                                                                                        color = {0, 0, 127}, smooth = Smooth.None));

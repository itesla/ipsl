...
model HYGOV
  ...
  iPSL.Electrical.Machines.PSSE.GENCLS.GENCLS gENCLS(
    ...
    angle_0=-3.00563e-7,
    M_b=100)
    annotation (Placement(transformation(extent={{92,-10},{70,12}})));
  ...
  iPSL.Electrical.Controls.PSSE.ES.SCRX.SCRX SCRX(
    ...
    E_MAX=5,
    C_SWITCH=0,
    r_cr_fd=0)            annotation (Placement(transformation(
        extent={{-18,-16},{18,16}},
        rotation=180,
        origin={-66,-26})));
...
equation
  ...
  connect(pwLine1.n, gENCLS.p) annotation(Line(points={{27,24},{58,24},{58,0.834604},
          {67.8,0.834604}},                                                                                     color = {0, 0, 255}, smooth = Smooth.None));
  ...
  connect(pwLine4.n, gENCLS.p) annotation(Line(points={{37,-10},{58,-10},{58,0.834604},
          {67.8,0.834604}},                                                                                       color = {0, 0, 255}, smooth = Smooth.None));
  connect(constantLoad.p, pwLine3.p) annotation(Line(points={{12,-14.8},{12,-27.5},{-3,
          -27.5},{-3,-10}},                                                                                         color = {0, 0, 255}, smooth = Smooth.None));
  connect(SCRX.VUEL, const.y) annotation(Line(points={{-48.15,-21.04},{-43.67,-21.04},
          {-43.67,-24},{-42.2,-24}},                                                                                      color = {0, 0, 127}, smooth = Smooth.None));
  connect(SCRX.VOEL, const.y) annotation(Line(points={{-48.15,-25.2},{-43.67,-25.2},
          {-43.67,-24},{-42.2,-24}},                                                                                      color = {0, 0, 127}, smooth = Smooth.None));
  connect(SCRX.VOTHSG, const.y) annotation(Line(points={{-48.15,-29.04},{-43.67,
          -29.04},{-43.67,-24},{-42.2,-24}},                                                                                color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(generator.EFD0, SCRX.EFD0) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(generator.PMECH0, HYGOV.PMECH0) annotation (Line(points={{-59.2,7},{
          -36,7},{-36,55},{-46.475,55}},    color={0,0,127}));
  connect(generator.SPEED, HYGOV.SPEED) annotation (Line(points={{-59.2,19},{
          -42,19},{-42,41},{-46.475,41}},   color={0,0,127}));
  connect(HYGOV.PMECH, generator.PMECH) annotation (Line(points={{-84.95,48},{
          -94,48},{-94,15},{-79.8,15}},  color={0,0,127}));
  ...
  connect(generator.XADIFD, SCRX.XADIFD) annotation (Line(points={{-59.2,1},{
          -42,1},{-42,-17.52},{-47.85,-17.52}},     color={0,0,127}));

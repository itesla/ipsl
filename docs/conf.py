# -*- coding: utf-8 -*-
#
# OpenIPSL documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'OpenIPSL.tex', u'OpenIPSL Documentation',
     u'Maxime', 'manual'),
]

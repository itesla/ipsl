...
model REN_SMIB1L_Group2
  ...
  REN.REN_Groups.Configuration.RGroup2 group2 annotation (Placement(transformation(rotation=0, extent={{-70,-10},{-50,10}})));
  ...
  inner iPSL.Electrical.SystemBase SysData(S_b=1000) annotation (Placement(transformation(extent={{-40,60},{-16,80}})));
equation

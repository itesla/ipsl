...
model REN_SMIB1L_Group1_4
  ...
  REN.REN_Groups.Configuration.RGroup1_4 group1_4 annotation (Placement(transformation(rotation=0, extent={{-84,-10},{-64,10}})));
  inner iPSL.Electrical.SystemBase SysData(S_b=1000) annotation (Placement(transformation(extent={{-46,52},{-22,72}})));
equation

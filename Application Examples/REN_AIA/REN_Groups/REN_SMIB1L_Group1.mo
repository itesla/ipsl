...
model REN_SMIB1L_Group1 "test"
  ...
  REN.REN_Groups.Configuration.RGroup1 group1 annotation (Placement(transformation(rotation=0, extent={{-68,18},{-48,38}})));
  inner iPSL.Electrical.SystemBase SysData(S_b=1000) annotation (Placement(transformation(extent={{-80,80},{-34,100}})));
equation

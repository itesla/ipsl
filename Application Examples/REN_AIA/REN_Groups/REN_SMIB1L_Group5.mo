...
model REN_SMIB1L_Group5
  ...
  iPSL.Electrical.Events.PwFault pwFault(
    ...
    X=-0.5,
    t1=10,
    t2=10.15) annotation (Placement(transformation(extent={{47,-56},{67,-36}})));
  ...
  REN.REN_Groups.Configuration.RGroup5 group5 annotation (Placement(transformation(rotation=0, extent={{-56,-10},{-36,10}})));
  inner iPSL.Electrical.SystemBase SysData(S_b=1000) annotation (Placement(transformation(extent={{-76,62},{-52,82}})));
equation

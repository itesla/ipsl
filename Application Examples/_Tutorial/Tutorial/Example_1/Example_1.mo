...
model Example_1
  ...
  Generator.Generator G1(
    ...
    displayPF=false)       annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
  ...
  OpenIPSL.Electrical.Events.PwFault fault(
    ...
    t1=0.5,
    t2=0.57,
    X=0.01*100/2220) annotation (Placement(transformation(extent={{10,-60},
            {30,-40}})));
...
equation
  ...
  connect(B2.p, line_1.p) annotation (Line(points={{-20,0},{-14,0},{
          -10,0},{-10,20},{11,20}},                                                           color={0,0,255}));
  connect(line_1.n, B3.p) annotation (Line(points={{29,20},{50,20},{
          50,0},{60,0}},                                                           color={0,0,255}));
  connect(B3.p, infinite_bus.p) annotation (Line(points={{60,0},{72,0},
          {72,1.33227e-15},{80,1.33227e-15}},                                                                color={0,0,255}));
  connect(line_2.n, B3.p) annotation (Line(points={{29,-20},{50,-20},
          {50,0},{60,0}},                                                            color={0,0,255}));
  connect(fault.p, B2.p) annotation (Line(points={{8.33333,-50},{-10,
          -50},{-10,0},{-20,0}}, color={0,0,255}));
  connect(line_2.p, B2.p) annotation (Line(points={{11,-20},{-10,-20},

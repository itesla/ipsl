...
package Namsskogan_Grid
  ...
  model Grid_Model
    ...
    iPSL.Electrical.Buses.BusExt B1(
      V_b=132,
      nu=1,
      V_0=V1,
      ...
      no=1) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={208,-134})));
    iPSL.Electrical.Buses.BusExt B2(
      V_b=132,
      no=3,
      nu=1,
      V_0=V2,
      angle_0=Modelica.SIunits.Conversions.to_deg(A2)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={162,-82})));
    iPSL.Electrical.Buses.BusExt B3(
      V_b=6.6,
      no=1,
      nu=1,
      V_0=V3,
      angle_0=Modelica.SIunits.Conversions.to_deg(A3)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={290,-96})));
    iPSL.Electrical.Buses.BusExt B4(
      V_b=132,
      no=1,
      nu=1,
      V_0=V4,
      angle_0=Modelica.SIunits.Conversions.to_deg(A4)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={134,-32})));
    iPSL.Electrical.Buses.BusExt B5(
      V_b=22,
      no=4,
      V_0=V5,
      ...
      nu=1) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={106,2})));
    iPSL.Electrical.Buses.BusExt B6(
      V_b=22,
      no=2,
      nu=2,
      V_0=V6,
      angle_0=Modelica.SIunits.Conversions.to_deg(A6)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={18,18})));
    iPSL.Electrical.Buses.BusExt B7(
      V_b=22,
      no=1,
      nu=2,
      V_0=V7,
      angle_0=Modelica.SIunits.Conversions.to_deg(A7)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-12,-44})));
    iPSL.Electrical.Buses.BusExt B8(
      V_b=6.6,
      no=1,
      nu=1,
      V_0=V8,
      angle_0=Modelica.SIunits.Conversions.to_deg(A8)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-40,-92})));
    iPSL.Electrical.Buses.BusExt B9(
      V_b=22,
      no=1,
      nu=1,
      V_0=V9,
      angle_0=Modelica.SIunits.Conversions.to_deg(A9)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={58,-82})));
    iPSL.Electrical.Buses.BusExt B10(
      V_b=6.6,
      no=1,
      nu=1,
      V_0=V10,
      angle_0=Modelica.SIunits.Conversions.to_deg(A10)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={58,-124})));
    iPSL.Electrical.Buses.BusExt B11(
      V_b=22,
      no=3,
      nu=2,
      V_0=V11,
      angle_0=Modelica.SIunits.Conversions.to_deg(A11)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-82,16})));
    iPSL.Electrical.Buses.BusExt B12(
      V_b=22,
      no=1,
      nu=1,
      V_0=V12,
      angle_0=Modelica.SIunits.Conversions.to_deg(A12)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-110,-60})));
    iPSL.Electrical.Buses.BusExt B13(
      V_b=6.6,
      no=1,
      nu=1,
      V_0=V13,
      angle_0=Modelica.SIunits.Conversions.to_deg(A13)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-122,-118})));
    iPSL.Electrical.Buses.BusExt B14(
      V_b=22,
      no=1,
      nu=1,
      V_0=V14,
      angle_0=Modelica.SIunits.Conversions.to_deg(A14)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-106,80})));
    iPSL.Electrical.Buses.BusExt B15(
      V_b=0.69,
      no=1,
      nu=1,
      V_0=V15,
      angle_0=Modelica.SIunits.Conversions.to_deg(A15)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-42,114})));
    iPSL.Electrical.Buses.BusExt B16(
      V_b=22,
      no=2,
      nu=1,
      V_0=V16,
      angle_0=Modelica.SIunits.Conversions.to_deg(A16)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-194,-18})));
    iPSL.Electrical.Buses.BusExt B17(
      V_b=22,
      nu=1,
      V_0=V17,
      ...
      no=1) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-214,-66})));
    iPSL.Electrical.Buses.BusExt B18(
      V_b=6.6,
      no=1,
      nu=1,
      V_0=V18,
      angle_0=Modelica.SIunits.Conversions.to_deg(A18)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-228,-112})));
    iPSL.Electrical.Buses.BusExt B19(
      V_b=22,
      no=2,
      nu=1,
      V_0=V19,
      angle_0=Modelica.SIunits.Conversions.to_deg(A19)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-266,-12})));
    iPSL.Electrical.Buses.BusExt B20(
      V_b=6.6,
      no=1,
      nu=1,
      V_0=V20,
      angle_0=Modelica.SIunits.Conversions.to_deg(A20)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-310,-72})));
    iPSL.Electrical.Buses.BusExt B21(
      V_b=22,
      no=1,
      nu=1,
      V_0=V21,
      angle_0=Modelica.SIunits.Conversions.to_deg(A21)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-318,50})));
    iPSL.Electrical.Buses.BusExt B22(
      V_b=6.6,
      nu=1,
      V_0=V22,
      ...
      no=1) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-288,122})));
    iPSL.Electrical.Buses.BusExt B23(
      V_b=22,
      no=3,
      nu=1,
      V_0=V23,
      angle_0=Modelica.SIunits.Conversions.to_deg(A23)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={98,62})));
    iPSL.Electrical.Buses.BusExt B24(
      V_b=22,
      no=1,
      V_0=V24,
      ...
      nu=1) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={192,44})));
    iPSL.Electrical.Buses.BusExt B25(
      V_b=0.69,
      no=1,
      nu=1,
      V_0=V25,
      angle_0=Modelica.SIunits.Conversions.to_deg(A25)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={240,-2})));
    iPSL.Electrical.Buses.BusExt B26(
      V_b=22,
      no=2,
      nu=4,
      V_0=V26,
      angle_0=Modelica.SIunits.Conversions.to_deg(A26)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={98,110})));
    iPSL.Electrical.Buses.BusExt B27(
      V_b=22,
      no=2,
      nu=1,
      V_0=V27,
      angle_0=Modelica.SIunits.Conversions.to_deg(A27)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={196,94})));
    iPSL.Electrical.Buses.BusExt B28(
      V_b=0.69,
      no=1,
      V_0=V28,
      ...
      nu=1) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={266,56})));
    iPSL.Electrical.Buses.BusExt B29(
      V_b=22,
      nu=1,
      V_0=V29,
      ...
      no=1) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={322,96})));
    iPSL.Electrical.Buses.BusExt B30(
      V_b=6.6,
      no=1,
      nu=1,
      V_0=V30,
      angle_0=Modelica.SIunits.Conversions.to_deg(A30)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={342,18})));
    iPSL.Electrical.Buses.BusExt B31(
      V_b=22,
      no=1,
      nu=1,
      V_0=V31,
      angle_0=Modelica.SIunits.Conversions.to_deg(A31)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={94,158})));
    iPSL.Electrical.Buses.BusExt B32(
      V_b=22,
      no=2,
      nu=1,
      V_0=V32,
      angle_0=Modelica.SIunits.Conversions.to_deg(A32)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={212,140})));
    iPSL.Electrical.Buses.BusExt B33(
      V_b=6.6,
      no=1,
      nu=1,
      V_0=V33,
    ...
    iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer2(
      ...
      x=0.09) annotation (Placement(transformation(
          ...
          rotation=0,
          origin={-38,-74})));
    iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer3(
      V_b=6.6,
      Vn=6.6,
      fn=50,
      r=0,
      ...
      kT=6.6/22) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={60,-106})));
    iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer4(
      V_b=6.6,
      Vn=6.6,
      fn=50,
      r=0,
      ...
      x=0.09) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={-114,-92})));
    iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer5(
      fn=50,
      r=0,
      Sn=2,
      V_b=0.69,
      ...
      x=0.06) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-74,110})));
    iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer6(
      V_b=6.6,
      Vn=6.6,
      fn=50,
      r=0,
      ...
      x=0.07) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={-212,-88})));
    iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer7(
      V_b=6.6,
      Vn=6.6,
      fn=50,
      r=0,
      ...
      x=0.07) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={-292,-46})));
    iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer8(
      V_b=6.6,
      Vn=6.6,
      fn=50,
      r=0,
      ...
      x=0.08) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={-330,96})));
    iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer9(
      fn=50,
      r=0,
      Sn=2,
      V_b=0.69,
      ...
      x=0.06) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={242,22})));
    iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer10(
      fn=50,
      r=0,
      Sn=2,
      V_b=0.69,
      ...
      x=0.06) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={238,78})));
    iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer11(
      fn=50,
      r=0,
      Sn=8,
      V_b=6.6,
      ...
      x=0.08) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={328,54})));
    iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer12(
      fn=50,
      r=0,
      Sn=5,
      V_b=6.6,
      ...
      x=0.07) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={250,140})));
    iPSL.Electrical.Branches.PwLine Line1_2(
      R=0.00336,
      X=0.01613,
      G=0,
      B=0.00426/2) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={198,-108})));
    iPSL.Electrical.Branches.PwLine Line2_4(
      R=0.00336,
      X=0.01613,
      G=0,
      B=0.0026/2) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={144,-60})));
    iPSL.Electrical.Branches.PwLine line56_1(
      R=0.0262,
      X=0.0595,
      G=0,
      B=0.00001289376/2,
    ...
    iPSL.Electrical.Branches.PwLine Line56_2(
      G=0,
      R=0.0262,
      X=0.0595,
      B=0.00001289376/2) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={60,30})));
    iPSL.Electrical.Branches.PwLine Line6_11(
      G=0,
      R=0.192,
      X=0.436,
    ...
    iPSL.Electrical.Branches.PwLine Line6_7(
      ...
      B=0.00003151808/2) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={2,-16})));
    iPSL.Electrical.Branches.PwLine Line7_9(
      G=0,
      R=0.134,
      X=0.138,
      B=0.0000267/2) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={18,-68})));
    iPSL.Electrical.Branches.PwLine Line7_1(
      G=0,
      R=0.0964,
      X=0.10,
      B=0.0000193/2) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-66,-30})));
    iPSL.Electrical.Branches.PwLine Line11_16(
      G=0,
      R=0.09814,
      X=0.1807,
      B=0.000039/2) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-132,22})));
    iPSL.Electrical.Branches.PwLine Line16_19(
      G=0,
      R=0.098,
      X=0.181,
      B=0.0000394/2) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-236,22})));
    iPSL.Electrical.Branches.PwLine Line19_21(
      G=0,
      R=0.134,
      X=0.0734,
      B=0.0000126/2) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={-284,24})));
    iPSL.Electrical.Branches.PwLine Line11_14(
      G=0,
      R=0.0446,
      X=0.0244,
      B=0.0000042/2) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={-100,52})));
    iPSL.Electrical.Branches.PwLine Line5_23(
      G=0,
      R=0.157,
      X=0.289,
      B=0.00000632/2) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={100,38})));
    iPSL.Electrical.Branches.PwLine Line2326_1(
      G=0,
      R=1.016,
      X=1.055,
      B=0.0002038/2) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={74,84})));
    iPSL.Electrical.Branches.PwLine Line2326_2(
      G=0,
      R=1.016,
      X=1.055,
      B=0.0002038/2) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={98,84})));
    iPSL.Electrical.Branches.PwLine Line26_31(
      G=0,
      R=0.742,
      X=0.771,
      B=0.000148/2) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={94,132})));
    iPSL.Electrical.Branches.PwLine Line31_32(
      G=0,
      R=0.1489,
      X=0.0816,
      B=0.00014/2) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={156,164})));
    iPSL.Electrical.Branches.PwLine Line26_27(
      G=0,
      R=0.111,
      X=0.116,
      B=0.0000223/2) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={156,116})));
    iPSL.Electrical.Branches.PwLine Line26_29(
      G=0,
      R=0.223,
      X=0.122,
      B=0.000021/2) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={252,102})));
    iPSL.Electrical.Branches.PwLine Line26_1(
      G=0,
      R=0.134,
      X=0.0734,
      B=0.0000126/2) annotation (Placement(transformation(
    ...
    iPSL.Electrical.Branches.PwLine Line16_17(
      ...
      B=0.000082/2) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-196,-44})));
    iPSL.Electrical.Loads.PSAT.VoltDependant voltDependant3(
      V_b=22,
      V_0=V5,
      angle_0=Modelica.SIunits.Conversions.to_deg(A5),
      P_0=0,
    ...
    iPSL.Electrical.Controls.PSAT.AVR.AVRTypeII aVR2(
      vrmin=-1,
      vrmax=1,
      Tr=1,
      Ka=50,
    ...
    iPSL.Electrical.Controls.PSAT.AVR.AVRTypeII aVR3(
      Tr=1,
      vrmin=-7.3,
      vrmax=7.3,
      Ka=400,
    ...
    iPSL.Electrical.Controls.PSAT.AVR.AVRTypeII aVR4(
      vrmin=-1,
      vrmax=1,
      Ke=-0.05,
      Tr=1,
    ...
    iPSL.Electrical.Machines.PSAT.SixthOrder.Order6 syn5(
      ...
      angle_0=Modelica.SIunits.Conversions.to_deg(A20)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-310,-106})));
    iPSL.Electrical.Controls.PSAT.AVR.AVRTypeII aVR5(
      vrmin=-1,
      vrmax=1,
      Ke=-0.05,
      Tr=1,
      ...
      vf0=VF5) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-312,-136})));
    iPSL.Electrical.Machines.PSAT.SixthOrder.Order6 syn6(
      V_b=6.6,
      Vn=6.6,
      ra=0,
      xd1=0.2,
      ...
      angle_0=Modelica.SIunits.Conversions.to_deg(A22)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-250,144})));
    iPSL.Electrical.Controls.PSAT.AVR.AVRTypeII aVR6(
      vrmin=-1,
      vrmax=1,
      Tr=1,
      Ka=50,
      ...
      vf0=VF6) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-214,152})));
    iPSL.Electrical.Machines.PSAT.SixthOrder.Order6 syn7(
      ra=0,
      D=0,
      xq1=0.3,
      Tq10=0.8,
      ...
      angle_0=Modelica.SIunits.Conversions.to_deg(A15)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-4,118})));
    iPSL.Electrical.Controls.PSAT.AVR.AVRTypeII aVR7(
      Tr=1,
      Ta=0.02,
      vrmin=-6.5,
      vrmax=6.5,
      ...
      vf0=VF7) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={32,126})));
    iPSL.Electrical.Machines.PSAT.SixthOrder.Order6 syn8(
      ra=0,
      D=0,
      xq1=0.3,
      Tq10=0.8,
      ...
      angle_0=Modelica.SIunits.Conversions.to_deg(A33)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={320,142})));
    iPSL.Electrical.Controls.PSAT.AVR.AVRTypeII aVR8(
      Tr=1,
      Ta=0.02,
      Kf=0.03,
      Tf=1,
      ...
      vf0=VF8) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={356,148})));
    iPSL.Electrical.Machines.PSAT.SixthOrder.Order6 syn9(
      ra=0,
      D=0,
      xq1=0.3,
      Tq10=0.8,
      ...
      angle_0=Modelica.SIunits.Conversions.to_deg(A30)) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={342,-12})));
    iPSL.Electrical.Controls.PSAT.AVR.AVRTypeII aVR9(
      Tr=1,
      Ta=0.02,
      vrmin=-1,
      vrmax=1,
      ...
      vf0=VF9) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={378,-4})));
    iPSL.Electrical.Machines.PSAT.SixthOrder.Order6 syn10(
      ra=0,
      D=0,
      xq1=0.3,
      Tq10=0.8,
      ...
      angle_0=Modelica.SIunits.Conversions.to_deg(A28)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={276,26})));
    iPSL.Electrical.Controls.PSAT.AVR.AVRTypeII aVR10(
      Tr=1,
      vrmin=-1,
      vrmax=1,
      Ka=25,
      ...
      vf0=VF10) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={278,-2})));
    iPSL.Electrical.Machines.PSAT.SixthOrder.Order6 syn11(
      ra=0,
      D=0,
      xq1=0.3,
      Tq10=0.8,
      ...
      angle_0=Modelica.SIunits.Conversions.to_deg(A25)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={238,-30})));
    iPSL.Electrical.Controls.PSAT.AVR.AVRTypeII aVR11(
      Tr=1,
      vrmin=-1,
      vrmax=1,
      Ta=0.2,
      ...
      v0=V25) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={240,-58})));
    iPSL.Electrical.Machines.PSAT.SixthOrder.Order6 syn12(
      ra=0,
      D=0,
      xq1=0.3,
      Tq10=0.8,
      ...
      angle_0=Modelica.SIunits.Conversions.to_deg(A3)) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={294,-128})));
    iPSL.Electrical.Buses.InfiniteBus infiniteBus(
      V_0=V1,
      angle_0=Modelica.SIunits.Conversions.to_deg(A1),
      V_b=132,
      P_0=PinfBus,
      Q_0=QinfBus) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={140,-148})));
    inner iPSL.Electrical.SystemBase SysData(S_b=100, fn=50) annotation (Placement(transformation(extent={{-358,138},{-284,180}})));
  ...
  equation
    ...
    annotation (
      Diagram(coordinateSystem(extent={{-360,-180},{400,180}}, preserveAspectRatio=false), graphics={
          Text(
...
<p><span style=\"font-family: MS Shell Dlg 2;\">If a copy of the MPL was not distributed with this file, You can obtain one at <a href=\"http://mozilla.org/MPL/2.0/\">http://mozilla.org/MPL/2.0</a>.</span></p>
  ...
  model StaticCondenser
    ...
    iPSL.Connectors.PwPin p annotation (Placement(transformation(extent={{80,-8},{100,12}})));
  ...
  annotation (uses(iPSL(version="0.8.1"), Modelica(version="3.2.1")), Documentation(info="<html>
<table cellspacing=\"2\" cellpadding=\"1\" border=\"1\"><tr>
<td><p>Reference</p></td>
<td><p> Namsskogan (Norway) Distribution Grid, Reference: PSAT</p></td>
</tr>

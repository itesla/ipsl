...
model FourteenBus_Test
  ...
  PowerSystems.Electrical.Controls.PSAT.AVR.AVRTypeII aVRTypeII(
    ...
    vrmin=0,
    vrmax=7.32,
    vref0=1.065579155392461,
    vf0=1.114009417991659)
  ...
  PowerSystems.Electrical.Controls.PSAT.AVR.AVRTypeII aVR1TypeII1(
    ...
    vrmin=0,
    vrmax=4.38,
    vref0=1.168637090723106,
    vf0=2.459246384888290)
  ...
  PowerSystems.Electrical.Controls.PSAT.AVR.AVRTypeII aVR2TypeII2(
    ...
    vrmin=0,
    vrmax=4.38,
    vref0=1.106442363863340,
    vf0=1.922340629006171) annotation (Placement(transformation(
        extent={{-9,-9},{9,9}},
        rotation=180,
        origin={69,-121})));
  PowerSystems.Electrical.Controls.PSAT.AVR.AVRTypeII aVR3TypeII2(
    ...
    vrmin=1.395,
    vrmax=6.81,
    vref0=1.229905600531139,
    vf0=2.777807103755427) annotation (Placement(transformation(
        extent={{-11,-10},{11,10}},
        rotation=180,
        origin={137,-4})));
  ...
  PowerSystems.Electrical.Controls.PSAT.AVR.AVRTypeII aVR4TypeII1(
    ...
    vrmin=1.395,
    vrmax=6.81,
    vref0=1.298396629789953,
    vf0=4.425421574609063) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-48,-10})));
  PowerSystems.Electrical.Branches.PSAT.TwoWindingTransformer
    ...
    R=0) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={66,-4})));
  Modelica.Blocks.Sources.Constant const(k=1.065579155392461)
    annotation (Placement(transformation(extent={{-156,6},{-148,14}})));
  Modelica.Blocks.Sources.Constant const1(k=1.168637090723106)
    annotation (Placement(transformation(extent={{-86,-126},{-78,-118}})));
  Modelica.Blocks.Sources.Constant const2(k=1.106442363863340)
    annotation (Placement(transformation(extent={{-3,-3},{3,3}},
        rotation=180,
        origin={97,-125})));
  Modelica.Blocks.Sources.Constant const4(k=1.298396629789953)
  ...
  PowerSystems.Electrical.Machines.PSAT.FourthOrder.Order4_Inputs_Outputs
    ...
    T1q0=0.001,
    M0=2*5.148,
    p0=3.517526718522406,
    q0=-0.349068056696753)
  ...
  PowerSystems.Electrical.Machines.PSAT.FourthOrder.Order4_Inputs_Outputs
    ...
    M0=2*6.54,
    v0=1.045,
    anglev0=-0.134902961887450,
    p0=0.399999999999996,
    q0=0.788506925241243) annotation (Placement(transformation(
        extent={{-7,-7},{7,7}},
        rotation=90,
        origin={-25,-109})));
  PowerSystems.Electrical.Machines.PSAT.FourthOrder.Order4_Inputs_Outputs
    ...
    M0=2*6.54,
    v0=1.01,
    anglev0=-0.329501883541310,
    p0=0.000000000000002,
    q0=0.526549789343593) annotation (Placement(transformation(
        extent={{-7,-7},{7,7}},
        rotation=90,
        origin={45,-111})));
  PowerSystems.Electrical.Machines.PSAT.FourthOrder.Order4_Inputs_Outputs
    ...
    anglev0=-0.342851610444379,
    q0=0.367941808430734) annotation (Placement(transformation(
        extent={{-9,-8},{9,8}},
        rotation=180,
        origin={109,-4})));
  PowerSystems.Electrical.Machines.PSAT.FourthOrder.Order4_Inputs_Outputs
    ...
    Vbus=13800,
    v0=1.07,
    anglev0=-0.378890344088099,
    p0=0.000000000000004,
    q0=0.718059875608557) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-46,18})));
  Modelica.Blocks.Sources.Constant const3(k=1.229905600531139)
    annotation (Placement(transformation(extent={{-4,-4},{4,4}},
        rotation=180,
        origin={146,-26})));
  PowerSystems.Electrical.Branches.PSAT.TwoWindingTransformer
  ...
  PowerSystems.Electrical.Events.PwFaultPQ pwFaultPQ(
    ...
    t2=10.01,
    X=0.001,
    R=1) annotation (Placement(transformation(extent={{96,30},{116,50}})));
equation
  ...
  connect(L13.n, B11.p) annotation (Line(
      points={{-29,52.2},{-29,54},{-12,54},{-12,64}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(B11.p, L14.p) annotation (Line(
      points={{-12,64},{-12,68},{-8,68},{-8,71.5}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(B11.p, lPQ10.p) annotation (Line(
      points={{-12,64},{-12,70},{-22,70},{-22,73.6}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(Gen3order4.pm0, Gen3order4.pm) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(B9.p, twoWindingTransformer3.n) annotation (Line(
      points={{54,44},{54,38},{16,38},{16,19}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(B4.p, twoWindingTransformer3.p) annotation (Line(
      points={{32,-32},{32,-6},{18,-6},{18,-3},{16,-3}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(B9.p, pwFaultPQ.p) annotation (Line(points={{54,44},{56,44},{56,
          34},{84,34},{84,41},{99,41}}, color={0,0,255}));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-200,
            -140},{180,140}})),                Icon(coordinateSystem(extent={{-200,
            -140},{180,140}})),

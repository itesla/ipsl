...
equation
  ...
  connect(sEXS.EFD, gENSAL.EFD) annotation (Line(points={{82.1,-59},{90,-59},{90,-92},{90,-90},{-84,-90},{-84,-7},{-67.38,-7}}, color={0,0,127}));
  connect(cte.y, sEXS.VOEL) annotation (Line(points={{-15.3,-59},{-4,-59},{12.1,-59}}, color={0,0,127}));
  connect(gENSAL.EFD0, sEXS.EFD0) annotation (Line(points={{-3.52,-12.2},{0,-12.2},{0,-73.375},{12.1,-73.375}}, color={0,0,127}));
  connect(gENSAL.ETERM, sEXS.ECOMP) annotation (Line(points={{-3.52,19},{6,19},{6,-44.625},{12.1,-44.625}}, color={0,0,127}));
  connect(gENSAL.p, p) annotation (Line(points={{-2.9,6},{22,6},{50,6},{50,0},{110,0}}, color={0,0,255}));
  connect(sEXS.VOTHSG, cte.y) annotation (Line(points={{12.1,-50.375},{-6,-50.375},{-6,-59},{-15.3,-59}}, color={0,0,127}));
  connect(sEXS.VUEL, cte.y) annotation (Line(points={{12.1,-67.625},{-6,-67.625},{-6,-59},{-15.3,-59}}, color={0,0,127}));
  annotation (

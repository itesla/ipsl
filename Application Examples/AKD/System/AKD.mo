...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{120,100}}), graphics={
        Text(
          extent={{-12,56},{8,50}},
          lineColor={0,128,0},
        ...
        Text(
          ...
          lineColor={0,128,0},
          textStyle={TextStyle.Bold},
          textString="bus 58653")}), Icon(coordinateSystem(extent={{-100,-100},{120,100}})));
end AKD;

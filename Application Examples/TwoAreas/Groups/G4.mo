...
equation
  ...
  connect(gENSAL.p, pwPin) annotation (Line(points={{26,4},{42,4},{42,0},{70,0}},
                  color={0,0,255}));
  connect(gENSAL.EFD0, gENSAL.EFD) annotation (Line(points={{25.6,-8.6},{22,-8.6},
          {22,-20},{-18,-20},{-18,-5},{-15.6,-5}},    color={0,0,127}));
  connect(gENSAL.PMECH, gENSAL.PMECH0) annotation (Line(points={{-15.6,13},{-14,
          13},{-14,16},{-18,16},{-18,30},{26,30},{26,-1.4},{25.6,-1.4}},
        color={0,0,127}));

...
equation
  ...
  connect(VOEL.y, sT5B.VOEL) annotation (Line(points={{-59.4,-54},{-56,-54},{
          -56,-80},{5,-80},{5,-74.6667}},                                                                    color={0,0,127}));
  connect(pSS2B.VOTHSG, sT5B.VOTHSG) annotation (Line(points={{19.4,-96},{-3,
          -96},{-3,-74.6667}},                                                                    color={0,0,127}));

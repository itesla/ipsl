...
model IEEE_9_Buses_Statcom
  ...
  iPSL.Electrical.Branches.PwLine line_4_5(
    ...
    B=0.088) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-72,-20})));
  iPSL.Electrical.Loads.PSAT.LOADPQ lOADPQ(P_0=1.25, Q_0=0.5) annotation (Placement(transformation(
        extent={{-7,-7},{7,7}},
        rotation=0,
        origin={-99,-9})));
  iPSL.Electrical.Loads.PSAT.LOADPQ PQ1(P_0=0.9, Q_0=0.3) annotation (Placement(transformation(
        extent={{-7,-7},{7,7}},
        rotation=0,
        origin={109,-13})));
  ...
  iPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer2(
    ...
    Vn=18) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-102,90})));
  iPSL.Electrical.Loads.PSAT.LOADPQ lOADPQ1(P_0=1, Q_0=0.35) annotation (Placement(transformation(
        extent={{-7,-7},{7,7}},
        rotation=0,
        origin={-9,65})));
  iPSL.Electrical.Controls.PSAT.FACTS.STATCOM.STATCOM sTATCOM3_1(
    ...
    fn=60,
    V_0=1.025,
    i_Min=-0.8) annotation (Placement(transformation(
        extent={{-6,-6},{6,6}},
        rotation=90,
        origin={12,66})));
  ...
  iPSL.Electrical.Branches.PwLine2Openings ine_7_8(
    ...
    B=0.0745,
    t1=100,
    t2=100.15) annotation (Placement(transformation(extent={{-50,80},{-30,100}})));
  Generation_Groups.Gen1 gen1(
    ...
    refdisturb_1=true) annotation (Placement(transformation(extent={{-160,80},{-140,100}})));
  Generation_Groups.Gen2 gen2(
    ...
    height_2=0.05,
    tstart_2=2,
    refdisturb_2=false) annotation (Placement(transformation(extent={{160,80},{140,100}})));

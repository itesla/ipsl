...
equation
  ...
  connect(Q_Reactors.y, imRelay.u4)
    annotation (Line(points={{22.8,-34},{50.4,-34}}, color={0,0,127}));
  connect(Q_capacitors.y, imRelay.u3) annotation (Line(points={{22.8,-12},{30,-12},
          {30,-30},{50.4,-30}}, color={0,0,127}));
  connect(add.u2, pwVoltage.v) annotation (Line(points={{-59.2,2.4},{-62,2.4},{
          -62,-2.1},{-66.16,-2.1}}, color={0,0,127}));
  ...
  annotation (
    ...
    Icon(coordinateSystem(extent={{-100,-100},{140,100}}, preserveAspectRatio=
          ...
          smooth=Smooth.None,
          thickness=0.5),Line(
          points={{-44,20},{-48,16},{-52,10},{-54,2},{-54,-4},{-52,-10},{-50,-14},
            {-46,-20},{-44,-20}},
          color={0,0,255},
          smooth=Smooth.Bezier,
          thickness=0.5),Rectangle(extent={{-86,34},{-14,-34}}, lineColor={0,0,
          255}),Text(
          extent={{-40,-18},{-14,-40}},
          lineColor={0,0,255},
          fillColor={0,0,255},

...
model pwPLL2 "Developed by DTU"
  ...
  Modelica.Blocks.Interfaces.RealOutput freq_meas annotation (Placement(
        transformation(extent={{68,-26},{80,-14}}), iconTransformation(extent={
            {45,-36},{59,-24}})));
  ...
  Modelica.Blocks.Interfaces.RealInput freq annotation (Placement(
        ...
        rotation=90,
        origin={0,-56})));
  Modelica.Blocks.Interfaces.RealOutput phi_meas annotation (Placement(
        transformation(extent={{60,14},{72,26}}), iconTransformation(extent={{
            45,24},{59,36}})));
...
equation
  ...
  connect(product.y, add.u1) annotation (Line(points={{-35.6,24},{-32,24},{-32,
          2.4},{-28.8,2.4}}, color={0,0,127}));
  ...
  connect(pwVoltage.vi, product1.u1) annotation (Line(points={{-53.1,0},{-50,0},
          {-50,-21.6},{-44.8,-21.6}}, color={0,0,127}));
  connect(imLimitedIntegrator.y, add1.u2) annotation (Line(points={{-3.6,-16},{
          -0.8,-16},{-0.8,-2.4}}, color={0,0,127}));
  ...
  connect(add2.u2, freq) annotation (Line(points={{19.2,-4.4},{11,-4.4},{11,-37}},
        color={0,0,127}));
  connect(add3.u1, add2.y) annotation (Line(points={{35.2,-1.6},{28.4,-1.6},{
          28.4,-2}}, color={0,0,127}));
  connect(sin.u, phi_meas) annotation (Line(points={{17.6,60},{38,60},{66,60},{
          66,20}}, color={0,0,127}));
  connect(sin.y, product.u1) annotation (Line(points={{-0.8,60},{-50,60},{-50,
  ...
  connect(imGain1.u, add2.y) annotation (Line(points={{41.2,-20},{34,-20},{34,-10},
          {30,-10},{30,-2},{28.4,-2},{28.4,-2}}, color={0,0,127}));
  annotation (

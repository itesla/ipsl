...
equation
  pin_EFD = V;
  annotation(Icon(graphics={  Rectangle(extent=  {{-60, 40}, {40, -40}}, lineColor=  {0, 0, 255}), Text(extent=  {{-36, 14}, {20, -12}}, lineColor=  {0, 0, 255}, textStyle=  {TextStyle.Bold}, textString=  "EFD1")}), Diagram(graphics), Documentation(info = "<html>

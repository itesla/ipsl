...
model AVR3 "Voltage regulator. Developed by AIA. 2013"
  ...
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag(K = KE, T = TE, y_start = init_V2) annotation(Placement(transformation(extent = {{34, 20}, {52, 38}})));
...
equation
  ...
  annotation(Icon(graphics={  Rectangle(extent=  {{-40, 40}, {60, -40}}, lineColor=  {0, 0, 255}), Text(extent=  {{58, -10}, {-40, 12}}, lineColor=  {0, 0, 255}, textString=  "AVR3")}), Documentation(info = "<html>

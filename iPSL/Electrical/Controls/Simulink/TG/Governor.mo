...
equation
  ...
  connect(imLimitedIntegrator.y, z) annotation(Line(points = {{146.7, 17}, {153.35, 17}, {153.35, 17}, {161, 17}}, color = {0, 0, 127}));
  connect(feedback.y, Gain3.u) annotation(Line(points = {{87, 16}, {88, 16}, {88, 17}, {90.6, 17}}, color = {0, 0, 127}));
  connect(feedback.u2, z) annotation(Line(points = {{78, 8}, {78, -6}, {152, -6}, {152, 17}, {153.35, 17}, {161, 17}}, color = {0, 0, 127}));
  connect(Pe, SimpleLag1.u) annotation(Line(points = {{-90, -33}, {-81, -33}, {-73.4, -33}}, color = {0, 0, 127}));
  connect(add.y, Droop.u) annotation(Line(points = {{-53, -3.5}, {-53, -0.1}, {-53.5, -0.1}}, color = {0, 0, 127}));
  connect(add.u2, SimpleLag1.y) annotation(Line(points = {{-50, -15}, {-50, -33}, {-57.3, -33}}, color = {0, 0, 127}));
  connect(Pm_set, add.u1) annotation(Line(points = {{-90, -17}, {-56, -17}, {-56, -15}}, color = {0, 0, 127}));
  connect(Droop.y, add1.u2) annotation(Line(points = {{-53.5, 12.55}, {-53.5, 22}, {-47, 22}}, color = {0, 0, 127}));
  connect(add2.u1, Omega) annotation(Line(points = {{-71, 32}, {-82, 32}, {-91, 32}}, color = {0, 0, 127}));
  connect(Omega_n.y, add2.u2) annotation(Line(points = {{-81.4, 12}, {-78, 12}, {-78, 26}, {-71, 26}}, color = {0, 0, 127}));
  connect(add2.y, add1.u1) annotation(Line(points = {{-59.5, 29}, {-53.75, 29}, {-53.75, 28}, {-47, 28}}, color = {0, 0, 127}));
  connect(Gain1.u, add1.y) annotation(Line(points = {{8.6, 25}, {-13.7, 25}, {-35.5, 25}}, color = {0, 0, 127}));
  connect(Gain2.u, add1.y) annotation(Line(points = {{8.6, 7}, {0, 7}, {0, 25}, {-13.7, 25}, {-35.5, 25}}, color = {0, 0, 127}));
  connect(Gain2.y, Integrator.u) annotation(Line(points = {{24.7, 7}, {26.35, 7}, {26.35, 7}, {28.6, 7}}, color = {0, 0, 127}));
  connect(add3.y, feedback.u1) annotation(Line(points = {{64.6, 16}, {67.3, 16}, {70, 16}}, color = {0, 0, 127}));

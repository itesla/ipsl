...
model Governor "Speed governor model for hydro turbines"
  ...
  Modelica.Blocks.Interfaces.RealInput Omega "Rotor speed in p.u" annotation(Placement(transformation(extent={{-96,26},
            {-86,38}}),                                                                                                    iconTransformation(extent = {{-14, 30}, {-4, 40}})));
  ...
  Modelica.Blocks.Continuous.Integrator Integrator(k=1, y_start=p0,
  ...
  Modelica.Blocks.Continuous.LimIntegrator            imLimitedIntegrator(outMax = 1, k = 1, outMin = 0, y_start = p0,
    initType=Modelica.Blocks.Types.Init.InitialOutput)                                                                 annotation(Placement(transformation(extent={{132,10},
            {146,24}})));
  Modelica.Blocks.Interfaces.RealOutput z "Gate opening" annotation(Placement(transformation(extent={{156,12},
            {166,22}}), iconTransformation(extent={{148,12},{158,22}})));
  ...
  Modelica.Blocks.Math.Add add3 annotation (Placement(transformation(
        ...
        origin={58,16})));
equation
  connect(Gain3.y, Limited.u) annotation (Line(points={{106.7,17},{106.7,17},{110.6,
          17}}, color={0,0,127}));
  ...
  connect(Droop.y, add1.u2) annotation (Line(points={{-53.5,12.55},{-53.5,22},{-47,
          22}}, color={0,0,127}));

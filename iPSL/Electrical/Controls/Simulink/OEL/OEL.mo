...
model OEL "OverExcitation Limiter"
  ...
  Modelica.Blocks.Continuous.LimIntegrator            Timer(           k = 1, y_start = init_OEL_Timer,
    outMax=10000.0,
    outMin=L1,
    initType=Modelica.Blocks.Types.Init.InitialOutput)                                                             annotation(Placement(transformation(extent={{10,8},{
            24,22}})));
...
equation
  ...
  connect(ifd, add.u1) annotation (Line(points={{-85,6},{-72,6},{-72,16},{-62,16}},
        color={0,0,127}));
  connect(add.y, block_1_1.p1) annotation (Line(points={{-39,10},{-36,10},{-36,11.54},
          {-33,11.54}}, color={0,0,127}));
  connect(imGain.y, switch.if_in) annotation (Line(points={{22.6,34},{30,34},{30,
          18.8},{33.54,18.8}}, color={0,0,127}));
  connect(imGain.u, block_1_1.p1) annotation (Line(points={{8.8,34},{-36,34},{-36,
          11.54},{-33,11.54}}, color={0,0,127}));
  connect(block_1_1.n1, Timer.u) annotation (Line(points={{3,11.27},{5.5,11.27},
          {5.5,15},{8.6,15}}, color={0,0,127}));
  connect(Timer.y, switch.y) annotation (Line(points={{24.7,15},{29.35,15},{29.35,
          13.58},{33.54,13.58}}, color={0,0,127}));
  connect(switch.n1, min.u1) annotation (Line(points={{60.92,14.45},{64.46,14.45},
          {64.46,14},{67,14}}, color={0,0,127}));

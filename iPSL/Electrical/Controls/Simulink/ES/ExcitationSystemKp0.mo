...
model ExcitationSystemKp0 "Excitation system without PSS included"
  ...
  Modelica.Blocks.Continuous.LimIntegrator imLimitedIntegrator(
    ...
    k=1,
    y_start=vfd0,
    initType=Modelica.Blocks.Types.Init.InitialOutput) annotation (Placement(transformation(extent={{110,46},{126,62}})));
  iPSL.NonElectrical.Continuous.LeadLag tgr(
    K=G,
    T1=Ta,
    T2=Tb,
    y_start=vfd0) "Transient gain rudection" annotation (Placement(transformation(extent={{32,44},{52,64}})));

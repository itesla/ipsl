...
model OEL
  ...
  Modelica.Blocks.Interfaces.RealInput IFD "Field current" annotation(Placement(transformation(extent={{-104,24},
            {-94,36}}),                                                                                                    iconTransformation(extent = {{-72, 32}, {-82, 44}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput VOEL "OEL output" annotation(Placement(transformation(extent={{72,34},
            {82,46}}),                                                                                                    iconTransformation(extent = {{72, 32}, {82, 44}})));
...
equation
  ...
  connect(IFDSetpoint.y, add.u1) annotation (Line(points={{-75.2,70},{-74,70},{-74,
          38.8},{-69.6,38.8}}, color={0,0,127}));
  connect(multiSum.y, VOEL)
    annotation (Line(points={{55.02,40},{66,40},{77,40}}, color={0,0,127}));
  connect(imLimitedIntegrator.y, multiSum.u[1]) annotation (Line(points={{16.8,66},
          {38,66},{38,43.15},{42,43.15}}, color={0,0,127}));

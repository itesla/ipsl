...
model HYGOV
  ...
  Modelica.Blocks.Interfaces.RealInput SPEED
    "Machine speed deviation from nominal (pu)"                                          annotation(Placement(transformation(extent = {{-206, -10}, {-192, 4}}), iconTransformation(extent = {{-84, 24}, {-72, 36}})));
  ...
  Modelica.Blocks.Continuous.Integrator q(y_start = q0, initType = Modelica.Blocks.Types.Init.InitialOutput, k = 1 / T_w) annotation(Placement(transformation(extent = {{62, -4}, {74, 8}})));
  ...
  iPSL.NonElectrical.Continuous.SimpleLag g(K = 1, T = T_g, y_start = g0)
    "servo_motor"                                                                       annotation(Placement(transformation(extent = {{-40, 0}, {-28, 12}})));
  Modelica.Blocks.Interfaces.RealInput PMECH0
    "Initial turbine mechanical power (pu)"                                           annotation(Placement(transformation(extent = {{-84, -62}, {-76, -52}}), iconTransformation(extent = {{-84, -36}, {-72, -24}})));
  iPSL.NonElectrical.Continuous.SimpleLead imLead(K = r * T_r, T = T_r, y_start = 0) annotation(Placement(transformation(extent = {{-106, 0}, {-94, 12}})));
  ...
  Modelica.Blocks.Continuous.LimIntegrator Position_Limiter(outMin = G_MIN, outMax = G_MAX, k = 1, y_start = c0, initType = Modelica.Blocks.Types.Init.InitialOutput) annotation(Placement(transformation(extent = {{-68, 0}, {-56, 12}})));
...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-80, -60}, {80, 60}}), graphics={  Rectangle(extent = {{-190, 32}, {-12, -38}}, lineColor = {255, 128, 0}, pattern = LinePattern.Dash,
            lineThickness =                                                                                                    1), Text(extent = {{-126, 40}, {-82, 34}}, lineColor = {255, 128, 0}, textStyle = {TextStyle.Bold}, textString = "Governor System"), Rectangle(extent = {{-8, 32}, {134, -38}}, lineColor = {85, 170, 255}, pattern = LinePattern.Dash,
            lineThickness =                                                                                                    1), Text(extent = {{38, 42}, {98, 32}}, lineColor = {85, 170, 255}, textStyle = {TextStyle.Bold}, textString = "Hydrauli Turbine System")}), Icon(coordinateSystem(extent = {{-80, -60}, {80, 60}}, preserveAspectRatio = false), graphics={  Text(extent = {{-48, 12}, {52, -14}}, lineColor = {0, 0, 255},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "HYGOV"), Text(extent = {{-70, -20}, {-42, -40}}, lineColor = {0, 0, 255},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "PMECH0"), Rectangle(extent = {{-80, 60}, {80, -60}}, lineColor = {0, 0, 255}), Text(extent = {{-78, 34}, {-40, 26}}, lineColor = {0, 0, 255}, textString = "SPEED"), Text(extent = {{52, 6}, {78, -8}}, lineColor = {0, 0, 255}, textString = "PMECH")}), Documentation(info = "<html>

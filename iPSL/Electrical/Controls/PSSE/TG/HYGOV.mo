...
model HYGOV
  ...
  Modelica.Blocks.Interfaces.RealOutput PMECH "Turbine mechanical power (pu)"
    annotation (Placement(transformation(extent={{138,-6},{150,6}}),
...
equation
  ...
  connect(product1.y, add4.u2) annotation (Line(points={{70.6,-24},{114,-24},{
          114,-3.6},{118.8,-3.6}}, color={0,0,127}));
  ...
  connect(division.u1, add3.u1) annotation (Line(points={{-1.2,5.6},{-6,5.6},{-6,
          -34},{78,-34},{78,6},{80.8,5.6}}, color={0,0,127}));
  annotation (

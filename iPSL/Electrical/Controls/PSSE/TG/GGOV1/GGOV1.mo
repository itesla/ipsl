...
public
  ...
  Modelica.Blocks.Continuous.Integrator s6(k=1,
    ...
    annotation (Placement(transformation(extent={{-6,-6},{6,6}},
        rotation=180,
        origin={-158,90})));
  Modelica.Blocks.Continuous.Integrator s2(k=1,
  ...
  Modelica.Blocks.Interfaces.RealInput SPEED
    ...
    annotation (Placement(transformation(extent={{-346,102},{-310,138}}),
        iconTransformation(extent={{-346,102},{-310,138}})));
  ...
  Modelica.Blocks.Continuous.LimIntegrator
                                        s7(k=Kimw, outMax=1.1*R,
    initType=Modelica.Blocks.Types.Init.InitialOutput,
    y_start=s70) "Power controller"
...
public
  ...
  Modelica.Blocks.Math.Add add7        annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-85,137})));
  Modelica.Blocks.Sources.Constant set2(k=Wfnl) "full load flow"
    annotation (Placement(transformation(extent={{-8,-8},{8,8}},
        rotation=270,
        origin={-116,182})));
  Modelica.Blocks.Math.Gain Gain(k=Kiload/Kpload) annotation (Placement(
        ...
        rotation=180,
        origin={-138,90})));
  Modelica.Blocks.Math.Add LoadlimiterPI1(k2=-1)
    annotation (Placement(transformation(extent={{-6,6},{6,-6}},
        rotation=180,
        origin={-114,90})));
  Modelica.Blocks.Math.Gain KPGOV1(k=Kigov/Kpgov)
    annotation (Placement(transformation(extent={{-5,-5},{5,5}},
        rotation=180,
        origin={-31,-117})));
  Modelica.Blocks.Math.Add LoadlimiterPI2(k1=-1)
    annotation (Placement(transformation(extent={{-5,5},{5,-5}},
        rotation=180,
        origin={-11,-117})));
  ...
  Modelica.Blocks.Continuous.Integrator s3(k=1,
    initType=Modelica.Blocks.Types.Init.InitialOutput,
    y_start=s30)                                annotation (Placement(
        transformation(
        extent={{-7,-7},{7,7}},
        rotation=0,
        origin={107,-57})));
  Modelica.Blocks.Math.Add add8(k2=-1) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={48,-58})));
  RSELECT rSELECT(Rselect=Rselect)
                             annotation (Placement(transformation(
        extent={{-15,-22},{15,22}},
        rotation=90,
        origin={-206,-131})));
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-320,-240},
        ...
        Text(
          ...
          textString="input should be speed")}),
                                          Icon(coordinateSystem(extent={{-320,-240},
            {260,220}}, preserveAspectRatio=false),graphics={

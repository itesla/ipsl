...
model IEEEG1
  Modelica.Blocks.Interfaces.RealInput SPEED_HP
    "Machine speed deviation from nominal (pu)"                                             annotation(Placement(transformation(extent = {{-172, 2}, {-162, 14}}), iconTransformation(extent = {{-162, -16}, {-132, 16}})));
  iPSL.NonElectrical.Continuous.LeadLag imLeadLag(K = K, T1 = T_2, T2 = T_1, y_start = 0) annotation(Placement(transformation(extent = {{-144, 0}, {-128, 16}})));
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag(K = 1, T = T_4, y_start = P0) annotation(Placement(transformation(extent = {{-20, 0}, {-4, 16}})));
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag1(K = 1, T = T_5, y_start = P0) annotation(Placement(transformation(extent = {{22, 0}, {38, 16}})));
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag2(K = 1, T = T_6, y_start = P0) annotation(Placement(transformation(extent = {{62, 0}, {78, 16}})));
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag3(K = 1, T = T_7, y_start = P0) annotation(Placement(transformation(extent = {{102, 0}, {118, 16}})));
  Modelica.Blocks.Math.Gain imGain1(k = K_1) annotation(Placement(transformation(extent = {{-6, -6}, {6, 6}}, rotation = 90, origin = {10, 32})));
  Modelica.Blocks.Math.Gain imGain2(k = K_2) annotation(Placement(transformation(extent = {{-6, -6}, {6, 6}}, rotation = -90, origin = {10, -16})));
  Modelica.Blocks.Math.Gain imGain3(k = K_3) annotation(Placement(transformation(extent = {{-6, -6}, {6, 6}}, rotation = 90, origin = {50, 32})));
  Modelica.Blocks.Math.Gain imGain4(k = K_4) annotation(Placement(transformation(extent = {{-6, -6}, {6, 6}}, rotation = -90, origin = {50, -16})));
  Modelica.Blocks.Math.Gain imGain5(k = K_5) annotation(Placement(transformation(extent = {{-6, -6}, {6, 6}}, rotation = 90, origin = {90, 32})));
  Modelica.Blocks.Math.Gain imGain6(k = K_6) annotation(Placement(transformation(extent = {{-6, -6}, {6, 6}}, rotation = -90, origin = {90, -16})));
  Modelica.Blocks.Math.Gain imGain7(k = K_7) annotation(Placement(transformation(extent = {{-6, -6}, {6, 6}}, rotation = 90, origin = {130, 32})));
  Modelica.Blocks.Math.Gain imGain8(k = K_8) annotation(Placement(transformation(extent = {{-6, -6}, {6, 6}}, rotation = -90, origin = {130, -16})));
  ...
  Modelica.Blocks.Continuous.LimIntegrator limIntegrator(k = 1, outMax = P_MAX, outMin = P_MIN, initType = Modelica.Blocks.Types.Init.InitialOutput, y_start = P0) annotation(Placement(transformation(extent = {{-46, 0}, {-30, 16}})));
...
equation
  ...
  annotation(Diagram(coordinateSystem(extent = {{-140, -80}, {160, 80}}, preserveAspectRatio = false)), Icon(coordinateSystem(extent = {{-140, -80}, {160, 80}}, preserveAspectRatio = true), graphics={  Rectangle(extent = {{-140, 80}, {160, -80}}, lineColor = {0, 0, 255}), Text(extent = {{-122, 18}, {-68, -18}}, lineColor = {0, 0, 255},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "SPEED_HP"), Text(extent = {{84, 56}, {158, 26}}, lineColor = {0, 0, 255},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "PMECH_HP"), Text(extent = {{86, -10}, {158, -48}}, lineColor = {0, 0, 255},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "PMECH_LP"), Text(extent = {{-68, 40}, {88, -46}}, lineColor = {0, 0, 255},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "IEEEG1")}), Documentation(info = "<html>

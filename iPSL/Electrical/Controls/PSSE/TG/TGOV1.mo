...
model TGOV1 "Steam Turbine-Governor"
  Modelica.Blocks.Interfaces.RealInput SPEED
    "Machine speed deviation from nominal (pu)"                                          annotation(Placement(transformation(extent = {{-85, -20}, {-75, -8}}), iconTransformation(extent = {{-86, -40}, {-66, -20}})));
  iPSL.NonElectrical.Continuous.LeadLag imLeadLag(T1 = T_2, T2 = T_3, K = 1, y_start = P0) annotation(Placement(transformation(extent = {{30, 7}, {40, 17}})));
  ...
  Modelica.Blocks.Interfaces.RealInput Reference "Speed reference (pu)" annotation(Placement(transformation(extent = {{-85, 9}, {-75, 21}}), iconTransformation(extent = {{-86.9, 19.9}, {-66.9, 39.9}})));
...
equation
  V = simpleLagLim.y;
  connect(Reference, add.u1) annotation(Line(points = {{-80, 15}, {-51, 15}}, color = {0, 0, 127}));
  ...
  connect(simpleLagLim.u, imGain9.y) annotation(Line(points = {{-1, 12}, {-19.5, 12}}, color = {0, 0, 127}));
  connect(simpleLagLim.y, imLeadLag.u) annotation(Line(points = {{10.5, 12}, {19.75, 12}, {29, 12}}, color = {0, 0, 127}));
  annotation(Diagram(coordinateSystem(extent = {{-80, -60}, {80, 60}}, preserveAspectRatio = false, grid = {1, 1})), Icon(coordinateSystem(extent = {{-80, -60}, {80, 60}}, preserveAspectRatio = false, grid = {1, 1}), graphics={  Rectangle(extent = {{-80, 60}, {80, -60}}, lineColor = {0, 0, 255}), Text(extent = {{-69, -25}, {-24, -36}}, lineColor = {0, 0, 255},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "SPEED"), Text(extent = {{44, 7}, {79, -8}}, lineColor = {0, 0, 255},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "PMECH"), Text(extent = {{-48, 14}, {42, -14}}, lineColor = {0, 0, 255},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "TGOV1"), Text(extent = {{-63, 37}, {-24, 23}}, lineColor = {0, 0, 255},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "Referece")}), Documentation(info = "<html>

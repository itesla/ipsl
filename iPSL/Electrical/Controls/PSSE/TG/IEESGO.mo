...
model IEESGO "IEEE Standard Model for Turbine-Governor"
  input Modelica.Blocks.Interfaces.RealInput SPEED
    "Machine speed deviation from nominal (pu)"                                                annotation(Placement(transformation(extent = {{-140, -2}, {-128, 10}}), iconTransformation(extent = {{-160, 22}, {-144, 38}})));
  input Modelica.Blocks.Interfaces.RealInput PMECH0
    "Initial value of turbine mechanical power (pu)"                                                 annotation(Placement(transformation(extent = {{-140, 24}, {-128, 36}}), iconTransformation(extent = {{-160, -48}, {-144, -32}})));
  ...
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag(K = K_1, T = T_1, y_start = 0) annotation(Placement(transformation(extent = {{-114, -6}, {-94, 14}})));
  iPSL.NonElectrical.Continuous.LeadLag imLeadLag(K = 1, T1 = T_2, T2 = T_3, y_start = 0) annotation(Placement(transformation(extent = {{-82, -6}, {-62, 14}})));
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag1(K = 1, T = T_4, y_start = p0) annotation(Placement(transformation(extent = {{26, 14}, {46, 34}})));
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag2(K = K_2, T = T_5, y_start = p0 * K_2) annotation(Placement(transformation(extent = {{6, -66}, {26, -46}})));
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag3(K = K_3, T = T_6, y_start = p0 * K_2 * K_3) annotation(Placement(transformation(extent = {{46, -66}, {66, -46}})));
  output Modelica.Blocks.Interfaces.RealOutput PMECH
    "Turbine mechanical power (pu)"                                                  annotation(Placement(transformation(extent = {{146, -22}, {156, -10}}), iconTransformation(extent = {{160, -10}, {180, 10}})));
...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-160, -80}, {160, 60}}), graphics={  Text(extent = {{-50, 70}, {46, 18}}, lineColor = {0, 0, 255}, textString = "Pm0*(1-K_2)+Pm0*K_2*(1-K_3)+Pm0*K_3*K_2
=0+0+0+Pm0")}), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-160, -80}, {160, 60}}), graphics={  Rectangle(extent = {{-160, 60}, {160, -80}}, lineColor = {0, 0, 255}), Text(extent = {{-52, 20}, {68, -20}}, lineColor = {0, 0, 255}, textString = "IEESGO"), Text(extent = {{-142, 36}, {-118, 22}}, lineColor = {0, 0, 255}, textString = "SPEED"), Text(extent = {{-142, -32}, {-116, -48}}, lineColor = {0, 0, 255}, textString = "PMECH0"), Text(extent = {{134, 6}, {156, -6}}, lineColor = {0, 0, 255}, textString = "PMECH")}), Documentation(info = "<html>

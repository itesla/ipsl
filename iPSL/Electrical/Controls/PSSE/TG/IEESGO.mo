...
model IEESGO "IEEE Standard Model for Turbine-Governor"
  ...
  input Modelica.Blocks.Interfaces.RealInput SPEED
    "Machine speed deviation from nominal (pu)"    annotation(Placement(
        transformation(extent={{-140,-2},{-128,10}}),
        iconTransformation(extent={{-160,22},{-144,38}})));
  input Modelica.Blocks.Interfaces.RealInput PMECH0
    "Initial value of turbine mechanical power (pu)"
                                                    annotation(Placement(transformation(extent={{-140,24},
            {-128,36}}),                                                                                                    iconTransformation(extent={{-160,
            -48},{-144,-32}})));
...
public
  ...
  output Modelica.Blocks.Interfaces.RealOutput PMECH
    "Turbine mechanical power (pu)"                  annotation(Placement(transformation(extent={{146,-22},
            {156,-10}}),                                                                                                    iconTransformation(extent={{160,-10},
            {180,10}})));
...
=0+0+0+Pm0")}),
      Icon(coordinateSystem(preserveAspectRatio=false,  extent={{-160,-80},{160,
            60}}),                                                                             graphics={  Rectangle(extent={{
              -160,60},{160,-80}},                                                                                                  lineColor = {0, 0, 255}),
                                                                                          Text(extent={{
              -52,20},{68,-20}},                                                                                                  lineColor=
              {0,0,255},
          textString="IEESGO"),
        Text(

...
equation
  ...
  connect(add.y, lV_Gate.n1) annotation(Line(points = {{-67.5, -17}, {-55.75, -17}, {-55.75, 1.8}, {-43, 1.8}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(lV_Gate.n2, add2.y) annotation(Line(points = {{-43, -2.6}, {-43, -25.3}, {-42.5, -25.3}, {-42.5, -47}}, color = {0, 0, 127}, smooth = Smooth.None));

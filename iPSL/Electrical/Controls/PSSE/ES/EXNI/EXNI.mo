...
protected
  ...
  NonElectrical.Continuous.SimpleLag VR(
    K=K_A,
    T=T_A,
    y_start=VR0)                                                                          annotation(Placement(transformation(extent={{-8,-2},
            {6,12}})));
public
...
equation
  ...
  connect(add3_1.u2, VOEL) annotation (Line(points={{-73.2,-16},{-84,-16},{-84,-14},
          {-97,-14}}, color={0,0,127}));
  ...
  connect(Vref.y, add3_2.u1) annotation (Line(points={{-73.4,30},{-58,30},{-58,14.8},
          {-51.2,14.8}}, color={0,0,127}));
  connect(add3_1.y, add3_2.u3) annotation (Line(points={{-59.4,-16},{-54,-16},{-54,
          5.2},{-51.2,5.2}}, color={0,0,127}));

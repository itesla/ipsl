...
model EXNI "Bus or Solid Fed SCR Bridge Excitation System Model Type NI (NVE)"
  ...
  Modelica.Blocks.Interfaces.RealInput ETERM(start = Et0)
    "Ternimal voltage of generator bus"                                                       annotation(Placement(transformation(extent = {{-104, 40}, {-94, 50}}), iconTransformation(extent = {{-100, 34}, {-90, 44}})));
  ...
  NonElectrical.Continuous.SimpleLag simpleLag(K = 1, T = T_R, y_start = Ec0) annotation(Placement(transformation(extent = {{-74, 4}, {-62, 16}})));
  ...
  Modelica.Blocks.Continuous.Derivative derivativeLag(k = K_F, T = T_F1, y_start = 0, initType = Modelica.Blocks.Types.Init.InitialOutput) annotation(Placement(transformation(extent = {{26, -26}, {12, -12}})));
  NonElectrical.Continuous.SimpleLag simpleLag1(K = 1, T = T_F2, y_start = 0) annotation(Placement(transformation(extent = {{-8, -26}, {-22, -12}})));
...
protected
  ...
  NonElectrical.Continuous.SimpleLag VR(K = K_A, T = T_A, y_start = VR0) annotation(Placement(transformation(extent = {{-8, -2}, {6, 12}})));
initial algorithm
  Ec0 := ECOMP;
  Ec0 := ECOMP;
  Efd0 := EFD0;
...
equation
  connect(XADIFD, negCurLogic.XadIfd) annotation(Line(points = {{-95, -50}, {64, -50}, {64, -5.84}, {76.8, -5.84}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(EFD, EFD) annotation(Line(points = {{126, -1}, {126, -1}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Text(extent=  {{-58, -8}, {-52, -14}}, lineColor=  {0, 0, 255}, textString=  "Vs"), Text(extent=  {{-84, 34}, {-76, 26}}, lineColor=  {0, 0, 255}, textString=  "Vref"), Text(extent=  {{-94, -30}, {-78, -36}}, lineColor=  {0, 0, 255}, textString=  "Efd0"), Text(extent=  {{-102, 16}, {-74, 10}}, lineColor=  {0, 0, 255}, textString=  "Ec"), Text(extent=  {{-94, 2}, {-76, -8}}, lineColor=  {0, 0, 255}, textString=  "VOTHSG"), Text(extent=  {{-96, -8}, {-74, -14}}, lineColor=  {0, 0, 255}, textString=  "VOEL"), Text(extent=  {{-96, -16}, {-74, -22}}, lineColor=  {0, 0, 255}, textString=  "VUEL"), Text(extent=  {{-92, 54}, {-80, 46}}, lineColor=  {0, 0, 255}, textString=  "Et"), Text(extent=  {{-88, -42}, {-70, -50}}, lineColor=  {0, 0, 255}, textString=  "XadIfd")}), Documentation(info = "<html>

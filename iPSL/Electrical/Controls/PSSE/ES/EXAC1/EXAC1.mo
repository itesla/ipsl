...
model EXAC1
  ...
  Modelica.Blocks.Interfaces.RealInput ECOMP
    "Compensated generator terminal voltage" annotation (Placement(
        transformation(extent={{-104,14},{-94,26}}), iconTransformation(extent=
            {{-100,-6},{-90,6}})));
  Modelica.Blocks.Interfaces.RealInput VOTHSG "PSS output signal" annotation (
      Placement(transformation(extent={{-122,-26},{-112,-14}}),
        iconTransformation(extent={{-100,34},{-90,46}})));
  Modelica.Blocks.Interfaces.RealInput VOEL "OEL output" annotation (Placement(
        transformation(extent={{-122,-46},{-112,-34}}), iconTransformation(
          extent={{-100,-56},{-90,-44}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput EFD "Excitation voltage" annotation (
      Placement(transformation(extent={{128,-6},{138,6}}), iconTransformation(
          extent={{100,-6},{110,6}})));
...
equation
  ...
  connect(add3_1.y, leadLag.u) annotation (Line(points={{-39.2,-28},{-36,-28},{
          -29.6,-28}}, color={0,0,127}));
  ...
  connect(add1.u1, imSE.VE_OUT) annotation (Line(points={{47,32},{54,32},{54,
          39.9},{59.5,39.9}}, color={0,0,127}));
  connect(add1.u2, imSetPoint3.y) annotation (Line(points={{47,26},{54,26},{54,
          20},{63.4,20}}, color={0,0,127}));
  connect(product.u1, add1.y)
    annotation (Line(points={{25,28},{35.5,28},{35.5,29}}, color={0,0,127}));
  connect(add2.u2, product.y) annotation (Line(points={{3,26},{8,26},{8,25},{
          13.5,25}}, color={0,0,127}));
  ...
  connect(add.u1, add2.y) annotation (Line(points={{28.4,-23.2},{24,-23.2},{24,
          0},{-12,0},{-12,29},{-8.5,29}}, color={0,0,127}));
  connect(limIntegrator.y, imSE.VE_IN) annotation (Line(points={{72.8,-28},{86,
          -28},{86,39.9},{80.5,39.9}}, color={0,0,127}));
  connect(product.u2, imSE.VE_IN) annotation (Line(points={{25,22},{32,22},{32,
          8},{86,8},{86,39.9},{80.5,39.9}}, color={0,0,127}));
  ...
  connect(division.u2, imSE.VE_IN) annotation (Line(points={{-57.2,66.4},{-60,
          66.4},{-60,54},{86,54},{86,39.9},{80.5,39.9}}, color={0,0,127}));
  ...
  connect(Vref.y, add3.u2) annotation (Line(points={{-93.3,-79},{-86,-79},{-86,
          -53.2},{-79.4,-53.2}}, color={0,0,127}));

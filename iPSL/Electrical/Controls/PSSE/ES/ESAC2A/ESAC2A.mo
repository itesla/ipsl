...
model ESAC2A "IEEE Type AC2A Excitation System"
  ...
  iPSL.NonElectrical.Continuous.LeadLag imLeadLag(K = 1, T1 = T_C, T2 = T_B, y_start = VA0 / K_A) annotation(Placement(transformation(extent = {{4, -10}, {24, 10}})));
  NonElectrical.Continuous.SimpleLag Vm(y_start = Vm0, K = 1, T = T_R) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin = {-74, 4})));
  Modelica.Blocks.Math.Product VX annotation(Placement(transformation(extent = {{-3, -3}, {3, 3}}, rotation = 180, origin = {267, -51})));
  ...
  Modelica.Blocks.Math.Add imSum2_2(k1 = -1, k2 = 1) annotation(Placement(transformation(extent = {{-4, 4}, {4, -4}}, rotation = 0, origin = {112, 6})));
  Modelica.Blocks.Math.Gain K_b(k = K_B) annotation(Placement(transformation(extent = {{-4, -4}, {4, 4}}, rotation = 0, origin = {128, 6})));
  ...
  Modelica.Blocks.Math.Gain imGain3(k = K_H) annotation(Placement(transformation(extent = {{-4, -4}, {4, 4}}, rotation = 180, origin = {128, -40})));
  Modelica.Blocks.Math.Gain imGain2(k = K_E) annotation(Placement(transformation(extent = {{-3, -3}, {3, 3}}, rotation = 180, origin = {269, -65})));
  Modelica.Blocks.Math.Gain imGain4(k = K_D) annotation(Placement(transformation(extent = {{-3, -3}, {3, 3}}, rotation = 180, origin = {269, -77})));
  Modelica.Blocks.Interfaces.RealInput XADIFD annotation(Placement(transformation(extent = {{-19, -19}, {19, 19}}, rotation = 0, origin = {-119, -93}), iconTransformation(extent = {{-17, -17}, {17, 17}}, origin = {-117, -1})));
  NonElectrical.Nonlinear.FEX fEX annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin = {338, -26})));
  ...
  Modelica.Blocks.Interfaces.RealInput EFD0 annotation(Placement(transformation(extent = {{-17, -17}, {17, 17}}, rotation = 90, origin = {-61, -207}), iconTransformation(extent = {{-17, -17}, {17, 17}}, origin = {-117, -135})));
  Modelica.Blocks.Interfaces.RealInput VOEL annotation(Placement(transformation(extent = {{-19, -19}, {19, 19}}, rotation = 0, origin = {-117, -45}), iconTransformation(extent = {{-17, -17}, {17, 17}}, origin = {-115, -43})));
  Modelica.Blocks.Interfaces.RealInput VUEL annotation(Placement(transformation(extent = {{-19, -19}, {19, 19}}, rotation = 0, origin = {-117, -145}), iconTransformation(extent = {{-17, -17}, {17, 17}}, origin = {-115, -85})));
  ...
  NonElectrical.Continuous.SimpleLagLim simpleLagLim(K = K_A, T = T_A, outMax = V_AMAX, outMin = V_AMIN, y_start = VA0) annotation(Placement(transformation(extent = {{50, -10}, {70, 10}})));
  NonElectrical.Functions.ImSE imSE(SE1 = S_EE_1, SE2 = S_EE_2, E1 = E_1, E2 = E_2) annotation(Placement(transformation(extent = {{280, -56}, {272, -50}})));
  Modelica.Blocks.Continuous.Derivative derivative(k = K_F, T = T_F, initType = Modelica.Blocks.Types.Init.InitialOutput, y_start = 0) annotation(Placement(transformation(extent = {{84, -74}, {64, -54}})));
  Modelica.Blocks.Math.Division division annotation(Placement(transformation(extent = {{-6, 6}, {6, -6}}, rotation = 90, origin = {338, -50})));
  Modelica.Blocks.Math.Gain gain2(k = K_C) annotation(Placement(transformation(extent = {{-7, -7}, {7, 7}}, rotation = 90, origin = {335, -73})));
  Modelica.Blocks.Math.Add add4 annotation(Placement(transformation(extent = {{4, -4}, {-4, 4}}, rotation = 270, origin = {262, -32})));
  ...
  Modelica.Blocks.Math.Add add5(k1 = -1, k2 = +1) annotation(Placement(transformation(extent = {{4, -4}, {-4, 4}}, rotation = 270, origin = {236, -26})));
  Modelica.Blocks.Math.Division division1 annotation(Placement(transformation(extent = {{-4, 4}, {4, -4}}, rotation = 90, origin = {254, -16})));
...
initial equation
  ...
  VFE0 = VE_0 * (iPSL.NonElectrical.Functions.SE(VE_0, S_EE_1, S_EE_2, E_1, E_2) + K_E) + K_D * XADIFD;
  VA0 = VFE0 * (1 / K_B + K_H);
equation
  connect(product.y, EFD) annotation(Line(points = {{356.6, -2}, {392, -2}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSum2_2.y, K_b.u) annotation(Line(points = {{116.4, 6}, {123.2, 6}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSum2_2.u1, imGain3.y) annotation(Line(points = {{107.2, 3.6}, {104, 3.6}, {104, -40}, {123.6, -40}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imGain2.u, product.u1) annotation(Line(points = {{272.6, -65}, {282, -65}, {282, 2}, {344, 2}, {344, 1.6}, {342.8, 1.6}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(K_b.y, hV_Gate.n1) annotation(Line(points = {{132.4, 6}, {140, 6}, {140, 17.5}, {142.5, 17.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(VUEL, hV_Gate.n2) annotation(Line(points = {{-117, -145}, {144.5, -145}, {144.5, 0.5}, {142.5, 0.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(hV_Gate.p, lV_Gate.n1) annotation(Line(points = {{166.5, 9}, {166.54, 9}, {166.54, 8.5}, {166.75, 8.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(lV_Gate.n2, VOEL) annotation(Line(points = {{166.75, -6.5}, {166.5, -6.5}, {166.5, -45}, {-117, -45}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(VX.u1, imSE.VE_OUT) annotation(Line(points={{270.6,-52.8},{271.2,
          -52.8},{271.2,-53},{271.76,-53}},                                                                                color = {0, 0, 127}));
  connect(imSE.VE_IN, product.u1) annotation(Line(points={{280.4,-53},{282,-53},
  ...
  connect(add4.u1, imSE.VE_OUT) annotation(Line(points={{264.4,-36.8},{264.4,
          -42},{271.76,-42},{271.76,-53}},                                                                              color = {0, 0, 127}));
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -200}, {300, 100}}), graphics={  Text(extent=  {{252, -44}, {280, -48}}, lineColor=  {0, 0, 255}, textString=  "VX=SE*VE"), Text(extent=  {{210, 18}, {216, 8}}, lineColor=  {255, 0, 0}, textString=  "VR"), Text(extent=  {{266, 18}, {272, 8}}, lineColor=  {255, 0, 0}, textString=  "VE")}), Icon(coordinateSystem(extent = {{-100, -200}, {300, 100}}, preserveAspectRatio = false), graphics={  Text(extent=  {{32, -2}, {240, -98}}, lineColor=  {0, 0, 255}, textString=  "ESAC2A"), Rectangle(extent=  {{-100, 100}, {300, -200}}, lineColor=  {0, 0, 255}), Text(extent=  {{-90, 80}, {-24, 0}}, lineColor=  {0, 0, 255}, textString=  "ECOMP"), Text(extent=  {{-90, 122}, {-24, 42}}, lineColor=  {0, 0, 255}, textString=  "VOTHSG"), Text(extent=  {{-88, 32}, {-28, -32}}, lineColor=  {0, 0, 255}, textString=  "XadIfd"), Text(extent=  {{-96, -120}, {-32, -146}}, lineColor=  {0, 0, 255}, textString=  "EFD0"), Text(extent=  {{-86, -10}, {-26, -74}}, lineColor=  {0, 0, 255}, textString=  "VOEL"), Text(extent=  {{-88, -52}, {-28, -116}}, lineColor=  {0, 0, 255}, textString=  "VUEL")}), Documentation(info = "<html>

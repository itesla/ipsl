...
model EXST1 "IEEE Type AC2A Excitation System"
  ...
  iPSL.NonElectrical.Continuous.LeadLag imLeadLag(K = 1, T1 = T_C, T2 = T_B, y_start = Efd0 / K_A) annotation(Placement(transformation(extent = {{116, -32}, {140, -8}})));
  NonElectrical.Continuous.SimpleLag Vm(y_start = Vm0, K = 1, T = T_R) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin = {8, -24})));
  ...
  Modelica.Blocks.Interfaces.RealInput XADIFD annotation(Placement(transformation(extent = {{-19, -19}, {19, 19}}, rotation = 0, origin = {-119, -69}), iconTransformation(extent = {{-17, -17}, {17, 17}}, origin = {-115, -9})));
  ...
  Modelica.Blocks.Interfaces.RealInput EFD0 annotation(Placement(transformation(extent = {{-17, -17}, {17, 17}}, rotation = 0, origin = {-119, -179}), iconTransformation(extent = {{-17, -17}, {17, 17}}, origin = {-39, -165}, rotation = 90)));
  Modelica.Blocks.Interfaces.RealInput ETERM annotation(Placement(transformation(extent = {{-19, -19}, {19, 19}}, rotation = 0, origin = {-117, 31}), iconTransformation(extent = {{-17, -17}, {17, 17}}, origin = {-115, 33})));
  Modelica.Blocks.Math.Add VERR(k1 = -1, k2 = 1) annotation(Placement(transformation(extent = {{-6, 6}, {6, -6}}, rotation = 0, origin = {34, -20})));
  Modelica.Blocks.Nonlinear.Limiter limiter(uMax = V_IMAX, uMin = V_IMIN) annotation(Placement(transformation(extent = {{78, -30}, {98, -10}})));
  NonElectrical.Continuous.SimpleLag Vm1(y_start = Efd0, K = 1, T = T_A) annotation(Placement(transformation(extent = {{-16, -14}, {16, 14}}, rotation = 0, origin = {192, -20})));
  Modelica.Blocks.Math.Gain K_a(k = K_A) annotation(Placement(transformation(extent = {{-4, -4}, {4, 4}}, rotation = 0, origin = {154, -20})));
  ...
  Modelica.Blocks.Interfaces.RealInput VOEL
    "Input from voltage over excitation limiter"                                         annotation(Placement(transformation(extent = {{-138, -110}, {-98, -70}}), iconTransformation(extent = {{-132, -104}, {-98, -70}})));
  Modelica.Blocks.Interfaces.RealInput VUEL
    "Input from voltage under excitation limiter"                                         annotation(Placement(transformation(extent = {{-140, -158}, {-100, -118}}), iconTransformation(extent = {{-132, -142}, {-98, -108}})));
  Modelica.Blocks.Continuous.Derivative imDerivativeLag(k = K_F, T = T_F, y_start = 0, initType = Modelica.Blocks.Types.Init.InitialOutput) annotation(Placement(transformation(extent = {{142, -90}, {122, -70}})));
...
equation
  ...
  connect(V_REF.y, VERR.u2) annotation(Line(points = {{16.6, 14}, {24, 14}, {24, -16.4}, {26.8, -16.4}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-120, -200}, {300, 100}}), graphics = {Text(extent=  {{50, -2}, {56, -12}}, lineColor=  {255, 0, 0}, textString=  "VS"), Text(extent=  {{24, 0}, {38, -16}}, lineColor=  {255, 0, 0}, textString=  "VERR")}), Icon(coordinateSystem(extent = {{-120, -200}, {300, 100}}, preserveAspectRatio = true), graphics = {Text(extent=  {{28, -18}, {188, -60}}, lineColor=  {0, 0, 255}, textString=  "EXST1"), Rectangle(extent=  {{-100, 82}, {280, -160}}, lineColor=  {0, 0, 255}), Text(extent=  {{-90, 100}, {-30, 38}}, lineColor=  {0, 0, 255}, textString=  "ECOMP"), Text(extent=  {{-88, 24}, {-28, -40}}, lineColor=  {0, 0, 255}, textString=  "XADIFD"), Text(extent=  {{-44, -124}, {18, -146}}, lineColor=  {0, 0, 255}, textString=  "EFD0"), Text(extent=  {{-90, 46}, {-32, 20}}, lineColor=  {0, 0, 255}, textString=  "ETERM"), Text(extent=  {{-92, -18}, {-26, -82}}, lineColor=  {0, 0, 255}, textString=  "VOTHSG"), Text(extent=  {{-94, -52}, {-48, -116}}, lineColor=  {0, 0, 255}, textString=  "VOEL"), Text(extent=  {{-94, -94}, {-46, -156}}, lineColor=  {0, 0, 255}, textString=  "VUEL"), Text(extent=  {{238, -10}, {274, -74}}, lineColor=  {0, 0, 255}, textString=  "EFD")}), Documentation(info = "<html>

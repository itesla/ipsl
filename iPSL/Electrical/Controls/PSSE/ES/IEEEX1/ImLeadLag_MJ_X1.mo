...
model ImLeadLag_MJ_X1 "Lead Lag filter.
  modified to match the behavior of IEEEX1 in PSSE"
...
equation
  ...
  //With modification in order to have the same behavior as pss

    T2 *T2* der(y) = -T2*y-K * p1;
  -n1 =(-T2*y-K * p1)*T1/T2 + T2 * y;

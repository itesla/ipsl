...
source-controlled rectifier exciter "
  ...
  NonElectrical.Continuous.SimpleLag Vm(T = T_R, y_start = V0, K = 1) annotation(Placement(transformation(extent = {{-7, -7}, {7, 7}}, rotation = 0, origin = {-89, -35})));
  ...
  Modelica.Blocks.Interfaces.RealInput IFD annotation(Placement(transformation(extent = {{-19, -19}, {19, 19}}, rotation = 0, origin = {-119, -141}), iconTransformation(extent = {{-17, -17}, {17, 17}}, origin = {-119, -117})));
  ...
  Modelica.Blocks.Interfaces.RealInput EFD0 annotation(Placement(transformation(extent = {{-17, -17}, {17, 17}}, rotation = 0, origin = {-121, -195}), iconTransformation(extent = {{-17, -17}, {17, 17}}, origin = {-121, -161})));
  Modelica.Blocks.Interfaces.RealInput VUEL annotation(Placement(transformation(extent = {{-19, -19}, {19, 19}}, rotation = 0, origin = {-123, -77}), iconTransformation(extent = {{-17, -17}, {17, 17}}, origin = {-121, -75})));
  NonElectrical.Continuous.SimpleLag VA(T = T_A, y_start = Efd0 * K_G, K = 1) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin = {108, 4})));
  Modelica.Blocks.Continuous.LimIntegrator VR1(k = K_IR, outMin = V_RMIN / K_PR, outMax = V_RMAX / K_PR, y_start = Efd0 * K_G) annotation(Placement(transformation(extent = {{-12, -22}, {6, -4}})));
  ...
  Modelica.Blocks.Math.Gain gain(k = K_G) annotation(Placement(transformation(extent = {{-9, -9}, {9, 9}}, rotation = 180, origin = {195, 59})));
  Modelica.Blocks.Continuous.LimIntegrator VM1(k = K_IR, outMin = V_MMIN / K_PM, outMax = V_MMAX / K_PM, y_start = Efd0 / VB0) annotation(Placement(transformation(extent = {{166, -26}, {186, -6}})));
  ...
  Modelica.Blocks.Math.Division division annotation(Placement(transformation(extent = {{-7, 7}, {7, -7}}, rotation = 0, origin = {75, -135})));
  Modelica.Blocks.Math.Gain gain2(k = K_C) annotation(Placement(transformation(extent = {{-7, -7}, {7, 7}}, rotation = 0, origin = {45, -131})));
protected
...
initial equation
  ...
  VB0 = VE0 * FEX_INI(IN0);
equation
  connect(product.y, EFD) annotation(Line(points = {{306.7, 3}, {336, 3}, {336, -90}, {240, -90}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Gain1.y, add.u1) annotation(Line(points = {{9, 22}, {26, 22}, {26, 7.6}, {32.8, 7.6}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(add.y, limiter.u) annotation(Line(points = {{46.6, 4}, {52, 4}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Gain2.y, add2.u1) annotation(Line(points = {{185, 22}, {198, 22}, {198, 15.6}, {208.8, 15.6}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(add2.y, limiter1.u) annotation(Line(points = {{222.6, 12}, {226, 12}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Gain2.u, add1.y) annotation(Line(points = {{162, 22}, {142, 22}, {142, 7}, {138.5, 7}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(add1.u1, gain.y) annotation(Line(points = {{127, 10}, {124, 10}, {124, 59}, {185.1, 59}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(gain.u, EFD) annotation(Line(points = {{205.8, 59}, {336, 59}, {336, -90}, {240, -90}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(vE.VE, VB.u1) annotation(Line(points = {{50.4, -73.64}, {81.2, -73.64}, {81.2, -74.8}, {144.6, -74.8}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(VB.y, maxLimiter.u) annotation(Line(points = {{160.7, -79}, {173.8, -79}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(maxLimiter.y, product.u2) annotation(Line(points = {{199.1, -79}, {280, -79}, {280, -1.2}, {290.6, -1.2}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(cons.y, vE.Vr) annotation(Line(points = {{-53.4, -46}, {-48, -46}, {-48, -60}, {-26.4, -60}, {-26.4, -60.32}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(cons1.y, vE.Vi) annotation(Line(points = {{-53.4, -68}, {-40, -68}, {-40, -68.6}, {-26.4, -68.6}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(cons2.y, vE.Ir) annotation(Line(points = {{-53.4, -94}, {-42, -94}, {-42, -76.88}, {-26.4, -76.88}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(cons3.y, vE.Ii) annotation(Line(points = {{-53.4, -116}, {-38, -116}, {-38, -85.52}, {-26.4, -85.52}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(limiter1.y, lV_Gate.n1) annotation(Line(points = {{249, 12}, {258, 12}, {258, 8.98}, {267.3, 8.98}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(V_OEL.y, lV_Gate.n2) annotation(Line(points = {{244.6, -22}, {256, -22}, {256, 4.14}, {267.3, 4.14}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(lV_Gate.p, product.u1) annotation(Line(points = {{281.49, 6.45}, {285.745, 6.45}, {285.745, 7.2}, {290.6, 7.2}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -180}, {340, 100}}), graphics = {Text(extent=  {{70, 26}, {94, 12}}, lineColor=  {255, 0, 0}, textString=  "VR"), Text(extent=  {{44, -6}, {50, -16}}, lineColor=  {255, 0, 0}, textString=  "VH"), Text(extent=  {{116, -140}, {142, -148}}, lineColor=  {255, 0, 0}, textString=  "FEX"), Text(extent=  {{66, -52}, {90, -66}}, lineColor=  {255, 0, 0}, textString=  "VE"), Text(extent=  {{210, -54}, {234, -68}}, lineColor=  {255, 0, 0}, textString=  "VB")}), Icon(coordinateSystem(extent = {{-100, -180}, {340, 100}}, preserveAspectRatio = true), graphics = {Text(extent=  {{-18, -10}, {190, -106}}, lineColor=  {0, 0, 255}, textString=  "ESST4B"), Rectangle(extent=  {{-98, 62}, {228, -178}}, lineColor=  {0, 0, 255}), Text(extent=  {{-88, 8}, {-22, -72}}, lineColor=  {0, 0, 255}, textString=  "ECOMP"), Text(extent=  {{-90, 52}, {-18, -32}}, lineColor=  {0, 0, 255}, textString=  "VOTHSG"), Text(extent=  {{-88, -88}, {-38, -146}}, lineColor=  {0, 0, 255}, textString=  "XadIfd"), Text(extent=  {{-92, -150}, {-34, -174}}, lineColor=  {0, 0, 255}, textString=  "EFD0"), Text(extent=  {{-84, -46}, {-34, -104}}, lineColor=  {0, 0, 255}, textString=  "VUEL"), Text(extent=  {{-60, 76}, {-10, 18}}, lineColor=  {0, 0, 255}, textString=  "GenT")}), Documentation(info = "<html>

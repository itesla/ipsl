...
public
  NonElectrical.Continuous.SimpleLag                        Vm(               T=T_R,
      y_start=V0,
    K=1)
  ...
  Modelica.Blocks.Interfaces.RealInput VUEL
        ...
        origin={-123,-77}), iconTransformation(extent={{-17,-17},{17,17}},
          origin={-121,-75})));
  NonElectrical.Continuous.SimpleLag                        VA(T=T_A, y_start=
        Efd0*K_G,
...
equation
  ...
  connect(lV_Gate.p, product.u1) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(VR1.y, add.u2) annotation (Line(points={{6.9,-13},{26,-13},{26,0.4},{32.8,
          0.4}}, color={0,0,127}));
  ...
  connect(add3_1.y, Gain1.u) annotation (Line(points={{-27,2},{-20,2},{-20,22},{
          -14,22}}, color={0,0,127}));
  connect(VR1.u, Gain1.u) annotation (Line(points={{-13.8,-13},{-20,-13},{-20,22},
          {-14,22}}, color={0,0,127}));
  ...
  connect(fEX.y, VB.u2) annotation (Line(points={{123.5,-135},{134,-135},{134,
          -83.2},{144.6,-83.2}}, color={0,0,127}));
  connect(iN.I_N, fEX.u) annotation (Line(points={{79.68,-135},{85.84,-135},{
          85.84,-135},{92,-135}}, color={0,0,127}));

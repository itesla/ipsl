...
parameter Real I_LR annotation (Dialog(group="Excitation system parameters"));
  ...
  Modelica.Blocks.Math.Gain imGain(k=K_LR) annotation (Placement(
        transformation(
  ...
  NonElectrical.Continuous.LeadLag imLeadLag1(
    ...
    T1=T_C1,
    T2=T_B1)
    annotation (Placement(transformation(extent={{45,15},{55,25}})));

  NonElectrical.Continuous.SimpleLag imSimpleLag(
    K=1,
    y_start=V_0,
    T=T_R)
    annotation (Placement(transformation(extent={{-74.8,-5},{-65,5}})));
...
public
  ...
  Modelica.Blocks.Math.Gain imGain1(k=V_RMIN)
        ...
        rotation=90,
        origin={130.15,-45.35})));
  Modelica.Blocks.Math.Gain imGain2(k=V_RMAX)
                                           annotation (Placement(
        transformation(
        extent={{-4.65,-4.85},{4.65,4.85}},
        rotation=90,
...
public
  Modelica.Blocks.Math.Add add3(k1=-1)
    annotation (Placement(transformation(extent={{5,-5},{-5,5}},
        rotation=270,
        origin={155,-25})));
  Modelica.Blocks.Math.Gain imGain3(k=K_C) annotation (Placement(
        transformation(
        extent={{-4.65,-4.85},{4.65,4.85}},
        rotation=90,
        origin={165.15,-45.35})));
...
equation
  ...
  connect(VUEL2, hV_GATE.n2) annotation (Line(
      points={{-95.5,-46},{-55.4,-46},{-55.4,-45.6},{-0.7,-45.6},{-0.7,18.196},{
          5.375,18.196}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(VUEL3, hV_GATE1.n2) annotation (Line(
      points={{-95.3,-66},{69.9,-66},{69.9,-0.7},{115.3,-0.7},{115.3,11.7}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(ECOMP, imSimpleLag.u) annotation (Line(points={{-95.3,0.4},{-85.65,0.4},
          {-85.65,0},{-75.78,0}}, color={0,0,127}));
  connect(Vref.y, add.u1) annotation (Line(points={{-65.52,20.95},{-60,20.95},{-60,
  ...
  connect(add.y, add3_1.u3) annotation (Line(points={{-44.5,5},{-40,5},{-40,21},
          {-35,21}}, color={0,0,127}));
  connect(add1.y, add3_1.u2) annotation (Line(points={{-44.5,55},{-40,55},{-40,25},
          {-35,25}}, color={0,0,127}));
  connect(imDerivativeLag.y, add3_1.u1) annotation (Line(points={{38.87,55.3},{-38,
          55.3},{-38,29},{-35,29}}, color={0,0,127}));
  ...
  connect(imLimited.y, hV_GATE.n1) annotation (Line(points={{-5.49,24.9},{0,24.9},
          {0,22.772},{5.375,22.772}}, color={0,0,127}));
  ...
  connect(add2.u2, XADIFD) annotation (Line(points={{88,-57},{88,-77.55},{103.25,
          -77.55}}, color={0,0,127}));
  connect(imGain.y, imLimited1.u) annotation (Line(points={{85.15,-26.235},{85.15,
          -23.6175},{84.9,-23.6175},{84.9,-21.22}}, color={0,0,127}));
  connect(add3_2.y, hV_GATE1.n1) annotation (Line(points={{106.5,16},{115.3,16},
          {115.3,16.1}}, color={0,0,127}));
  connect(simpleLagLim.y, add3_2.u1)
    annotation (Line(points={{74.5,20},{84.75,20},{95,20}}, color={0,0,127}));
  connect(VOTHSG2, add3_2.u3) annotation (Line(points={{-95.4,-25},{-28,-25},{40,
          -25},{40,12},{95,12}}, color={0,0,127}));
  connect(imLimited1.y, add3_2.u2) annotation (Line(points={{84.9,-9.49},{84.9,16},
          {95,16}}, color={0,0,127}));
  ...
  connect(lV_GATE.p, variableLimiter.u) annotation (Line(points={{145.7,7.8},{
          150,7.8},{150,0},{156.8,0}}, color={0,0,127}));
  connect(add3.y, variableLimiter.limit1) annotation (Line(points={{155,-19.5},
          {155,-16},{155,-16},{155,4.8},{156.8,4.8}}, color={0,0,127}));
  connect(imGain1.y, variableLimiter.limit2) annotation (Line(points={{130.15,
          -40.235},{130.15,-4.8},{156.8,-4.8}}, color={0,0,127}));

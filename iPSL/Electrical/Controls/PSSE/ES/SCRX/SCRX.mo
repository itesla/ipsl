...
model SCRX "Bus Fed or Solid Fed Static Exciter"
  ...
  Modelica.Blocks.Math.Add3 V_erro(k3 = 1, k1 = 1, k2 = -1) annotation(Placement(transformation(extent = {{-52, -8}, {-36, 8}})));
  ...
  iPSL.NonElectrical.Continuous.LeadLag imLeadLag(K = 1, y_start = VR0 / K, T1 = T_AT_B * T_B, T2 = T_B) annotation(Placement(transformation(extent = {{-28, -10}, {-8, 10}})));
  ...
  NonElectrical.Continuous.SimpleLagLim simpleLagLim(K = K, T = T_E, y_start = VR0, outMax = E_MAX, outMin = E_MIN) annotation(Placement(transformation(extent = {{10, -10}, {30, 10}})));
...
equation
  connect(ETERM, V_erro.u2) annotation(Line(points = {{-109, 5}, {-56, 5}, {-56, 0}, {-53.6, 0}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(XADIFD, negCurLogic.XadIfd) annotation(Line(points = {{-109, -42}, {55, -42}, {55, -11}, {62.3333, -11}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(negCurLogic.Efd, EFD) annotation(Line(points = {{113.667, 0}, {114.7, 0}, {114.7, -19}, {124, -19}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  annotation(Placement(transformation(extent = {{-114, 44}, {-102, 58}}), iconTransformation(extent = {{-100, -50}, {-90, -40}})), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-120, -120}, {120, 80}}), graphics = {Text(extent=  {{-110, 38}, {-92, 26}}, lineColor=  {0, 0, 255}, textString=  "Ecomp
             "), Text(extent=  {{-104, 14}, {-92, 6}}, lineColor=  {0, 0, 255}, textString=  "Et"), Text(extent=  {{-106, 6}, {-86, -16}}, lineColor=  {0, 0, 255}, textString=  "VOTHSG "), Text(extent=  {{-108, -12}, {-82, -18}}, lineColor=  {0, 0, 255}, textString=  " VOEL"), Text(extent=  {{-110, -22}, {-80, -28}}, lineColor=  {0, 0, 255}, textString=  " VUEL "), Text(extent=  {{-102, 26}, {-90, 12}}, lineColor=  {0, 0, 255}, textString=  "Efd0"), Text(extent=  {{-102, -34}, {-84, -42}}, lineColor=  {0, 0, 255}, textString=  "XadIfd"), Text(extent=  {{106, 14}, {122, 6}}, lineColor=  {0, 0, 255}, textString=  "Efd")}), Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-120, -120}, {120, 80}}), graphics={  Rectangle(extent = {{-120, 80}, {120, -120}}, lineColor = {0, 0, 255}), Text(extent = {{-114, -48}, {-70, -66}}, lineColor = {0, 0, 255}, textString = "ETERM"), Text(extent = {{-114, 62}, {-62, 32}}, lineColor = {0, 0, 255}, textString = "VOTHSG "), Text(extent = {{90, 4}, {122, -10}}, lineColor = {0, 0, 255}, textString = "EFD"), Text(extent = {{-52, 26}, {60, -56}}, lineColor = {0, 0, 255}, textString = "SCRX"), Text(extent = {{-114, -2}, {-80, -16}}, lineColor = {0, 0, 255}, textString = " VUEL "), Text(extent = {{-118, 26}, {-74, 12}}, lineColor = {0, 0, 255}, textString = " VOEL"), Text(extent = {{-112, -82}, {-88, -106}}, lineColor = {0, 0, 255}, textString = "Efd0"), Text(extent = {{-112, -24}, {-72, -42}}, lineColor = {0, 0, 255}, textString = "XADIFD"), Text(extent = {{-114, 86}, {-72, 58}}, lineColor = {0, 0, 255}, textString = "ECOMP")}), Documentation(info = "<html>

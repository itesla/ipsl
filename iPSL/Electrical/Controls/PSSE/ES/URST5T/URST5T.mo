...
model URST5T "IEEE Proposed Type ST5B Excitation System"
  ...
  Modelica.Blocks.Interfaces.RealInput ECOMP annotation (Placement(
        transformation(extent={{-144,-32},{-106,6}}), iconTransformation(extent
          ={{-128,82},{-94,116}})));
  Modelica.Blocks.Interfaces.RealInput V_REF annotation (Placement(
        transformation(extent={{-130,40},{-92,78}}), iconTransformation(extent=
            {{-130,40},{-92,78}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput EFD annotation (Placement(
        transformation(extent={{410,-40},{430,-20}}), iconTransformation(extent
          ={{410,-40},{430,-20}})));
...
equation
  ...
  connect(VERR1.u1, lV_Gate.p) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(Vm.u, ECOMP) annotation (Line(points={{-89.8,-13},{-100.9,-13},{-125,
          -13}}, color={0,0,127}));
  ...
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,-200},{
          ...
          lineColor={255,0,0},
          textString="VERR")}),
    Icon(coordinateSystem(extent={{-120,-200},{420,120}}, preserveAspectRatio=
            true), graphics={Text(
          extent={{42,14},{234,-78}},
          lineColor={0,0,255},
          textString="URST5T"),Rectangle(extent={{-100,120},{300,-200}},

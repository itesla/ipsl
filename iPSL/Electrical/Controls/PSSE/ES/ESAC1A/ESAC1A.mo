...
model ESAC1A
  ...
  Modelica.Blocks.Interfaces.RealInput XADIFD "Field current" annotation(Placement(transformation(extent = {{-5, -6}, {5, 6}}, rotation = 180, origin = {219, -86}), iconTransformation(extent = {{-5, -6}, {5, 6}}, rotation = 90, origin = {-0.5, -54.9})));
  ...
  Modelica.Blocks.Interfaces.RealInput VOEL
    "value from the Over Excitation Limiter"                                         annotation(Placement(transformation(extent = {{-5, -6}, {5, 6}}, rotation = 270, origin = {43, 62}), iconTransformation(extent = {{-5, -6}, {5, 6}}, rotation = 90, origin = {-60.2, -54.9})));
  ...
  Modelica.Blocks.Interfaces.RealInput VUEL "Under Excitation Limiter output" annotation(Placement(transformation(extent = {{-5, -6}, {5, 6}}, rotation = 270, origin = {17, 62}), iconTransformation(extent = {{-5, -6}, {5, 6}}, rotation = 90, origin = {-120, -54.6})));
  ...
  NonElectrical.Continuous.LeadLag imLeadLag(K = 1, T1 = T_C, T2 = T_B, y_start = VR0 / K_A) annotation(Placement(transformation(extent = {{-66, 30}, {-46, 50}})));
  NonElectrical.Continuous.SimpleLag imSimpleLag(K = 1, y_start = V0, T = T_R) annotation(Placement(transformation(extent = {{-170, 30}, {-150, 50}})));
  NonElectrical.Functions.ImSE imSE(SE1 = S_EE_1, SE2 = S_EE_2, E1 = E_1, E2 = E_2) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 180, origin = {158, -16})));
  Modelica.Blocks.Math.Product product annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 180, origin = {130, -22})));
  Modelica.Blocks.Math.Gain gain(k = K_E) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 180, origin = {130, -52})));
  Modelica.Blocks.Math.Gain gain1(k = K_D) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 180, origin = {130, -86})));
  Modelica.Blocks.Math.Add3 add3_1 annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 180, origin = {54, -52})));
  Modelica.Blocks.Math.Gain gain2(k = K_C) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin = {198, -66})));
  Modelica.Blocks.Math.Division division annotation(Placement(transformation(extent = {{-10, 10}, {10, -10}}, rotation = 90, origin = {192, -34})));
  NonElectrical.Nonlinear.FEX fEX annotation(Placement(transformation(extent = {{-8, -8}, {8, 8}}, rotation = 90, origin = {192, 2})));
  Modelica.Blocks.Math.Product product1 annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin = {212, 32})));
  Modelica.Blocks.Interfaces.RealInput EFD0 annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}, rotation = 90, origin = {-14, -58}), iconTransformation(extent = {{-6, -6}, {6, 6}}, rotation = 90, origin = {60, -54})));
  ...
  Modelica.Blocks.Continuous.LimIntegrator limIntegrator(k = 1 / T_E, outMax = Modelica.Constants.inf, outMin = 0, initType = Modelica.Blocks.Types.Init.InitialOutput, y_start = VE0) annotation(Placement(transformation(extent = {{144, 28}, {164, 48}})));
  NonElectrical.Continuous.SimpleLagLim simpleLagLim(K = K_A, T = T_A, y_start = VR0, outMax = V_AMAX, outMin = V_AMIN) annotation(Placement(transformation(extent = {{-20, 30}, {0, 50}})));
  Modelica.Blocks.Continuous.Derivative derivative(k = K_F, T = T_F, initType = Modelica.Blocks.Types.Init.InitialOutput, y_start = 0) annotation(Placement(transformation(extent = {{0, -10}, {-20, 10}})));
protected
...
equation
  connect(hV_GATE.p, lV_GATE.n1) annotation(Line(points = {{38.75, 44}, {38.75, 41}, {38.75, 41}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(VOEL, lV_GATE.n2) annotation(Line(points = {{43, 62}, {43, 56}, {43, 51}, {38.75, 51}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(product.u2, imSE.VE_OUT) annotation(Line(points={{142,-16},{147.4,-16},
          {147.4,-16}},                                                                                 color = {0, 0, 127}));
  ...
  connect(imSE.VE_IN, product1.u1) annotation(Line(points={{169,-16},{176,-16},
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-220, -60}, {240, 60}}, grid = {2, 2}), graphics={  Text(extent=  {{200, -20}, {194, -18}}, lineColor=  {255, 0, 0}, textString=  "N"), Text(extent=  {{192, -14}, {198, -20}}, lineColor=  {255, 0, 0}, textString=  "I")}), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-220, -60}, {240, 60}}, grid = {2, 2}), graphics={  Rectangle(extent=  {{-220, 60}, {240, -60}}, lineColor=  {0, 0, 255}), Text(extent=  {{-26, -32}, {26, -54}}, lineColor=  {0, 0, 255}, textString=  "XADIFD"), Text(extent=  {{-204, 40}, {-164, 20}}, lineColor=  {0, 0, 255}, textString=  "ECOMP"), Text(extent=  {{-210, -24}, {-158, -36}}, lineColor=  {0, 0, 255}, textString=  "VOTHSG"), Text(extent=  {{-76, -36}, {-42, -50}}, lineColor=  {0, 0, 255}, textString=  "VOEL"), Text(extent=  {{208, 8}, {238, -8}}, lineColor=  {0, 0, 255}, textString=  "EFD"), Text(extent=  {{-54, 32}, {50, -30}}, lineColor=  {0, 0, 255}, textString=  "ESAC1A"), Text(extent=  {{-136, -36}, {-103, -49}}, lineColor=  {0, 0, 255}, textString=  "VUEL"), Text(extent=  {{38, -36}, {82, -50}}, lineColor=  {0, 0, 255}, textString=  "EFD0")}), Documentation(info = "<html>

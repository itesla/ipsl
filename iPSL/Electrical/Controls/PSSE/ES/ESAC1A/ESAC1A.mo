...
model ESAC1A
  ...
  Modelica.Blocks.Interfaces.RealInput ECOMP
    "Input, generator terminal voltage" annotation (Placement(transformation(
          extent={{-220,24},{-210,36}}), iconTransformation(extent={{-220,24},{
            -210,36}})));
  Modelica.Blocks.Interfaces.RealInput VOTHSG "Upss" annotation (Placement(
        transformation(extent={{-220,-36},{-210,-24}}), iconTransformation(
          extent={{-220,-36},{-210,-24}})));
  Modelica.Blocks.Interfaces.RealInput VOEL
    "value from the Over Excitation Limiter" annotation (Placement(
        transformation(
        extent={{-5,-6},{5,6}},
        rotation=270,
...
equation
  ...
  connect(VUEL, hV_GATE.n2)
    annotation (Line(points={{17,62},{17,49},{18.75,49}}, color={0,0,127}));
  connect(add3_1.u2, gain.y)
    annotation (Line(points={{66,-52},{66,-52},{119,-52}}, color={0,0,127}));
  connect(product.y, add3_1.u3) annotation (Line(points={{119,-22},{72,-22},{72,
          -44},{66,-44}}, color={0,0,127}));
  connect(add3_1.u1, gain1.y) annotation (Line(points={{66,-60},{78,-60},{78,-86},
          {119,-86}}, color={0,0,127}));
  ...
  connect(ECOMP, imSimpleLag.u) annotation (Line(points={{-215,30},{-194,30},{-194,
          40},{-172,40}}, color={0,0,127}));
  connect(imSimpleLag.y, add3_2.u2)
    annotation (Line(points={{-149,40},{-138,40}}, color={0,0,127}));
  connect(const.y, add3_2.u1) annotation (Line(points={{-149,74},{-146,74},{-146,
          48},{-138,48}}, color={0,0,127}));
  connect(VOTHSG, add3_2.u3) annotation (Line(points={{-215,-30},{-146,-30},{-146,
  ...
  connect(lV_GATE.p, limiter1.u) annotation (Line(points={{58.75,46},{58.75,
  ...
  annotation (
    ...
    Icon(coordinateSystem(
        preserveAspectRatio=false,
        extent={{-220,-60},{240,60}},
        grid={2,2}), graphics={Rectangle(extent={{-220,60},{240,-60}},

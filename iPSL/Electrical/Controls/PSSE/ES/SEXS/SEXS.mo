...
model SEXS "Simplified excitation system model"
  ...
  Modelica.Blocks.Interfaces.RealInput ECOMP annotation (Placement(
        transformation(extent={{-102,-4},{-92,8}}), iconTransformation(extent={
            {-100,44},{-88,56}})));
  Modelica.Blocks.Interfaces.RealOutput EFD annotation (Placement(
        transformation(extent={{100,-6},{112,6}}), iconTransformation(extent={{
            100,-6},{112,6}})));
  ...
  Modelica.Blocks.Interfaces.RealInput VOTHSG(start=0) "PSS output Upss"
    annotation (Placement(transformation(extent={{-102,-14},{-92,-4}}),
        iconTransformation(extent={{-100,24},{-88,36}})));
  Modelica.Blocks.Interfaces.RealInput VOEL "OEL output" annotation (Placement(
        transformation(extent={{-102,-24},{-92,-14}}), iconTransformation(
          extent={{-100,-6},{-88,6}})));
  Modelica.Blocks.Interfaces.RealInput VUEL annotation (Placement(
        transformation(extent={{-102,-34},{-92,-24}}), iconTransformation(
          extent={{-100,-36},{-88,-24}})));
  Modelica.Blocks.Interfaces.RealInput EFD0 annotation (Placement(
        transformation(extent={{-102,10},{-92,24}}), iconTransformation(extent=
            {{-100,-56},{-88,-44}})));
...
equation
  ...
  connect(const.y, V_erro.u1) annotation (Line(points={{-71,50},{-62,50},{-62,
          8.4},{-53.6,8.4}}, color={0,0,127}));
  ...
  annotation (
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-80},{100,80}}),
        graphics={Text(
          extent={{-22,10},{24,-12}},
          lineColor={0,0,255},
          textString="SEXS"),Rectangle(extent={{-100,80},{100,-80}}, lineColor=
          {0,0,255}),Text(
          extent={{-84,38},{-54,20}},
          lineColor={0,0,255},
          textString="VOTHSG "),Text(

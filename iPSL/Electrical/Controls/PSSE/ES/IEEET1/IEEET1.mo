...
model IEEET1 "IEEE Type 1 excitation system"
  ...
  NonElectrical.Functions.ImSE se1(SE1 = S_EE_1, SE2 = S_EE_2, E1 = E_1, E2 = E_2) annotation(Placement(transformation(extent = {{-8, -10}, {8, 10}}, rotation = 180, origin = {54, 38})));
  ...
  Modelica.Blocks.Math.Gain KE_EFD(k = KE0) annotation(Placement(transformation(extent = {{-4, -4}, {4, 4}}, rotation = 180, origin = {46, 16})));
  Modelica.Blocks.Math.Add sum5 annotation(Placement(transformation(extent = {{-4, -4}, {4, 4}}, rotation = 180, origin = {20, 18})));
  ...
  NonElectrical.Continuous.SimpleLag imSimpleLag1(K = 1, y_start = VT0, T = T_R) annotation(Placement(transformation(extent = {{-86, -4}, {-72, 10}})));
  Modelica.Blocks.Math.Add3 sum1 annotation(Placement(transformation(extent = {{-74, -22}, {-64, -12}})));
  Modelica.Blocks.Continuous.Integrator integrator(k = 1 / T_E, initType = Modelica.Blocks.Types.Init.InitialOutput, y_start = Efd0) annotation(Placement(transformation(extent = {{42, -6}, {52, 4}})));
  Modelica.Blocks.Continuous.Derivative derivativeLag(k = K_F, T = T_F, y_start = 0) annotation(Placement(transformation(extent = {{12, -40}, {2, -30}})));
  NonElectrical.Continuous.SimpleLagLim simpleLagLim(K = K_A, T = T_A, y_start = VR0, outMax = V_RMAX, outMin = V_RMIN) annotation(Placement(transformation(extent = {{-8, -8}, {2, 2}})));
protected
...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-140, -100}, {120, 100}}), graphics = {Text(extent=  {{10, 40}, {38, 32}}, lineColor=  {0, 0, 255}, textString=  "VE=SE*EFD"), Text(extent=  {{-110, 10}, {-82, 4}}, lineColor=  {0, 0, 255}, textString=  "Ec"), Text(extent=  {{-102, -20}, {-80, -26}}, lineColor=  {0, 0, 255}, textString=  "VUEL"), Text(extent=  {{-102, -12}, {-80, -18}}, lineColor=  {0, 0, 255}, textString=  "VOEL"), Text(extent=  {{-100, -2}, {-82, -12}}, lineColor=  {0, 0, 255}, textString=  "VOTHSG")}), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-140, -100}, {120, 100}}), graphics = {Rectangle(extent=  {{-140, 100}, {120, -100}}, lineColor=  {0, 0, 255}), Text(extent=  {{-126, -36}, {-68, -62}}, lineColor=  {0, 0, 255}, textString=  "ECOMP
"), Text(extent=  {{-124, 92}, {-60, 68}}, lineColor=  {0, 0, 255}, textString=  "VOTHSG"), Text(extent=  {{-130, 8}, {-80, -8}}, lineColor=  {0, 0, 255}, textString=  "VUEL"), Text(extent=  {{88, 8}, {118, -8}}, lineColor=  {0, 0, 255}, textString=  "EFD"), Text(extent=  {{-46, 36}, {54, -36}}, lineColor=  {0, 0, 255}, textString=  "IEEET1"), Text(extent=  {{-126, 48}, {-84, 32}}, lineColor=  {0, 0, 255}, textString=  "VOEL"), Text(extent=  {{-132, -72}, {-76, -88}}, lineColor=  {0, 0, 255}, textString=  "EFD0")}), Documentation(info = "<html>

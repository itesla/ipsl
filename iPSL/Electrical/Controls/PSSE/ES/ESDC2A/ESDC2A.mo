...
model ESDC2A
  ...
  Modelica.Blocks.Continuous.Derivative imDerivativeLag(k = K_F, T = T_F1, y_start = 0, initType = Modelica.Blocks.Types.Init.InitialOutput) annotation(Placement(transformation(extent = {{8, -6}, {-4, 6}})));
  ...
  Modelica.Blocks.Interfaces.RealInput VT "sensed VT" annotation(Placement(transformation(extent = {{-5, -6}, {5, 6}}, rotation = 270, origin = {23, -62}), iconTransformation(extent = {{-6, -6}, {6, 6}}, rotation = 90, origin = {-10, -34})));
  Modelica.Blocks.Interfaces.RealInput EFD0 annotation(Placement(transformation(extent = {{-7, -7}, {7, 7}}, rotation = 0, origin = {-129, 39}), iconTransformation(extent = {{-6, -6}, {6, 6}}, rotation = 90, origin = {-50, -34})));
  NonElectrical.Functions.ImSE imSE(SE1 = S_EE_1, SE2 = S_EE_2, E1 = E_1, E2 = E_2) annotation(Placement(transformation(extent = {{82, 38}, {64, 58}})));
  NonElectrical.Continuous.LeadLag imLeadLag(K = 1, T1 = T_C, T2 = T_B, y_start = vr0 / K_A) annotation(Placement(transformation(extent = {{-34, -34}, {-22, -22}})));
  ...
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag1(K = 1, T = T_R, y_start = ECOMP0) annotation(Placement(transformation(extent = {{-74, 26}, {-66, 34}})));
  ...
  Modelica.Blocks.Continuous.Integrator integrator(k = 1 / T_E, initType = Modelica.Blocks.Types.Init.InitialOutput, y_start = vf00) annotation(Placement(transformation(extent = {{70, -32}, {82, -20}})));
  NonElectrical.Continuous.SimpleLagLimVar simpleLagLimVar(K = K_A, T = T_A, y_start = vr0) annotation(Placement(transformation(extent = {{12, -34}, {22, -24}})));
  Modelica.Blocks.Math.Gain gain(k = V_RMIN) annotation(Placement(transformation(extent = {{-3, -3}, {3, 3}}, rotation = 90, origin = {13, -47})));
  Modelica.Blocks.Math.Gain gain1(k = V_RMAX) annotation(Placement(transformation(extent = {{-3, -3}, {3, 3}}, rotation = 90, origin = {29, -47})));
protected
...
initial equation
  ...
  VREF = vr0 / K_A + ECOMP0;
equation
  connect(VUEL, hV_GATE.n2) annotation(Line(points = {{-91, -74}, {-16.7, -74}, {-16.7, -32.6}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -40}, {100, 40}})), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -40}, {100, 40}}), graphics = {Rectangle(extent=  {{-100, 40}, {100, -40}}, lineColor=  {0, 0, 255}), Text(extent=  {{74, 4}, {102, -6}}, lineColor=  {0, 0, 255}, textString=  "EFD"), Text(extent=  {{-42, 8}, {40, -12}}, lineColor=  {0, 0, 255}, textString=  "ESDC2A"), Text(extent=  {{-86, 38}, {-56, 22}}, lineColor=  {0, 0, 255}, textString=  "ECOMP"), Text(extent=  {{-86, 16}, {-54, 6}}, lineColor=  {0, 0, 255}, textString=  "VOTHSG"), Text(extent=  {{-88, -4}, {-62, -14}}, lineColor=  {0, 0, 255}, textString=  "VOEL"), Text(extent=  {{-92, -24}, {-60, -34}}, lineColor=  {0, 0, 255}, textString=  "VUEL"), Text(extent=  {{-66, -18}, {-34, -28}}, lineColor=  {0, 0, 255}, textString=  "EFD0"), Text(extent=  {{-26, -18}, {6, -28}}, lineColor=  {0, 0, 255}, textString=  "VT")}), Documentation(info = "<html>

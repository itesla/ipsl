...
model IEEET2 "IEEE Type 2 excitation system"
  ...
  Modelica.Blocks.Interfaces.RealInput VOTHSG "PSS output Upss" annotation (
      Placement(transformation(extent={{-110,-20},{-104,-12}}),
        iconTransformation(extent={{-126,30},{-106,50}})));
  Modelica.Blocks.Interfaces.RealInput VOEL "OEL output" annotation (Placement(
        transformation(extent={{-110,-28},{-104,-20}}), iconTransformation(
          extent={{-126,-10},{-106,10}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput EFD(start=Efd0)
    "Output,excitation voltage" annotation (Placement(transformation(extent={{
            100,-6},{110,6}}), iconTransformation(extent={{120,-10},{138,10}})));
  Modelica.Blocks.Interfaces.RealInput VUEL annotation (Placement(
        transformation(extent={{-112,-38},{-106,-30}}), iconTransformation(
          extent={{-126,-50},{-106,-30}})));
  ...
  Modelica.Blocks.Interfaces.RealInput EFD0 "Input, generator terminal voltage"
    annotation (Placement(transformation(extent={{-110,-46},{-104,-38}}),
        iconTransformation(extent={{-126,-90},{-106,-70}})));
  ...
  Modelica.Blocks.Math.Add3 add3_1(k2=-1)
    annotation (Placement(transformation(extent={{-52,-4},{-38,10}})));
  Modelica.Blocks.Math.Add3 add3_2
    annotation (Placement(transformation(extent={{-76,-36},{-64,-24}})));
  Modelica.Blocks.Math.Add add(k2=-1)
    annotation (Placement(transformation(extent={{-28,-8},{-16,4}})));
  ...
  Modelica.Blocks.Continuous.Derivative derivativeLag(
    ...
    annotation (Placement(transformation(extent={{28,-40},{14,-26}})));
...
equation
  connect(ECOMP, imSimpleLag1.u)
    annotation (Line(points={{-114,2},{-77.4,2},{-77.4,3}}, color={0,0,127}));
  connect(imSimpleLag1.y, add3_1.u2)
    annotation (Line(points={{-61.3,3},{-53.4,3}}, color={0,0,127}));
  connect(Vref.y, add3_1.u1) annotation (Line(points={{-83.4,20},{-58,20},{-58,
          8.6},{-53.4,8.6}}, color={0,0,127}));
  connect(VOTHSG, add3_2.u1) annotation (Line(points={{-107,-16},{-80,-16},{-80,
          -25.2},{-77.2,-25.2}}, color={0,0,127}));
  connect(add3_2.u2, VOEL) annotation (Line(points={{-77.2,-30},{-102,-30},{-102,
          -24},{-107,-24}}, color={0,0,127}));
  connect(VUEL, add3_2.u3) annotation (Line(points={{-109,-34},{-77.2,-34},{-77.2,
          -34.8}}, color={0,0,127}));
  connect(add3_2.y, add3_1.u3) annotation (Line(points={{-63.4,-30},{-58,-30},{
          -58,-2.6},{-53.4,-2.6}}, color={0,0,127}));
  connect(add3_1.y, add.u1) annotation (Line(points={{-37.3,3},{-33.65,3},{-33.65,
          1.6},{-29.2,1.6}}, color={0,0,127}));
  connect(simpleLag.y, add.u2) annotation (Line(points={{-16.7,-33},{-34,-33},{
          -34,-5.6},{-29.2,-5.6}}, color={0,0,127}));
  connect(simpleLag.u, derivativeLag.y) annotation (Line(points={{-0.6,-33},{
          6.7,-33},{13.3,-33}}, color={0,0,127}));
  connect(integrator.y, EFD)
    annotation (Line(points={{86.6,0},{105,0}}, color={0,0,127}));
  connect(add1.y, integrator.u)
    annotation (Line(points={{52.6,0},{72.8,0}}, color={0,0,127}));
  connect(se1.VE_IN, EFD) annotation (Line(points={{86.4,41.09},{96,41.09},{96,
          0},{105,0}}, color={0,0,127}));
  connect(product.u1, se1.VE_OUT) annotation (Line(points={{61,40},{69.6,40},{
          69.6,41.09}}, color={0,0,127}));
  connect(product.u2, EFD) annotation (Line(points={{61,34},{96,34},{96,0},{105,
          0}}, color={0,0,127}));
  connect(add2.u1, product.y) annotation (Line(points={{43.2,31.6},{46,31.6},{
          46,37},{49.5,37}}, color={0,0,127}));
  connect(add2.y, add1.u1) annotation (Line(points={{29.4,28},{24,28},{24,12},{
          32,12},{32,3.6},{38.8,3.6}}, color={0,0,127}));
  connect(derivativeLag.u, add1.u2) annotation (Line(points={{29.4,-33},{36,-33},
          {36,-3.6},{38.8,-3.6}}, color={0,0,127}));
  ...
  annotation (
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-120,-100},{120,
          ...
          extent={{-102,-74},{-78,-86}},
          lineColor={0,0,255},
          textString="EFD0"),Rectangle(extent={{-120,100},{120,-100}},

...
model IEEET2 "IEEE Type 2 excitation system"
  ...
  NonElectrical.Functions.ImSE                       se1(
    ...
    SE2=S_EE_2,
    E1=E_1,
    E2=E_2)                                                                                      annotation(Placement(transformation(extent = {{-8, -9}, {8, 9}}, rotation = 180, origin={78,41})));
  Modelica.Blocks.Interfaces.RealInput ECOMP
    "Input, generator terminal voltage"                                             annotation(Placement(visible = true, transformation(origin={-114,2},    extent = {{-4, -4}, {4, 4}}, rotation = 0), iconTransformation(origin={-116,80},    extent={{-10,-10},
            {10,10}},                                                                                                  rotation = 0)));
protected
...
public
  ...
  NonElectrical.Continuous.DerivativeLag derivativeLag(
    K=K_F,
    y_start=0,
    T=T_F1) annotation (Placement(transformation(extent={{28,-40},{14,-26}})));
...
equation
  ...
  connect(Vref.y, add3_1.u1) annotation (Line(points={{-83.4,20},{-58,20},{-58,8.6},
          {-53.4,8.6}}, color={0,0,127}));
  ...
  connect(VUEL, add3_2.u3) annotation (Line(points={{-109,-34},{-77.2,-34},{-77.2,
          -34.8}}, color={0,0,127}));
  connect(add3_2.y, add3_1.u3) annotation (Line(points={{-63.4,-30},{-58,-30},{-58,
  ...
  connect(se1.VE_IN, EFD) annotation (Line(points={{86.4,41.09},{96,41.09},{96,0},
          {105,0}}, color={0,0,127}));
  connect(product.u1, se1.VE_OUT) annotation (Line(points={{61,40},{69.6,40},{69.6,
          41.09}}, color={0,0,127}));
  connect(product.u2, EFD) annotation (Line(points={{61,34},{96,34},{96,0},{105,
          0}}, color={0,0,127}));
  connect(add2.u1, product.y) annotation (Line(points={{43.2,31.6},{46,31.6},{46,
          37},{49.5,37}}, color={0,0,127}));

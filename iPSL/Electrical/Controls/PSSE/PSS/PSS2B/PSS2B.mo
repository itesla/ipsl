...
model PSS2B
  ...
  Modelica.Blocks.Interfaces.RealInput V_S1 "PSS input signal 1"
                                                               annotation(Placement(transformation(extent={{-186,14},
            {-174,26}})));
  ...
  Modelica.Blocks.Interfaces.RealInput V_S2 "PSS input signal 2"
                                                      annotation(Placement(transformation(extent={{-186,
            -26},{-174,-14}})));
...
equation
  ...
  connect(derivativeLag2.y, derivativeLag3.u) annotation (Line(points={{-111,
          -20},{-106.5,-20},{-102,-20}}, color={0,0,127}));
  connect(limiter2.y, derivativeLag2.u) annotation (Line(points={{-145,-20},{
          -139.5,-20},{-134,-20}}, color={0,0,127}));
  connect(limiter1.y, derivativeLag.u)
    annotation (Line(points={{-143,20},{-134,20}}, color={0,0,127}));
  connect(derivativeLag.y, derivativeLag1.u) annotation (Line(points={{-111,20},
          {-106.5,20},{-102,20}}, color={0,0,127}));
  connect(derivativeLag1.y, SimpleLag1.u)
    annotation (Line(points={{-79,20},{-74.5,20},{-70,20}}, color={0,0,127}));
  connect(derivativeLag3.y, SimpleLag2.u) annotation (Line(points={{-79,-20},{
          -74.5,-20},{-70,-20}}, color={0,0,127}));
  connect(SimpleLag1.y, add.u1)
    annotation (Line(points={{-47,20},{-38,20}}, color={0,0,127}));
  connect(SimpleLag2.y, add.u2) annotation (Line(points={{-47,-20},{-44,-20},{
          -44,8},{-38,8}}, color={0,0,127}));
  connect(add1.u2, add.u2) annotation (Line(points={{-2,-6},{-10,-6},{-10,-20},
          {-44,-20},{-44,8},{-38,8}}, color={0,0,127}));
  connect(add.y, add1.u1) annotation (Line(points={{-15,14},{-10,14},{-10,6},{
          -2,6}}, color={0,0,127}));
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false,  extent={{-180,
            -40},{180,40}})),                                                                                      Icon(coordinateSystem(preserveAspectRatio=false,   extent={{-180,
            -40},{180,40}}),                                                                                                    graphics={  Rectangle(extent={{
              -180,40},{180,-40}},                                                                                                    lineColor=  {0, 0, 255}), Text(extent={{
              -34,14},{32,-16}},                                                                                                    lineColor=  {0, 0, 255}, textString=  "PSS2B"), Text(extent={{
              -172,26},{-132,12}},                                                                                                   lineColor=
              {0,0,255},
          textString="V_S1"),                                                                                                    Text(extent={{
              130,14},{176,-16}},                                                                                                   lineColor=
              {0,0,255},
          textString="VOTHSG"),                                                                                                    Text(extent={{
              -174,-14},{-134,-28}},                                                                                                 lineColor=
              {0,0,255},
          textString="V_S2")}),

...
model PSS2A "IEEE Dual-Input Stabilizer Model"
  ...
  iPSL.NonElectrical.Continuous.SimpleLag SimpleLag1(K = 1, T = T_6, y_start = 0) annotation(Placement(transformation(extent = {{-80, 10}, {-60, 30}})));
  iPSL.NonElectrical.Continuous.SimpleLag SimpleLag2(K = K_S2, T = T_7, y_start = 0) annotation(Placement(transformation(extent = {{-80, -30}, {-60, -10}})));
  Modelica.Blocks.Continuous.Derivative Washout1(k = T_w1, T = T_w1, y_start = 0) annotation(Placement(transformation(extent = {{-160, 10}, {-140, 30}})));
  Modelica.Blocks.Continuous.Derivative Washout2(k = T_w2, T = T_w2, y_start = 0) annotation(Placement(transformation(extent = {{-120, 10}, {-100, 30}})));
  Modelica.Blocks.Continuous.Derivative Washout3(k = T_w3, T = T_w3, y_start = 0) annotation(Placement(transformation(extent = {{-160, -30}, {-140, -10}})));
  Modelica.Blocks.Continuous.Derivative Washout4(k = T_w4, T = T_w4, y_start = 0) annotation(Placement(transformation(extent = {{-120, -30}, {-100, -10}})));
...
equation
  connect(V_S1, Washout1.u) annotation(Line(points = {{-180, 20}, {-180, 20}, {-162, 20}}, color = {0, 0, 127}));
  connect(Washout1.y, Washout2.u) annotation(Line(points = {{-139, 20}, {-122, 20}}, color = {0, 0, 127}));
  connect(SimpleLag1.u, Washout2.y) annotation(Line(points = {{-82, 20}, {-99, 20}}, color = {0, 0, 127}));
  connect(V_S2, Washout3.u) annotation(Line(points = {{-180, -20}, {-180, -20}, {-162, -20}}, color = {0, 0, 127}));
  connect(Washout3.y, Washout4.u) annotation(Line(points = {{-139, -20}, {-130, -20}, {-122, -20}}, color = {0, 0, 127}));
  connect(Washout4.y, SimpleLag2.u) annotation(Line(points = {{-99, -20}, {-82, -20}}, color = {0, 0, 127}));

...
model TGtypeII "TG Type II"
  ...
  Modelica.Blocks.Interfaces.RealInput pm0 "Initial mechanical power (pu)"
                                           annotation(Placement(visible = true, transformation(origin = {5.0, 75.0}, extent = {{-20.0, -20.0}, {20.0, 20.0}}, rotation = -90), iconTransformation(origin = {0.0, 120.0}, extent = {{-20.0, -20.0}, {20.0, 20.0}}, rotation = -90)));
  Modelica.Blocks.Interfaces.RealOutput pm "Mechanical power (pu)"
                                           annotation(Placement(visible = true, transformation(origin = {127.8147, -10.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0), iconTransformation(origin = {110.0, -0.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput W "Rotor speed (pu)"
                                         annotation(Placement(visible = true, transformation(origin = {-86.6223, -82.7085}, extent = {{-20.0, -20.0}, {20.0, 20.0}}, rotation = -270), iconTransformation(origin = {-120.0, -0.0}, extent = {{-20.0, -20.0}, {20.0, 20.0}}, rotation = 0)));
...
equation
  ...
  annotation(Icon(coordinateSystem(extent = {{-100.0, -100.0}, {100.0, 100.0}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics={  Rectangle(visible=  true, fillColor=  {255, 255, 255}, extent=  {{-100.0, -100.0}, {100.0, 100.0}}), Text(visible=  true, origin=  {0.0, 2.0143},
            fillPattern=                                                                                                    FillPattern.Solid, extent=  {{-35.7561, -17.9857}, {35.7561, 17.9857}}, textString=  "TGtype2", fontName=  "Arial"), Text(visible=  true, origin=  {0.0, 84.3902},
            fillPattern=                                                                                                    FillPattern.Solid, extent=  {{-21.9862, -7.9881}, {21.9862, 7.9881}}, textString=  "pm0", fontName=  "Arial"), Text(visible=  true, origin=  {-80.0, -2.4321},
            fillPattern=                                                                                                    FillPattern.Solid, extent=  {{-11.4068, -12.4321}, {11.4068, 12.4321}}, textString=  "W", fontName=  "Arial"), Text(visible=  true, origin=  {80.0, 1.5812},
            fillPattern=                                                                                                    FillPattern.Solid, extent=  {{-16.0104, -8.4188}, {16.0104, 8.4188}}, textString=  "pm", fontName=  "Arial")}), Diagram(coordinateSystem(extent={{-148.5,

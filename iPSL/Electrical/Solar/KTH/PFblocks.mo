...
<p><span style=\"font-family: MS Shell Dlg 2;\">You should have received a copy of the GNU Lesser General Public License along with the iPSL. If not, see &LT;http://www.gnu.org/licenses/&GT;.</span></p>
  ...
  model MPPT
    ...
    Modelica.Blocks.Math.Add add2(k2=-1) annotation (Placement(visible=true,
          ...
          extent={{-10.0,-10.0},{10.0,10.0}},
          rotation=0)));
    iPSL.Electrical.Solar.KTH.Auxiliary.InputSelectorEpsilon
  ...
  equation
    ...
    connect(add1.y, inputSelectorEpsilon1.dv) annotation (Line(
        ...
        points={{-23.4337,22.3106},{-6.8495,22.3106},{-6.8495,-14.5932},{
            18.5663,-14.5932},{18.5663,-15.4347}},
        color={0,0,127}));
...
<p><span style=\"font-family: MS Shell Dlg 2;\">You should have received a copy of the GNU Lesser General Public License along with the iPSL. If not, see &LT;http://www.gnu.org/licenses/&GT;.</span></p>
  ...
  equation
    ...
    connect(Ipv, add1.u1) annotation (Line(
        ...
        points={{-78.0721,30.5362},{25.0241,30.5362},{25.0241,-30.5361},{
            28.0241,-30.5361}},
        color={0,0,127}));
  ...
  model Controller
    ...
    Modelica.Blocks.Nonlinear.Limiter limiter1(uMax=id_max, uMin=id_min)
      annotation (Placement(visible=true, transformation(
          ...
          extent={{-10.0,-10.0},{10.0,10.0}},
          rotation=0)));
    Modelica.Blocks.Math.Gain gain1(k=1/ibase) annotation (Placement(visible=
            true, transformation(
          origin={16.5869,-65.0},
          extent={{-10.0,-10.0},{10.0,10.0}},
          rotation=0)));

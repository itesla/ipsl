...
model WT1G1_oneMass_nosaturation
  ...
  iPSL.Electrical.Wind.PSSE.WT1G.IIIorderWind iIIorderWind(X = X, Xp = Xp, T = T, p0 = p0, q0 = q0, S0 = s0, v0 = eterm, anglev0 = anglev0, CoB = CoB) annotation(Placement(transformation(extent = {{-56, 6}, {-36, 26}})));
...
equation
  connect(iIIorderWind.p, pwPin) annotation(Line(points = {{-37.6, 16}, {28, 16}, {28, 2}, {94, 2}}, color = {0, 0, 255}, smooth = Smooth.None));
  connect(shunt1_1.p, pwPin) annotation(Line(points = {{11.6, -26.4}, {11.6, 2}, {94, 2}}, color = {0, 0, 255}, smooth = Smooth.None));

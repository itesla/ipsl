...
//0.4 pu. For voltages between 0.8 pu and 0.4 pu to reduce the active power is linear according to equation
  ...
  Modelica.Blocks.Interfaces.RealOutput Ip_LVACL
    annotation (Placement(transformation(extent={{54,-8},{72,10}}),
        iconTransformation(extent={{54,-8},{72,10}})));
...
elseif Vt>0.8 then
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,
            -100},{100,100}}), graphics={                   Rectangle(extent={{-26,
              18},{20,-22}}, lineColor={0,0,255})}), Icon(coordinateSystem(
          preserveAspectRatio=true, extent={{-100,-100},{100,100}}), graphics={
          Rectangle(extent={{-58,46},{56,-54}}, lineColor={0,0,255}), Text(
          extent={{-42,60},{46,0}},
          lineColor={0,0,255},
          textString="LVACL"),
        Line(

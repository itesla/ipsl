...
model WT3E1
  ...
  Modelica.Blocks.Interfaces.RealInput Pelec annotation (Placement(
        transformation(extent={{-120,-76},{-90,-46}}), iconTransformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={138,-92})));
  ...
  Modelica.Blocks.Interfaces.RealInput Vterm(start=v0) annotation (Placement(
        transformation(extent={{-122,-112},{-88,-78}}), iconTransformation(
        extent={{-12,-12},{12,12}},
        rotation=180,
        origin={136,-16})));
  ...
  Modelica.Blocks.Interfaces.RealOutput WIPCMD annotation (Placement(
        transformation(extent={{176,2},{194,20}}), iconTransformation(extent={{
            148,40},{166,58}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput WEQCMD annotation (Placement(
        transformation(extent={{176,32},{194,50}}), iconTransformation(extent={
            {148,64},{166,82}})));
  Modelica.Blocks.Interfaces.RealOutput WNDSP1 annotation (Placement(
        transformation(extent={{20,-126},{38,-108}}), iconTransformation(
        extent={{-9,-9},{9,9}},
        rotation=270,
        origin={-47,-113})));
  Modelica.Blocks.Interfaces.RealOutput WPCMND annotation (Placement(
        transformation(extent={{144,-104},{162,-86}}), iconTransformation(
        extent={{-9,-9},{9,9}},
        rotation=270,
        origin={15,-113})));
  ...
  Modelica.Blocks.Math.Gain XC(k=Xc) "Line drop compensation reactance (pu)"
    annotation (Placement(transformation(extent={{-178,74},{-166,86}})));
  Modelica.Blocks.Math.Add add3(k2=-1)
    annotation (Placement(transformation(extent={{-110,82},{-100,92}})));
  ...
  Modelica.Blocks.Math.Add add5(k2=-1)
    annotation (Placement(transformation(extent={{-154,78},{-144,88}})));
  ...
  Modelica.Blocks.Interfaces.RealInput WEQCMD0 annotation (Placement(
        transformation(extent={{-218,-84},{-184,-50}}), iconTransformation(
        extent={{-12,-12},{12,12}},
        rotation=270,
        origin={90,78})));
  Modelica.Blocks.Interfaces.RealInput WIPCMD0 annotation (Placement(
        transformation(extent={{-216,-52},{-184,-20}}), iconTransformation(
        extent={{-12,-12},{12,12}},
        rotation=270,
        origin={54,78})));
...
protected
  ...
  Modelica.Blocks.Interfaces.RealInput ShaftSpeed=sp0 annotation (Placement(
        transformation(extent={{-122,-50},{-88,-16}}), iconTransformation(
        extent={{-12,-12},{12,12}},
        rotation=90,
        origin={80,-92})));
initial equation
...
equation
  ...
  connect(imLimited.y, K2.u) annotation (Line(points={{86.5,-55},{88.25,-55},{
          91,-55}}, color={0,0,127}));
  connect(K2.y, division.u1) annotation (Line(points={{102.5,-55},{114,-55},{
          114,-56},{117,-56}}, color={0,0,127}));
  connect(feedback.u2, division.u1) annotation (Line(points={{65,-60.6},{65,-72},
          {106,-72},{106,-56},{114,-56},{114,-56},{117,-56}}, color={0,0,127}));
  connect(WPCMND, division.u1) annotation (Line(points={{153,-95},{124,-95},{
          124,-72},{106,-72},{106,-56},{117,-56}}, color={0,0,127}));
  connect(Vcl.u2, Vterm) annotation (Line(points={{83,37.4},{83,-32},{62,-32},{
          62,-95},{-105,-95}}, color={0,0,127}));
  connect(division.y, imLimited_max.u) annotation (Line(points={{128.5,-59},{
          133.25,-59},{139,-59}}, color={0,0,127}));
  ...
  connect(add1.y, Qcmdn2.u2) annotation (Line(points={{38.5,-57},{40.25,-57},{
          40.25,-58},{43,-58}}, color={0,0,127}));
  ...
  connect(K4.y, add3.u2) annotation (Line(points={{-121.5,83},{-118,83},{-118,
          84},{-111,84}}, color={0,0,127}));
  ...
  connect(K1.y, add4.u1) annotation (Line(points={{-57.6,100},{-56,100},{-56,
          91.2},{-54.4,91.2}}, color={0,0,127}));
  connect(K10.y, K1.u) annotation (Line(points={{-69.6,100},{-66.8,100},{-66.8,
          100}}, color={0,0,127}));
  ...
  connect(Qord1.y, K.u) annotation (Line(points={{-37.6,90},{-34,90},{-30.8,90}},
        color={0,0,127}));
  connect(feedback1.y, K6.u) annotation (Line(points={{57.3,43},{58.65,43},{
          58.65,43},{61,43}}, color={0,0,127}));
  connect(K6.y, Vcl.u1) annotation (Line(points={{72.5,43},{74.25,43},{74.25,43},
          {77.4,43}}, color={0,0,127}));
  connect(Qord.y, feedback1.u1) annotation (Line(points={{40.7,43},{43.35,43},{
          43.35,43},{45.4,43}}, color={0,0,127}));
  annotation (
    choices(
...
"),Rectangle(
          ...
          points={{-86,-54},{-86,-74},{-58,-74},{-60,-72},{-60,-76},{-58,-74},{
            -58,-74}},
          color={0,0,255},
          smooth=Smooth.None,
          thickness=0.5),Line(
...
",        textStyle={TextStyle.Bold}),Line(
          ...
          thickness=0.5,
          smooth=Smooth.None)}),
    Icon(coordinateSystem(extent={{-200,-140},{180,140}}, preserveAspectRatio=
            true), graphics={Rectangle(extent={{-96,90},{148,-104}}, lineColor=
          {0,0,255}),Text(
          extent={{-74,68},{106,-76}},
          lineColor={0,0,255},

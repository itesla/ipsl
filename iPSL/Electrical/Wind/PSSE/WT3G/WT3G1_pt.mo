...
protected
  ...
  Modelica.Blocks.Interfaces.RealOutput Ix(start=Ix0)
    annotation (Placement(transformation(extent={{40,30},{58,48}})));
  Modelica.Blocks.Interfaces.RealInput Eqcmd=Eqcmd0 annotation (Placement(
...
equation
  ...
  connect(Eqcmd, imSimpleLag.u) annotation (Line(points={{-101,73},{-65.5,73},{
          -65.5,73},{-31.8,73}}, color={0,0,127}));
  connect(imSimpleLag1.u, Ipcmd) annotation (Line(points={{-31.8,39},{-60.9,39},
          {-60.9,39},{-101,39}}, color={0,0,127}));
  connect(imSimpleLag1.y, Ix) annotation (Line(points={{-11.1,39},{16.45,39},{
          16.45,39},{49,39}}, color={0,0,127}));
  ...
  connect(imLimited.y, imIntegrator.u) annotation (Line(points={{26.5,-15},{
          28.25,-15},{28.25,-15},{31,-15}}, color={0,0,127}));
  ...
  annotation (
    ...
    Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{100,
            100}}), graphics={Rectangle(extent={{-100,56},{108,-32}}, lineColor
          ={0,0,255}),Text(
          extent={{-44,24},{40,-14}},
          lineColor={0,0,255},
          textString="WT3G1")}),

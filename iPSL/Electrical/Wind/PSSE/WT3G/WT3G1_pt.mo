...
model WT3G1_pt
  ...
  iPSL.Connectors.PwPin p(vr(start = vr0), vi(start = vi0), ir(start = ir1), ii(start = ii1)) annotation(Placement(transformation(extent = {{58, 6}, {78, 26}}), iconTransformation(extent = {{58, 6}, {78, 26}})));
  Modelica.Blocks.Continuous.Integrator imIntegrator(k = wbase, y_start = anglev_rad, initType = Modelica.Blocks.Types.Init.InitialOutput) annotation(Placement(transformation(extent = {{32, -20}, {42, -10}})));
  Modelica.Blocks.Continuous.LimIntegrator imIntegrator1(outMin = -Pllmax, outMax = Pllmax, k = 0, y_start = 0, initType = Modelica.Blocks.Types.Init.InitialOutput) annotation(Placement(transformation(extent = {{-30, -12}, {-16, 2}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput eqcmd0 = Eqcmd0 annotation(Placement(transformation(extent = {{18, -70}, {36, -52}}), iconTransformation(extent = {{-9, -9}, {9, 9}}, rotation = 90, origin = {-59, 65})));
  Modelica.Blocks.Interfaces.RealOutput ipcmd0 = Ipcmd0 annotation(Placement(transformation(extent = {{18, -94}, {36, -76}}), iconTransformation(extent = {{-9, -9}, {9, 9}}, rotation = 90, origin = {-29, 65})));
protected
...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}})), Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics={  Rectangle(extent=  {{-100, 56}, {108, -32}}, lineColor=  {0, 0, 255}), Text(extent=  {{-44, 24}, {40, -14}}, lineColor=  {0, 0, 255}, textString=  "WT3G1")}), Documentation(info = "<html>

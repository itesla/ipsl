...
model GE_WT
  ...
  Generator.Generator generator1(freq = freq, ge_x0_0 = ge_x0_0, ge_x1_0 = ge_x1_0, ge_x2_0 = ge_x2_0, GEN_base = GEN_base, Kpllp = Kpllp, Lpp = Lpp, SYS_base = SYS_base) annotation(Placement(visible = true, transformation(origin = {45.0, 60.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
protected
  function cp_init
    input Real lambda;
    input Real theta;
  ...
  protected
    ...
    Real[5, 1] theta_vec;
    Real[5, 1] prod;
    parameter Real[5, 5] coeff = [-0.41909, 0.21808, -0.012406, -0.00013365, 0.000011524; -0.067606, 0.060405, -0.013934, 0.0010683, -0.000023895; 0.015727, -0.010996, 0.0021495, -0.00014855, 0.0000027937; -0.00086018, 0.00057051, -0.00010479, 0.0000059924, -0.000000089194; 0.000014788, -0.0000094839, 0.0000016167, -0.000000071535, 0.00000000049686];
  algorithm
...
initial algorithm
  ...
  theta := pimin;
  lambda := get_Vw(pimin, Kl, wndtge_kp, genbc_k_speed, pmech);
  lambda := lambda + 0.01;
  ...
  if pmech >= 1.0 and wndtge_spdw1 > Vw then
    ...
    theta := get_theta(lambda, Vw, Kl, wndtge_kp, genbc_k_speed, pmech, pimin, pimax);
    cp := cp_init(lambda, theta);
    Vw := Kl * genbc_k_speed / lambda;
  end if;
...
equation
  ...
  connect(electrical_Control1.Efd, generator1.Efd) annotation(Line(visible = true, origin = {24.7437, 56.5275}, points = {{-26.7437, 2.18767}, {7.2437, 2.18767}, {7.2437, -2.18767}, {12.2563, -2.18767}}, color = {0, 0, 127}));
  connect(generator1.Qgen, electrical_Control1.Qgen) annotation(Line(visible = true, origin = {26.605, 49.271}, points = {{26.395, 4.729}, {31.4075, 4.729}, {31.4075, -4.8235}, {-44.605, -4.8235}, {-44.605, 0.189}}, color = {0, 0, 127}));
  ...
  annotation(Icon(coordinateSystem(extent = {{-100.0, -100.0}, {100.0, 100.0}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Ellipse(visible = true, fillColor = {255, 255, 255}, extent = {{-100.0, -100.0}, {100.0, 100.0}}), Text(visible = true, origin = {0.0, 16.6286}, fillPattern = FillPattern.Solid, extent = {{-44.8085, -23.3714}, {44.8085, 23.3714}}, textString = "DFIG", fontName = "Arial"), Text(visible = true, origin = {0.0, -17.9447}, fillPattern = FillPattern.Solid, extent = {{-25.6048, -15.9106}, {25.6048, 15.9106}}, textString = "GE", fontName = "Arial")}), Diagram(coordinateSystem(extent = {{-148.5, -105.0}, {148.5, 105.0}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})), Documentation(info = "<html>

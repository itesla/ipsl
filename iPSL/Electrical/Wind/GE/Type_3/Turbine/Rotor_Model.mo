...
model Rotor_Model
  Modelica.Blocks.Interfaces.RealInput Pm "Mechanical Power Input" annotation (Placement(
      transformation(
      ...
      iconTransformation(
        ...
        extent={{-102.0,54.0},{-62.0,94.0}},
        rotation=0)));
  Modelica.Blocks.Interfaces.RealInput Pe "Electrical Power Input" annotation (Placement(
      transformation(
        extent={{-102.0,54.0},{-62.0,94.0}},
...
protected
  ...
  Modelica.Blocks.Math.Add3 add31 annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Division division1 annotation (Placement(visible=true, transformation(
        origin={-105.0,51.7929},
        extent={{-10.0,10.0},{10.0,-10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Division division2 annotation (Placement(visible=true, transformation(
  ...
  Modelica.Blocks.Math.Add3 add32(
    ...
    k3=-1) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain i2H(k=1/(2*H)) annotation (Placement(visible=true, transformation(
        origin={-51.5025,51.5804},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain Gain_i2Hg(k=1/(2*Hg)) annotation (Placement(visible=true, transformation(
        origin={-52.0335,-38.3327},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain Gain1_wbase(k=wbase) annotation (Placement(visible=true, transformation(
        origin={7.1416,51.7326},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain Gain_wbase(k=wbase) annotation (Placement(visible=true, transformation(
  ...
  Modelica.Blocks.Math.Add add1(k1=-1) annotation (Placement(visible=true, transformation(
        ...
        extent={{10.0,-10.0},{-10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain Gain_Dtg(k=Dtg) annotation (Placement(visible=true, transformation(
        origin={-60.0,7.5203},
        extent={{10.0,-10.0},{-10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Add add2(k1=-1) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain Gain_Ktg(k=Ktg) annotation (Placement(visible=true, transformation(
  ...
  Modelica.Blocks.Sources.Constant Const1_wndtge_spd0(k=wndtge_spd0)
    annotation (Placement(visible=true, transformation(
        ...
        extent={{10.0,-10.0},{-10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Sources.Constant Const_wndtge_spd0(k=wndtge_spd0)
    annotation (Placement(visible=true, transformation(
        origin={15.0,90.0},
        extent={{10.0,-10.0},{-10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Sources.Constant Const_wndtge_ang0(k=wndtge_ang0)
    annotation (Placement(visible=true, transformation(
        origin={25.0,-2.4551},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
equation
  ...
  connect(Gain_Ktg.y, add31.u1) annotation (Line(
      ...
      points={{111.7182,-36.5345},{114.7181,-36.5345},{114.7181,23.4655},{-114.7364,23.4655},{-114.7364,13.069},{-111.6816,13.069}},
      color={0,0,127}));
  connect(Gain_Ktg.y, add32.u3) annotation (Line(
      visible=true,
      origin={22.2231,-34.3404},
      points={{111.2264,44.3404},{114.2264,44.3404},{114.2264,-32.4736},{-115.2281,-32.4736},{-115.2281,-11.8667},{-109.2231,-11.8667}},
      color={0,0,127}));
  ...
  connect(add32.y, Gain_i2Hg.u) annotation (Line(
      ...
      color={0,0,127}));
  connect(Gain_i2Hg.y, integrator2.u)
    annotation (Line(
      visible=true,
  ...
  connect(Gain_Dtg.y, add32.u1) annotation (Line(
      ...
      color={0,0,127}));
  connect(Gain_Dtg.y, add31.u3)
    annotation (Line(
      visible=true,
      origin={-80.1801,15.7288},
      points={{9.1801,-8.2085},{5.1801,-8.2085},{5.1801,-5.7288},{-9.7702,-5.7288},{-9.7702,27.8747}},
      color={0,0,127}));
  ...
  connect(integrator2.y, add4.u1) annotation (Line(
      ...
      color={0,0,127}));
  connect(add5.u2, integrator1.y)
    annotation (Line(
      visible=true,
      origin={-12.3235,62.8575},
      points={{-0.6765,11.1425},{2.3235,11.1425},{2.3235,-11.1425},{-3.9703,-11.1425}},
      color={0,0,127}));
  connect(add1.u1, integrator1.y)
    annotation (Line(
      visible=true,
      origin={-15.2204,32.8832},
      points={{-2.7796,-18.8319},{1.9265,-18.8319},{1.9265,18.8318},{-1.0734,18.8318}},
      color={0,0,127}));
  ...
  connect(add3.y, add2.u2) annotation (Line(
      ...
      points={{-2.2026,-12.3375},{0.7973,-12.3375},{0.7973,0.675},{-0.7973,0.675},{-0.7973,11.6625},{2.2027,11.6625}},
      color={0,0,127}));
  connect(integrator3.y, add2.u1) annotation (Line(
      ...
      color={0,0,127}));
  connect(division2.u2, add4.y)
    annotation (Line(
      visible=true,
      origin={-98.25,-61.9699},
      points={{-18.75,18.0301},{-21.75,18.0301},{-21.75,-18.0301},{62.25,-18.0301}},
      color={0,0,127}));
  connect(division1.u2, add5.y)
    annotation (Line(
      visible=true,
      origin={-98.25,68.8965},
      points={{-18.75,-11.1036},{-21.75,-11.1036},{-21.75,11.1035},{62.25,11.1035}},
      color={0,0,127}));

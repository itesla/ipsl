...
model Turbine_Model
  ...
  Modelica.Blocks.Interfaces.RealInput Pelec "Electrical power" annotation (Placement(
      transformation(
      ...
      iconTransformation(
        ...
        extent={{-102.0,54.0},{-62.0,94.0}},
        rotation=0)));
  Modelica.Blocks.Interfaces.RealInput Wind_Speed "Wind speed" annotation (Placement(
      transformation(
        extent={{-102.0,54.0},{-62.0,94.0}},
        origin={-88.0,-29.0},
        rotation=0),
  ...
  Rotor_Model rotor_Model1(
    ...
    wndtge_spd0=wndtge_spd0) annotation (Placement(visible=true, transformation(
        ...
        rotation=0)));
  Wind_Power_Model wind_Power_Model1(KI=KI, wndtge_kp=wndtge_kp)
...
protected
  ...
  Modelica.Blocks.Math.Gain Change_Base(k=GEN_base/WT_base)
    annotation (Placement(visible=true, transformation(
        origin={-130.0,85.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  ...
  Modelica.Blocks.Math.Add add2(k1=-1) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain Gain_Kpp(k=Kpp) annotation (Placement(visible=true, transformation(
  ...
  Modelica.Blocks.Continuous.Integrator integrator3(k=Kic, y_start=wt_x3_0)
    annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Add add3 annotation (Placement(visible=true, transformation(
        origin={-7.225,-25.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain Gain_Kpc(k=Kpc) annotation (Placement(visible=true, transformation(
        origin={-35.0,1.579},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Add add4(k1=-1) annotation (Placement(visible=true, transformation(
        origin={-105.0,-11.8301},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Add add5(k2=-1) annotation (Placement(visible=true, transformation(
        origin={52.373,60.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain Gain_iTP(k=1/Tp) annotation (Placement(visible=true, transformation(
        origin={80.0,60.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax=pirat) annotation (Placement(visible=true, transformation(
  ...
  Modelica.Blocks.Continuous.LimIntegrator limIntegrator1(
    ...
    outMax=pimax,
    outMin=pimin,
    initType=Modelica.Blocks.Types.Init.InitialOutput) annotation (Placement(visible=true, transformation(
        origin={135.0,60.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain Gain_Kptrq(k=Kptrq) annotation (Placement(visible=true, transformation(
        origin={-35.0,-75.421},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Add add6 annotation (Placement(visible=true, transformation(
        origin={-7.225,-82.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  ...
  Modelica.Blocks.Continuous.LimIntegrator limIntegrator2(
    ...
    y_start=wt_x4_0) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Nonlinear.Limiter limiter2(uMax=pwrat)
    annotation (Placement(visible=true, transformation(
        origin={111.3449,-76.2002},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain Gain_iTPc(k=1/Tpc) annotation (Placement(visible=true, transformation(
        origin={84.1753,-76.2002},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Add add8(k2=-1) annotation (Placement(visible=true, transformation(
        origin={56.5483,-76.2002},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain Change_Base1(k=WT_base/GEN_base)
    annotation (Placement(visible=true, transformation(
        origin={175.0,-1.9789},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Sources.Constant const(k=1) annotation (Placement(visible=true, transformation(
        origin={-147.5253,-5.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
equation
  ...
  connect(add1.u2, integrator1.y) annotation (Line(
      ...
      points={{-24.1654,-1.9958},{-25.1654,-1.9958},{-25.1654,-7.0083},{25.1654,-7.0083},{25.1654,9.0042},{24.1655,9.0042}},
      color={0,0,127}));
  ...
  connect(add4.u2, limIntegrator2.y) annotation (Line(
      ...
      points={{-133.588,31.8467},{-136.588,31.8467},{-136.588,-5.3232},{136.588,-5.3232},{136.588,-26.5234},{133.588,-26.5234}},
      color={0,0,127}));
  connect(limIntegrator2.y, Change_Base1.u)
    annotation (Line(
      visible=true,
      origin={158.2938,-39.0896},
      points={{-8.1185,-37.1106},{1.7062,-37.1106},{1.7062,37.1107},{4.7062,37.1107}},
      color={0,0,127}));
  ...
  connect(limIntegrator2.y, add8.u2) annotation (Line(
      ...
      points={{52.8135,8.6667},{55.8135,8.6667},{55.8135,-11.3333},{-55.8135,-11.3333},{-55.8135,2.6667},{-52.8135,2.6667}},
      color={0,0,127}));
  ...
  connect(add2.y, Gain_Kptrq.u) annotation (Line(
      ...
      points={{16.3485,55.2108},{17.0758,55.6318},{17.0758,22.3946},{-19.6515,22.3946},{-19.6515,-78.0264},{-6.6515,-78.4474}},
      color={0,0,127}));
  connect(rotor_Model1.omega_gen, product1.u1) annotation (Line(
      visible=true,
      origin={-41.5592,-14.7662},
      points={{-50.991,66.7762},{-26.3238,66.7762},{-26.3238,-42.1593},{51.8193,-42.1593},{51.8193,-49.2338}},
      color={0,0,127}));
  ...
  connect(wind_Power_Model1.Theta, limIntegrator1.y) annotation (Line(
      ...
      points={{-112.068,-39.4497},{-117.08,-39.4497},{-117.08,28.1499},{-91.0554,28.1499},{177.065,28.1499},{177.065,-16.8501},{174.065,-16.8501}},
      color={0,0,127}));
  ...
  connect(Gain_Kpc.y, add3.u1) annotation (Line(
      ...
      points={{-2.3875,11.268},{0.6125,11.268},{0.6125,-1.957},{-0.6125,-1.957},{-0.6125,-9.311},{2.3875,-9.311}},
      color={0,0,127}));
  ...
  connect(add2.y, Gain_Kpp.u) annotation (Line(
      ...
      color={0,0,127}));
  connect(Change_Base.y, rotor_Model1.Pe)
    annotation (Line(
      visible=true,
      origin={-111.2201,65.5087},
      points={{-7.7799,19.4913},{1.2201,19.4913},{1.2201,-12.8593},{2.6699,-12.8593},{2.6699,-13.2639}},
      color={0,0,127}));
  connect(rotor_Model1.omega_gen, add2.u2)
    annotation (Line(
      visible=true,
      origin={-64.1526,52.1236},
      points={{-28.3976,-0.1136},{14.1526,-0.1136},{14.1526,0.1136},{17.1526,0.1136}},
      color={0,0,127}));
  connect(wind_Power_Model1.Pm, rotor_Model1.Pm)
    annotation (Line(
      visible=true,
      origin={-114.9521,38.2345},
      points={{-9.1806,-0.31293},{1.3894,-0.31293},{1.3894,0.31291},{6.4019,0.31291}},
      color={0,0,127}));
  connect(rotor_Model1.omega_turb, wind_Power_Model1.omega) annotation (Line(
      visible=true,
      origin={-116.3415,31.1587},
      points={{23.7913,7.24754},{28.8037,7.24754},{28.8037,-6.5139},{-28.8037,-6.5139},{-28.8037,-0.73366},{-23.7912,-0.73366}},
      color={0,0,127}));

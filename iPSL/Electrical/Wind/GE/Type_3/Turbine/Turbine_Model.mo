...
protected
  ...
  Modelica.Blocks.Math.Gain Change_Base(k = GEN_base / WT_base) annotation(Placement(visible = true, transformation(origin = {-130.0, 85.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Add add1(k2 = -1) annotation(Placement(visible = true, transformation(origin = {-92.0602, 80.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Continuous.Integrator integrator1(k = 1 / 5, y_start = wt_x5_0) annotation(Placement(visible = true, transformation(origin = {-66.7293, 85.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Add add2(k1 = -1) annotation(Placement(visible = true, transformation(origin = {-35.0, 58.2372}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Gain Gain_Kpp(k = Kpp) annotation(Placement(visible = true, transformation(origin = {-6.8708, 73.0513}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Continuous.Integrator integrator2(k = Kip, y_start = wt_x1_0) annotation(Placement(visible = true, transformation(origin = {-1.8708, 43.0036}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Add3 add31 annotation(Placement(visible = true, transformation(origin = {23.3965, 65.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Continuous.Integrator integrator3(k = Kic, y_start = wt_x3_0) annotation(Placement(visible = true, transformation(origin = {-35.0, -32.7609}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Add add3 annotation(Placement(visible = true, transformation(origin = {-7.225, -25.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Gain Gain_Kpc(k = Kpc) annotation(Placement(visible = true, transformation(origin = {-35.0, 1.579}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Add add4(k1 = -1) annotation(Placement(visible = true, transformation(origin = {-105.0, -11.8301}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Add add5(k2 = -1) annotation(Placement(visible = true, transformation(origin = {52.373, 60.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Gain Gain_iTP(k = 1 / Tp) annotation(Placement(visible = true, transformation(origin = {80.0, 60.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax = pirat) annotation(Placement(visible = true, transformation(origin = {107.1696, 60.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Continuous.LimIntegrator limIntegrator1(y_start = wt_x0_0, outMax = pimax, outMin = pimin, initType = Modelica.Blocks.Types.Init.InitialOutput) annotation(Placement(visible = true, transformation(origin = {135.0, 60.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Gain Gain_Kptrq(k = Kptrq) annotation(Placement(visible = true, transformation(origin = {-35.0, -75.421}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Add add6 annotation(Placement(visible = true, transformation(origin = {-7.225, -82.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Continuous.Integrator integrator4(k = Kitrq, y_start = wt_x2_0) annotation(Placement(visible = true, transformation(origin = {-35.0, -106.8211}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Product product1 annotation(Placement(visible = true, transformation(origin = {22.2601, -70.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Continuous.LimIntegrator limIntegrator2(outMax = pwmax, outMin = pwmin, y_start = wt_x4_0) annotation(Placement(visible = true, transformation(origin = {139.1753, -76.2002}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Nonlinear.Limiter limiter2(uMax = pwrat) annotation(Placement(visible = true, transformation(origin = {111.3449, -76.2002}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  Modelica.Blocks.Math.Gain Gain_iTPc(k = 1 / Tpc) annotation(Placement(visible = true, transformation(origin = {84.1753, -76.2002}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
...
equation
  ...
  connect(Gain_iTPc.y, limiter2.u) annotation(Line(visible = true, origin = {97.2601, -76.2002}, points = {{-2.0848, 0.0}, {2.0848, 0.0}}, color = {0, 0, 127}));
  connect(product1.y, add8.u1) annotation(Line(visible = true, origin = {34.2519, -67.0}, points = {{-0.9918, -3.0}, {7.2964, -3.2002}, {7.2964, -3.2002}, {10.2964, -3.2002}}, color = {0, 0, 127}));
  connect(limIntegrator2.y, add8.u2) annotation(Line(visible = true, origin = {97.3618, -84.8669}, points = {{52.8135, 8.6667}, {55.8135, 8.6667}, {55.8135, -11.3333}, {-55.8135, -11.3333}, {-55.8135, 2.6667}, {-52.8135, 2.6667}}, color = {0, 0, 127}));
  connect(limiter2.y, limIntegrator2.u) annotation(Line(visible = true, origin = {124.7601, -76.2002}, points = {{-2.4152, 0.0}, {2.4152, 0.0}}, color = {0, 0, 127}));
  connect(integrator4.y, add6.u2) annotation(Line(visible = true, origin = {-20.9188, -97.4105}, points = {{-3.0812, -9.4106}, {0.6938, -9.4106}, {0.6938, 9.4105}, {1.6938, 9.4105}}, color = {0, 0, 127}));
  connect(add31.u2, integrator2.y) annotation(Line(visible = true, origin = {10.196, 54.0018}, points = {{1.2005, 10.9982}, {-0.0668, 10.9982}, {-0.0668, -10.9982}, {-1.0668, -10.9982}}, color = {0, 0, 127}));
  connect(add3.y, add31.u3) annotation(Line(visible = true, origin = {11.1982, 16.0}, points = {{-7.4232, -41.0}, {0.4054, -41.0}, {0.4054, 41.0}, {0.1983, 41.0}}, color = {0, 0, 127}));
  connect(add2.y, Gain_Kptrq.u) annotation(Line(visible = true, origin = {-40.3485, 3.0264}, points = {{16.3485, 55.2108}, {17.0758, 55.6318}, {17.0758, 22.3946}, {-19.6515, 22.3946}, {-19.6515, -78.0264}, {-6.6515, -78.4474}}, color = {0, 0, 127}));
  ...
  connect(add31.y, add5.u1) annotation(Line(visible = true, origin = {38.3789, 65.5}, points = {{-3.9824, -0.5}, {0.9941, -0.5}, {0.9941, 0.5}, {1.9941, 0.5}}, color = {0, 0, 127}));
  connect(integrator3.y, add3.u2) annotation(Line(visible = true, origin = {-20.9188, -31.8805}, points = {{-3.0812, -0.8804}, {0.6937, -0.8804}, {0.6937, 0.8805}, {1.6938, 0.8805}}, color = {0, 0, 127}));
  connect(add4.y, Gain_Kpc.u) annotation(Line(visible = true, origin = {-60.25, -5.1256}, points = {{-33.75, -6.7045}, {10.25, -6.7045}, {10.25, 6.7046}, {13.25, 6.7046}}, color = {0, 0, 127}));
  ...
  add1.u1 = if Change_Base.y >= 0.75 then 1.2 else ((-0.67 * Change_Base.y) + 1.42) * Change_Base.y + 0.51;
  ...
  annotation(Icon(coordinateSystem(extent = {{-100.0, -100.0}, {100.0, 100.0}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Rectangle(visible = true, fillColor = {255, 255, 255}, extent = {{-100.0, -100.0}, {100.0, 100.0}}), Text(visible = true, fillPattern = FillPattern.Solid, extent = {{-44.9792, -41.316}, {44.9792, 41.316}}, textString = "Turbine", fontName = "Arial")}), Diagram(coordinateSystem(extent = {{-210.0, -148.5}, {210.0, 148.5}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})), Documentation(revisions = "<html>
<!--DISCLAIMER-->

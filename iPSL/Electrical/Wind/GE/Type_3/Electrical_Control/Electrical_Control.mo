...
model Electrical_Control
  ...
  Modelica.Blocks.Interfaces.RealInput Qord "Reactive power command" annotation (Placement(
      ...
      iconTransformation(
        ...
        extent={{-102.0,54.0},{-62.0,94.0}},
        rotation=0)));
  Modelica.Blocks.Interfaces.RealInput Pord "Active power command" annotation (Placement(
      visible=true,
      transformation(
      ...
      iconTransformation(
        ...
        extent={{-102.0,54.0},{-62.0,94.0}},
        rotation=0)));
  Modelica.Blocks.Interfaces.RealInput Vterm "Terminal voltage" annotation (Placement(
      visible=true,
      transformation(
        origin={-148.0,-174.0},
        extent={{-102.0,54.0},{-62.0,94.0}},
      ...
      iconTransformation(
        ...
        extent={{-102.0,54.0},{-62.0,94.0}},
        rotation=0)));
  Modelica.Blocks.Interfaces.RealOutput Ipcmd "Current command" annotation (Placement(
      visible=true,
      transformation(
        origin={128.0,-154.0},
        extent={{102.0,54.0},{62.0,94.0}},
      ...
      iconTransformation(
        ...
        extent={{102.0,54.0},{62.0,94.0}},
        rotation=0)));
  Modelica.Blocks.Interfaces.RealOutput Efd "Excitation voltage" annotation (Placement(
      transformation(
        extent={{102.0,54.0},{62.0,94.0}},
        origin={128.0,-2.1101},
        rotation=0),
...
protected
  Modelica.Blocks.Math.Division division1 annotation (Placement(visible=true, transformation(
        ...
        rotation=0)));
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax=1.1, uMin=-inf)
  ...
  Modelica.Blocks.Math.Add add2(k2=-1) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain gain1(k=KVi) annotation (Placement(visible=true, transformation(
...
equation
  ...
  connect(lim_exc_s11.Efd, lim_exc_s12.y) annotation (Line(
      ...
      points={{-54.4747,-11.8207},{-58.9866,-12.1987},{-58.9866,31.3162},{65.692,31.3162},{65.692,-19.1174},{44.0878,-18.7394}},
      color={0,0,127}));
  ...
  connect(add2.u2, Vterm) annotation (Line(
      ...
      points={{70.3359,105.3642},{64.818,105.3642},{64.818,-15.7201},{-32.3219,-15.7201},{-32.3219,-58.8094},{-67.6641,-58.8094},{-67.6641,-61.6695}},
      color={0,0,127}));
  connect(Pord, division1.u1)
    annotation (Line(
      visible=true,
  ...
  connect(add2.y, gain1.u) annotation (Line(
      ...
      color={0,0,127}));
  connect(limIntegrator1.y, add2.u1)
    annotation (Line(
      visible=true,
  ...
  connect(add1.y, limIntegrator1.u) annotation (Line(
      ...
      color={0,0,127}));
  connect(limiter2.y, add1.u2)
    annotation (Line(
      visible=true,
      origin={-166.7949,60.6443},
      points={{-8.3847,-13.3556},{1.7949,-13.3556},{1.7949,13.3557},{4.7949,13.3557}},
      color={0,0,127}));

...
model Generator
  ...
  Modelica.Blocks.Interfaces.RealInput Efd "Excitation voltage" annotation (Placement(
      transformation(
      ...
      iconTransformation(
        ...
        extent={{-102.0,54.0},{-62.0,94.0}},
        rotation=0)));
  Modelica.Blocks.Interfaces.RealInput Ipcmd "Current command" annotation (Placement(
      transformation(
        extent={{-102.0,54.0},{-62.0,94.0}},
      ...
      iconTransformation(
        ...
        extent={{-102.0,54.0},{-62.0,94.0}},
        rotation=0)));
  Modelica.Blocks.Interfaces.RealOutput Vt "Terminal voltage" annotation (Placement(
      visible=true,
      transformation(
        origin={68.0,-29.8146},
        extent={{102.0,54.0},{62.0,94.0}},
      ...
      iconTransformation(
        ...
        extent={{102.0,54.0},{62.0,94.0}},
        rotation=0)));
  Modelica.Blocks.Interfaces.RealOutput Pgen "Active power" annotation (Placement(
      visible=true,
      transformation(
        origin={68.0,-114.0},
        extent={{102.0,54.0},{62.0,94.0}},
      ...
      iconTransformation(
        ...
        extent={{102.0,54.0},{62.0,94.0}},
        rotation=0)));
  Modelica.Blocks.Interfaces.RealOutput Qgen "Reactive power" annotation (Placement(
      visible=true,
      transformation(
...
protected
  ...
  Modelica.Blocks.Continuous.Integrator integrator1(k=omega_0, y_start=ge_x2_0)
    annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax=0.1, uMin=-0.1)
    annotation (Placement(visible=true, transformation(
        origin={-97.7647,-70.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain gain1(k=Kpllp/omega_0) annotation (Placement(visible=true, transformation(
        origin={-125.925,-70.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Cos cos1 annotation (Placement(visible=true, transformation(
        origin={-35.4375,-56.5604},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Sin sin1 annotation (Placement(visible=true, transformation(
  ...
  Modelica.Blocks.Math.Add add1(k2=-1) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain gain2(k=1/Lpp) annotation (Placement(visible=true, transformation(
        origin={76.305,-30.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain gain3(k=1/Lpp) annotation (Placement(visible=true, transformation(
        origin={70.0,-3.3186},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  ...
  Modelica.Blocks.Math.Add add3(k2=-1) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Gain gain4(k=-1/Lpp) annotation (Placement(visible=true, transformation(
        origin={-54.097,90.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Add add4(k2=-1) annotation (Placement(visible=true, transformation(
        origin={28.575,84.2094},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Product product3 annotation (Placement(visible=true, transformation(
        origin={0.2646,65.4063},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Product product4 annotation (Placement(visible=true, transformation(
        origin={0.0,90.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Product product5 annotation (Placement(visible=true, transformation(
        origin={0.0,40.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Product product6 annotation (Placement(visible=true, transformation(
        origin={0.2646,15.4063},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Add add5 annotation (Placement(visible=true, transformation(
  ...
  Modelica.Blocks.Math.Add add6 annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Math.Add add7(k2=-1) annotation (Placement(visible=true, transformation(
        origin={100.0,2.3228},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
equation
  ...
  connect(Efd, add2.u1) annotation (Line(
      ...
      points={{-25.6157,-3.9816},{7.5385,-3.9816},{7.5385,3.9816},{10.5385,3.9816}},
      color={0,0,127}));
  connect(gain2.y, add6.u2) annotation (Line(
      ...
      color={0,0,127}));
  connect(add7.u1, add4.y)
    annotation (Line(
      visible=true,
      origin={62.1454,46.0725},
      points={{25.8546,-37.7497},{-16.096,-37.676},{-16.096,37.676},{-22.5704,38.1369}},
      color={0,0,127}));
  connect(gain3.y, add7.u2) annotation (Line(
      ...
      color={0,0,127}));
  connect(add6.u1, add5.y)
    annotation (Line(
      visible=true,
      origin={44.1804,8.1359},
      points={{49.7755,-26.0735},{-1.6054,-26.0735},{-1.6054,26.0735},{-4.6054,26.0735}},
      color={0,0,127}));
  connect(integrator3.y, product6.u1)
    annotation (Line(
      visible=true,
      origin={-52.0781,40.0},
      points={{-27.1865,16.35},{15.3823,17.4718},{15.3823,-17.4718},{40.3427,-18.5937}},
      color={0,0,127}));
  connect(integrator3.y, product4.u1)
    annotation (Line(
      visible=true,
      origin={-51.7474,76.9688},
      points={{-27.5172,-20.6188},{15.3161,-20.6188},{15.3161,19.0312},{39.7474,19.0312}},
      color={0,0,127}));
  connect(product3.u2, sin1.y)
    annotation (Line(
      visible=true,
      origin={-15.7932,-12.4948},
      points={{4.0578,71.9011},{-1.6755,70.5781},{-1.6755,-70.5781},{-8.6443,-69.2552}},
      color={0,0,127}));
  connect(product6.u2, sin1.y)
    annotation (Line(
      visible=true,
  ...
  connect(add1.y, gain1.u) annotation (Line(
      ...
      points={{83.4667,14.1611},{85.4625,14.1611},{85.4625,-22.3451},{-95.4625,-22.3451},{-95.4625,7.6549},{-92.4625,7.6549}},
      color={0,0,127}));
  connect(cos1.y, product4.u2)
    annotation (Line(
      visible=true,
      origin={-23.7531,13.9844},
      points={{-0.6844,-70.5448},{1.6094,-70.2802},{1.6094,70.2802},{11.7531,70.0156}},
      color={0,0,127}));
  connect(cos1.y, product5.u2)
    annotation (Line(
      visible=true,
      origin={-23.4885,-11.5448},
      points={{-0.949,-45.0156},{1.6094,-45.0156},{1.6094,45.5448},{11.4885,45.5448}},
      color={0,0,127}));
  ...
  connect(integrator3.y, add3.u2) annotation (Line(
      ...
      points={{26.5333,7.5882},{29.5333,7.5882},{29.5333,-8.7618},{-29.5333,-8.7618},{-29.5333,1.1736},{-26.5334,1.1736}},
      color={0,0,127}));
  connect(integrator2.y, add2.u2) annotation (Line(
      visible=true,
      origin={-108.1753,82.6179},
      points={{31.5481,7.3821},{34.5482,7.3821},{34.5482,-10.3866},{-26.4976,-10.3866},{-26.4976,2.3134},{-23.8247,2.3134},{-23.8247,1.3821}},
      color={0,0,127}));
  connect(add3.y, integrator3.u)
    annotation (Line(
      visible=true,

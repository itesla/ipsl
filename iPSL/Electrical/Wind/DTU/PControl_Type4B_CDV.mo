...
model PControl_Type4B_CDV
  ...
  PowerSystems.NonElectrical.Continuous.ImSimpleLag_varnonwindup imSimpleLag_varnonwindup(initValue = ini_Pcmd, rmin = -999, rmax = dPmax, T = Tpord) annotation(Placement(transformation(extent = {{26, -52}, {56, -24}})));
...
equation
  ...
  connect(imSetPoint.y, imSimpleLag_varnonwindup.min) annotation (Line(points={{
          24.6,-50},{32,-50},{38.75,-50},{38.75,-46.4}}, color={0,0,127}));
  connect(imSimpleLag1.y, imPin) annotation (Line(points={{72.4,-70},{80,-70},{80,
          -80},{-1,-80},{-1,-36}}, color={0,0,127}));
  connect(division.u1, imSimpleLag_varnonwindup.yo) annotation (Line(points={{20.8,
          3.6},{12,3.6},{12,-14},{60,-14},{60,-38.14},{50.9,-38.14}}, color={0,0,
          127}));
  connect(imSimpleLag1.u, imSimpleLag_varnonwindup.yo) annotation (Line(points={
          {63.2,-70},{60,-70},{60,-38.14},{50.9,-38.14}}, color={0,0,127}));
  connect(imLimiter.y, division.u2) annotation (Line(points={{2.5,41},{14,41},{14,
          -3.6},{20.8,-3.6}}, color={0,0,127}));
  ...
  connect(iPmax, product.u2) annotation (Line(points={{-56,10},{-40,10},{-40,12.8},
          {-33.4,12.8}}, color={0,0,127}));
  connect(product.y, imSimpleLag_varnonwindup.max) annotation (Line(points={{-17.3,
          17},{-4,17},{-4,-22},{45.65,-22},{45.65,-29.6}}, color={0,0,127}));
  connect(product1.y, imSimpleLag_varnonwindup.yi) annotation (Line(points={{-7.3,
          -39},{12,-39},{12,-38},{30.95,-38}}, color={0,0,127}));
  connect(w_gen, product1.u1) annotation (Line(points={{-56,-10},{-28,-10},{-28,
          -34.8},{-23.4,-34.8}}, color={0,0,127}));
  connect(imGain.y, product1.u2) annotation (Line(points={{-27.3,-43},{-25.65,
          -43},{-25.65,-43.2},{-23.4,-43.2}}, color={0,0,127}));
  connect(Pwtt_ref, imGain.u) annotation (Line(points={{-56,-32},{-48,-32},{-48,
          -43},{-43.4,-43}}, color={0,0,127}));
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-100,
            -100},{100,100}})),                                                                                     Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics={  Rectangle(extent = {{-50, 32}, {40, -32}}, lineColor = {0, 0, 255},

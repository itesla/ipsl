...
model PControl_Type4B_CDV "Active Power Control for IEC Type4B Model. Developed by DTU"
  ...
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag(K = 1, T = T_Ufilt, y_start = ini_Uwtt) annotation(Placement(transformation(extent = {{-32, 33}, {-18, 48}})));
  ...
  iPSL.NonElectrical.Continuous.SimpleLagRateLimVar imSimpleLag_varnonwindup(y_start = ini_Pcmd, rmin = -999, rmax = dPmax, T = Tpord) annotation(Placement(transformation(extent = {{30, -46}, {44, -32}})));
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag1(K = 1, y_start = ini_Pcmd, T = Tpaero) annotation(Placement(transformation(extent = {{64, -74}, {72, -66}})));
...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}})), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(extent = {{-50, 32}, {40, -32}}, lineColor = {0, 0, 255}, lineThickness = 0.5), Text(extent = {{-26, 14}, {18, -10}}, lineColor = {0, 0, 255}, lineThickness = 0.5, fillPattern = FillPattern.Solid, textString = "Type 4B
P Control"), Text(extent = {{-50, 30}, {-30, 24}}, lineColor = {0, 0, 255}, textString = "Uwtt"), Text(extent = {{-49, 13}, {-29, 7}}, lineColor = {0, 0, 255}, textString = "iPmax"), Text(extent = {{-49, -6}, {-29, -12}}, lineColor = {0, 0, 255}, textString = "w_gen"), Text(extent = {{-47, -24}, {-27, -30}}, lineColor = {0, 0, 255}, textString = "Pwtt_ref"), Text(extent = {{20, 3}, {40, -3}}, lineColor = {0, 0, 255}, textString = "iPcmd")}), Documentation(revisions = "<html>
<!--DISCLAIMER-->

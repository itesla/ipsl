  ...
  annotation (
    Diagram(coordinateSystem(extent={{-180,-100},{160,100}}, preserveAspectRatio=false), graphics={
        ...
        Text(
          extent={{16,34},{60,20}},
          lineColor={0,0,255},
          textString="Generator System Model"),
        Text(
          extent={{60,26},{92,18}},
          lineColor={0,0,255},
          textString="Current Injector"),
        Text(
          extent={{88,-12},{120,-20}},
          lineColor={0,0,255},
          textString="Measurements"),
        Text(
          extent={{-176,36},{-108,-8}},
          lineColor={0,0,255},
          textString="Wind Turbine Reference Values"),
        Text(
          extent={{102,36},{156,2}},
          lineColor={0,0,255},
          textString="Wind Turbine Terminal")}),
    Icon(coordinateSystem(extent={{-180,-100},{160,100}}, preserveAspectRatio=false), graphics={
        Rectangle(
        ...
        Bitmap(
          ...
          fileName="modelica://ToAIA_FrDTU/../Library/Turbine.jpg"),
        Text(
          extent={{-126,50},{-92,26}},
          lineColor={0,0,255},
          fillColor={0,0,255},

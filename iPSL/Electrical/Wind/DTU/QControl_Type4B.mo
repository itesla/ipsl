...
model QControl_Type4B "Developed by DTU"
  ...
  Modelica.Blocks.Sources.Constant imSetPoint1(k=MwttPF)
    annotation (Placement(transformation(extent={{-92,40},{-74,60}})));
  Modelica.Blocks.Sources.Constant imSetPoint4(k=MwttOL)
    annotation (Placement(transformation(extent={{-92,64},{-74,84}})));
  Modelica.Blocks.Sources.Constant imSetPoint3(k=Uref0)
    annotation (Placement(transformation(extent={{-92,56},{-74,76}})));
  Modelica.Blocks.Sources.Constant imSetPoint2(k=MwttU)
    annotation (Placement(transformation(extent={{-92,48},{-74,68}})));
  Modelica.Blocks.Sources.Constant imSetPoint(k=Tangent_phi)
  ...
  Modelica.Blocks.Nonlinear.Limiter imLimiter2(uMin=iqmin, uMax=iqh1)
    annotation (Placement(transformation(extent={{-4,-86},{8,-74}})));
  Modelica.Blocks.Sources.Constant imSetPoint6(k=iq_post)
    annotation (Placement(transformation(extent={{12,-74},{24,-62}})));
  Modelica.Blocks.Math.Gain imGain(k=KpQ)
    annotation (Placement(transformation(extent={{50,18},{62,30}})));
  iPSL.NonElectrical.Nonlinear.ImRelay imRelay2
    annotation (Placement(transformation(extent={{72,36},{104,68}})));
  Modelica.Blocks.Nonlinear.Limiter imLimiter3(uMin=Umin, uMax=Umax)
    annotation (Placement(transformation(extent={{100,48},{108,56}})));
  Modelica.Blocks.Sources.Constant imSetPoint8(k=0)
    annotation (Placement(transformation(extent={{137,54},{148,66}})));
  iPSL.NonElectrical.Nonlinear.ImRelay imRelay4
    annotation (Placement(transformation(extent={{154,42},{186,79}})));
  Modelica.Blocks.Math.Gain imGain1(k=KpU)
    annotation (Placement(transformation(extent={{178,36},{190,48}})));
  ...
  Modelica.Blocks.Continuous.LimIntegrator ImIntegratornonwindup(
    ...
    annotation (Placement(transformation(extent={{50,34},{60,44}})));
  Modelica.Blocks.Continuous.LimIntegrator ImIntegratornonwindup1(
    ...
    y_start=ini_Iqwtt,
    initType=Modelica.Blocks.Types.Init.InitialOutput)
    annotation (Placement(transformation(extent={{186,56},{196,66}})));
  Modelica.Blocks.Math.Add add
    annotation (Placement(transformation(extent={{68,26},{80,38}})));
  Modelica.Blocks.Math.Add add1(k2=-1)
    annotation (Placement(transformation(extent={{8,28},{18,38}})));
  Modelica.Blocks.Math.Add add2
    annotation (Placement(transformation(extent={{32,60},{44,72}})));
  Modelica.Blocks.Math.Division division
    annotation (Placement(transformation(extent={{94,0},{108,14}})));
  Modelica.Blocks.Math.Product product
    annotation (Placement(transformation(extent={{-50,-28},{-40,-18}})));
  Modelica.Blocks.Math.Add add3(k1=-1)
    annotation (Placement(transformation(extent={{116,46},{128,58}})));
  Modelica.Blocks.Math.Add add4
    annotation (Placement(transformation(extent={{202,46},{214,58}})));
initial equation
  ini_Pwtt = Pwtt;
...
equation
  ...
  connect(Pwtt, imSimpleLag.u) annotation(Line(points={{-84,-20},{-84,-19},{-71,
          -19}},                                                                     color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint1.y, imReal4in.in1) annotation(Line(points={{-73.1,50},{-60,
          50},{-60,33.74}},                                                                               color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint2.y, imReal4in.in2) annotation(Line(points={{-73.1,58},{-54.8,
          58},{-54.8,33.74}},                                                                                 color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint3.y, imReal4in.in3) annotation(Line(points={{-73.1,66},{-49.2,
          66},{-49.2,33.74}},                                                                                 color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint4.y, imReal4in.in4) annotation(Line(points={{-73.1,74},{-44,
          74},{-44,33.74}},                                                                               color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(imRelay.n1, imLimiter.u) annotation(Line(points={{-16.16,30},{-10.8,30}},      color = {0, 0, 127}, smooth = Smooth.None));
  connect(Uwtt, imSimpleLag1.u) annotation(Line(points={{-84,-40},{-84,-49},{-76.6,
          -49}},                                                                      color = {0, 0, 127}, smooth = Smooth.None));
  connect(lVRT.Uwtt, imSimpleLag1.y) annotation(Line(points={{-38.88,-53},{-46.44,
          -53},{-46.44,-49},{-69.7,-49}},                                                                                    color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSimpleLag1.u, imLimiter1.u) annotation(Line(points={{-76.6,-49},{-62,
          -49},{-62,-40},{-41.2,-40}},                                                            color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(voltageDepCurrent.Uwtt, imSimpleLag1.y) annotation(Line(points={{-40.04,
          -80},{-46,-80},{-46,-49},{-69.7,-49}},                                                                                    color = {0, 0, 127}, smooth = Smooth.None));
  connect(voltageDepCurrent.iqv, imLimiter2.u) annotation(Line(points={{-12.22,-80},
          {-5.2,-80}},                                                                                color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(imSimpleLag_nonwindup.yi, imLimiter.u) annotation(Line(points={{31.96,
          11},{-14,11},{-14,30},{-10.8,30}},                                                                                color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(imSetPoint6.y, iQLVRT1.iQpost) annotation(Line(points={{24.6,-68},{32,
          -68},{32,-74},{42.96,-74}},                                                           color = {0, 0, 127}, smooth = Smooth.None));
  connect(imLimiter2.y, iQLVRT1.iqv) annotation(Line(points={{8.6,-80},{24,-80},
          {24,-80.6},{42.96,-80.6}},                                                                                color = {0, 0, 127}, smooth = Smooth.None));
  connect(voltageDrop.Pwt, imSimpleLag.u) annotation(Line(points={{-19.6,-9.4},{
          -76,-9.4},{-76,-19},{-71,-19}},                                                                                   color = {0, 0, 127}, smooth = Smooth.None));
  connect(voltageDrop.Uwt, imLimiter1.u) annotation(Line(points={{-19.6,-24.6},{
          -34,-24.6},{-34,-32},{-42,-32},{-42,-40},{-41.2,-40}},                                                                                    color = {0, 0, 127}, smooth = Smooth.None));
  connect(imRelay1.n1, ImIntegratornonwindup.u) annotation(Line(points={{45.84,38.5},
          {48,38.5},{48,39},{49,39}},                                                                                       color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(ImIntegratornonwindup.y, add.u1) annotation (Line(points={{60.5,39},{62,
          39},{62,35.6},{66.8,35.6}}, color={0,0,127}));
  connect(imGain.y, add.u2) annotation (Line(points={{62.6,24},{66.8,24},{66.8,28.4}},
        color={0,0,127}));
  connect(add.y, imRelay2.p3) annotation (Line(points={{80.6,32},{82,32},{82,42},
          {76,42},{76,47.2},{79.84,47.2}}, color={0,0,127}));
  connect(imSetPoint5.y, imRelay1.p2) annotation (Line(points={{18.55,46.5},{22,
          46.5},{22,38.5},{29.84,38.5}}, color={0,0,127}));
  connect(add1.y, imRelay1.p3) annotation (Line(points={{18.5,33},{20,33},{20,32.95},
          {29.84,32.95}}, color={0,0,127}));
  connect(add1.u2, imLimiter.y)
    annotation (Line(points={{7,30},{-1.6,30}}, color={0,0,127}));
  connect(imGain.u, imRelay1.p3) annotation (Line(points={{48.8,24},{22,24},{22,
          32.95},{29.84,32.95}}, color={0,0,127}));
  connect(Qwtt, add1.u1)
    annotation (Line(points={{-84,40},{0,40},{0,36},{7,36}}, color={0,0,127}));
  connect(add2.y, imRelay2.p2) annotation (Line(points={{44.6,66},{76,66},{76,52},
          {79.84,52}}, color={0,0,127}));
  connect(add2.u2, imRelay.n1) annotation (Line(points={{30.8,62.4},{-16.16,62.4},
          {-16.16,30}}, color={0,0,127}));
  connect(add2.u1, imReal4in.in3) annotation (Line(points={{30.8,69.6},{-10,69.6},
          {-10,70},{-49.2,70},{-49.2,66},{-49.2,33.74}}, color={0,0,127}));
  connect(imSimpleLag_nonwindup.yo, division.u1) annotation (Line(points={{47.92,
          10.87},{69.96,10.87},{69.96,11.2},{92.6,11.2}}, color={0,0,127}));
  connect(division.y, imSimpleLag_frznonwindup.yi) annotation (Line(points={{108.7,
          7},{130,7},{130,-13},{148.6,-13}}, color={0,0,127}));
  connect(imLimiter1.y, division.u2) annotation (Line(points={{-27.4,-40},{-26,-40},
          {-26,2.8},{92.6,2.8}}, color={0,0,127}));
  connect(imSimpleLag.y, product.u1) annotation (Line(points={{-59.5,-19},{-55.75,
          -19},{-55.75,-20},{-51,-20}}, color={0,0,127}));
  connect(imSetPoint.y, product.u2) annotation (Line(points={{-63.6,-36},{-56,-36},
          {-56,-26},{-51,-26}}, color={0,0,127}));
  connect(product.y, imRelay.p2) annotation (Line(points={{-39.5,-23},{-38,-23},
          {-38,30},{-32.16,30}}, color={0,0,127}));
  connect(voltageDrop.Qwt, add1.u1) annotation (Line(points={{-19.6,-17},{-34,-17},
          {-34,12},{-74,12},{-74,40},{0,40},{0,36},{7,36}}, color={0,0,127}));
  connect(imRelay2.n1, imLimiter3.u)
    annotation (Line(points={{95.84,52},{98,52},{99.2,52}}, color={0,0,127}));
  connect(imLimiter3.y, add3.u1) annotation (Line(points={{108.4,52},{110,52},{110,
          55.6},{114.8,55.6}}, color={0,0,127}));
  connect(voltageDrop.deltaU, add3.u2) annotation (Line(points={{11.6,-17},{84,-17},
          {84,28},{112,28},{112,48.4},{114.8,48.4}}, color={0,0,127}));
  connect(imSetPoint8.y, imRelay4.p2) annotation (Line(points={{148.55,60},{161.84,
          60},{161.84,60.5}}, color={0,0,127}));
  connect(add3.y, imGain1.u) annotation (Line(points={{128.6,52},{134,52},{134,42},
          {176.8,42}}, color={0,0,127}));
  connect(imRelay4.n1, ImIntegratornonwindup1.u) annotation (Line(points={{177.84,
          60.5},{181.92,60.5},{181.92,61},{185,61}}, color={0,0,127}));
  connect(imRelay4.p3, imGain1.u) annotation (Line(points={{161.84,54.95},{156,54.95},
          {156,42},{176.8,42}}, color={0,0,127}));
  connect(ImIntegratornonwindup1.y, add4.u1) annotation (Line(points={{196.5,61},
          {200.8,61},{200.8,55.6}}, color={0,0,127}));
  connect(imGain1.y, add4.u2) annotation (Line(points={{190.6,42},{200.8,42},{200.8,
          48.4}}, color={0,0,127}));
  connect(add4.y, imRelay5.p3) annotation (Line(points={{214.6,52},{220,52},{220,
          56.2},{224.84,56.2}}, color={0,0,127}));

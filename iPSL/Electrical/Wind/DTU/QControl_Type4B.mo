...
initial equation
  ...
  ini_Qwtt = -Qwtt;
equation
  connect(imReal4in.p1, Uref) annotation(Line(points={{-58.625,27.5},{-69.75,
          27.5},{-69.75,20},{-84,20}},                                                                         color = {0, 0, 127}, smooth = Smooth.None));
  connect(imReal4in.p2, Qref) annotation(Line(points={{-58.625,22.5},{-68.75,
          22.5},{-68.75,0},{-84,0}},                                                                         color = {0, 0, 127}, smooth = Smooth.None));
  connect(Pwtt, imSimpleLag.u) annotation(Line(points = {{-84, -20}, {-84, -19}, {-71, -19}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint1.y, imReal4in.in1) annotation(Line(points={{-73.1,50},{
          -56.75,50},{-56.75,30.6875}},                                                                  color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint2.y, imReal4in.in2) annotation(Line(points={{-73.1,58},{
          -54.5,58},{-54.5,30.6875}},                                                                        color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint3.y, imReal4in.in3) annotation(Line(points={{-73.1,66},{
          -51.75,66},{-51.75,30.6875}},                                                                      color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint4.y, imReal4in.in4) annotation(Line(points={{-73.1,74},{
          -49.25,74},{-49.25,30.6875}},                                                                  color = {0, 0, 127}, smooth = Smooth.None));
  connect(imReal4in.n, imRelay.u3) annotation(Line(points={{-47.5,25},{-33,25}},      color = {0, 0, 127}, smooth = Smooth.None));
  connect(imRelay.u1, imReal4in.in1) annotation(Line(points={{-33,31},{-38,31},
          {-38,50},{-56.75,50},{-56.75,30.6875}},                                                                         color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(imRelay2.u1, imReal4in.in2) annotation(Line(points={{83,51},{-54.5,51},
          {-54.5,30.6875}},                                                                             color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(imRelay5.u1, imReal4in.in4) annotation(Line(points={{223.625,62.625},
          {208,62.625},{208,74},{-49.25,74},{-49.25,30.6875}},                                                                         color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(add2.u1, imReal4in.in3) annotation(Line(points={{30.8,69.6},{-10,69.6},
          {-10,70},{-49.2,70},{-49.2,30.6875},{-51.75,30.6875}},                                                                             color = {0, 0, 127}));

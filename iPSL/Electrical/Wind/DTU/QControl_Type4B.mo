...
model QControl_Type4B "Developed by DTU"
  iPSL.NonElectrical.Logical.Relay4 imReal4in
    annotation (Placement(transformation(extent={{-58,20},{-48,30}})));
  Modelica.Blocks.Interfaces.RealInput Uref
    annotation (Placement(transformation(extent={{-88,16},{-80,24}})));
  Modelica.Blocks.Interfaces.RealInput Qref
    annotation (Placement(transformation(extent={{-88,-4},{-80,4}})));
  Modelica.Blocks.Interfaces.RealInput Qwtt
    annotation (Placement(transformation(extent={{-88,36},{-80,44}})));
  Modelica.Blocks.Interfaces.RealInput Pwtt
    annotation (Placement(transformation(extent={{-88,-24},{-80,-16}})));
  Modelica.Blocks.Interfaces.RealInput Uwtt
    annotation (Placement(transformation(extent={{-88,-44},{-80,-36}})));
  ...
  iPSL.NonElectrical.Logical.Relay imRelay
  ...
  iPSL.NonElectrical.Logical.Relay imRelay1
  ...
  iPSL.NonElectrical.Logical.Relay imRelay2
    annotation (Placement(transformation(extent={{84,44},{92,52}})));
  ...
  iPSL.NonElectrical.Logical.Relay imRelay4
    annotation (Placement(transformation(extent={{160,56},{170,66}})));
  Modelica.Blocks.Math.Gain imGain1(k=KpU)
    annotation (Placement(transformation(extent={{178,36},{190,48}})));
  iPSL.NonElectrical.Logical.Relay imRelay5
    annotation (Placement(transformation(extent={{225,53},{236,64}})));
  Modelica.Blocks.Interfaces.RealOutput Iqcmd annotation (Placement(
        transformation(extent={{120,-24},{128,-16}}), iconTransformation(extent
          ={{120,-24},{128,-16}})));
  Modelica.Blocks.Interfaces.RealOutput F_LVRT annotation (Placement(
        transformation(extent={{120,16},{128,24}}), iconTransformation(extent={
            {120,16},{128,24}})));
  ...
  NonElectrical.Continuous.SimpleLagLim simpleLagLim(
    ...
    outMin=Qmin,
    y_start=ini_Qwtt)
    annotation (Placement(transformation(extent={{28,6},{40,18}})));
...
equation
  ...
  connect(imRelay5.u1, imReal4in.in4) annotation (Line(
      points={{223.625,62.625},{208,62.625},{208,74},{-49.25,74},{-49.25,
          30.6875}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(iQLVRT1.F_LVRT, imRelay1.u1) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(ImIntegratornonwindup.y, add.u1) annotation (Line(points={{60.5,39},{
          62,39},{62,35.6},{66.8,35.6}}, color={0,0,127}));
  connect(imGain.y, add.u2) annotation (Line(points={{62.6,24},{66.8,24},{66.8,
          28.4}}, color={0,0,127}));
  connect(add.y, imRelay2.u3) annotation (Line(points={{80.6,32},{82,32},{82,42},
          {76,42},{76,45},{83,45}}, color={0,0,127}));
  connect(imSetPoint5.y, imRelay1.u2) annotation (Line(points={{18.55,46.5},{22,
          46.5},{22,39},{28.75,39}}, color={0,0,127}));
  connect(add1.y, imRelay1.u3) annotation (Line(points={{18.5,33},{20,33},{20,
          35.25},{28.75,35.25}}, color={0,0,127}));
  connect(add1.u2, imLimiter.y)
    annotation (Line(points={{7,30},{-1.6,30}}, color={0,0,127}));
  connect(imGain.u, imRelay1.u3) annotation (Line(points={{48.8,24},{22,24},{22,
          35.25},{28.75,35.25}}, color={0,0,127}));
  connect(Qwtt, add1.u1)
    annotation (Line(points={{-84,40},{0,40},{0,36},{7,36}}, color={0,0,127}));
  connect(add2.y, imRelay2.u2) annotation (Line(points={{44.6,66},{76,66},{76,
          48},{83,48}}, color={0,0,127}));
  connect(add2.u2, imRelay.y) annotation (Line(points={{30.8,62.4},{-23.2,62.4},
          {-23.2,28}}, color={0,0,127}));
  connect(add2.u1, imReal4in.in3) annotation (Line(points={{30.8,69.6},{-10,
          69.6},{-10,70},{-49.2,70},{-49.2,30.6875},{-51.75,30.6875}}, color={0,
          0,127}));
  connect(imLimiter1.y, division.u2) annotation (Line(points={{-27.4,-40},{-26,
          -40},{-26,2.8},{92.6,2.8}}, color={0,0,127}));
  ...
  connect(product.y, imRelay.u2) annotation (Line(points={{-39.5,-23},{-38,-23},
          {-38,28},{-33,28}}, color={0,0,127}));
  connect(voltageDrop.Qwt, add1.u1) annotation (Line(points={{-19.6,-17},{-34,-17},
          {-34,12},{-74,12},{-74,40},{0,40},{0,36},{7,36}}, color={0,0,127}));
  connect(imRelay2.y, imLimiter3.u)
    annotation (Line(points={{92.8,48},{99.2,48},{99.2,52}}, color={0,0,127}));
  connect(imLimiter3.y, add3.u1) annotation (Line(points={{108.4,52},{110,52},{
          110,55.6},{114.8,55.6}}, color={0,0,127}));
  connect(voltageDrop.deltaU, add3.u2) annotation (Line(points={{11.6,-17},{84,
          -17},{84,28},{112,28},{112,48.4},{114.8,48.4}}, color={0,0,127}));
  connect(imSetPoint8.y, imRelay4.u2) annotation (Line(points={{148.55,60},{
          158.75,60},{158.75,61}}, color={0,0,127}));
  connect(add3.y, imGain1.u) annotation (Line(points={{128.6,52},{134,52},{134,
          42},{176.8,42}}, color={0,0,127}));
  connect(imRelay4.y, ImIntegratornonwindup1.u)
    annotation (Line(points={{171,61},{171,61},{185,61}}, color={0,0,127}));
  connect(imRelay4.u3, imGain1.u) annotation (Line(points={{158.75,57.25},{156,
          57.25},{156,42},{176.8,42}}, color={0,0,127}));
  connect(ImIntegratornonwindup1.y, add4.u1) annotation (Line(points={{196.5,61},
          {200.8,61},{200.8,55.6}}, color={0,0,127}));
  connect(imGain1.y, add4.u2) annotation (Line(points={{190.6,42},{200.8,42},{
          200.8,48.4}}, color={0,0,127}));
  connect(add4.y, imRelay5.u3) annotation (Line(points={{214.6,52},{220,52},{
          220,54.375},{223.625,54.375}}, color={0,0,127}));
  connect(simpleLagLim.y, division.u1) annotation (Line(points={{40.6,12},{92.6,
          12},{92.6,11.2}}, color={0,0,127}));
  connect(simpleLagLim.u, imLimiter.u) annotation (Line(points={{26.8,12},{-14,
          12},{-14,30},{-10.8,30}}, color={0,0,127}));
  connect(simpleLagLimBlock.y, imRelay5.u2) annotation (Line(points={{197,8},{
          218,8},{218,58.5},{223.625,58.5}}, color={0,0,127}));
  connect(simpleLagLimBlock.Block, imRelay1.u1) annotation (Line(points={{174,
          16},{136,16},{136,-4},{2,-4},{2,42.75},{28.75,42.75}}, color={0,0,127}));
  connect(division.y, simpleLagLimBlock.u) annotation (Line(points={{108.7,7},{
          140.35,7},{140.35,8},{174,8}}, color={0,0,127}));
  annotation (
    Icon(coordinateSystem(extent={{-100,-100},{260,80}}, preserveAspectRatio=

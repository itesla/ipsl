...
model QControl_Type4B "Developed by DTU"
  ...
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag(y_start = ini_Pwtt, K = 1, T = Tpfilt) annotation(Placement(transformation(extent = {{-70, -24}, {-60, -14}})));
  ...
  iPSL.NonElectrical.Continuous.SimpleLag imSimpleLag1(K = 1, T = Tufilt, y_start = ini_Uwtt) annotation(Placement(transformation(extent = {{-76, -52}, {-70, -46}})));
  ...
  iPSL.Electrical.Wind.DTU.VoltageDepCurrent voltageDepCurrent(Udb1 = Udb1, Udb2 = Udb2, Kqv = Kqv) annotation(Placement(transformation(extent = {{-52, -98}, {0, -62}})));
  ...
  Modelica.Blocks.Continuous.LimIntegrator ImIntegratornonwindup(outMin = Umin, outMax = Umax, k = KiQ, y_start = ini_Qpi, initType = Modelica.Blocks.Types.Init.InitialOutput) annotation(Placement(transformation(extent = {{50, 34}, {60, 44}})));
  Modelica.Blocks.Continuous.LimIntegrator ImIntegratornonwindup1(outMin = iqmin, outMax = iqmax, k = KiU, y_start = ini_Iqwtt, initType = Modelica.Blocks.Types.Init.InitialOutput) annotation(Placement(transformation(extent = {{186, 56}, {196, 66}})));
  ...
  NonElectrical.Continuous.SimpleLagLim simpleLagLim(K = 1, T = Tqord, outMax = Qmax, outMin = Qmin, y_start = ini_Qwtt) annotation(Placement(transformation(extent = {{28, 6}, {40, 18}})));
  NonElectrical.Continuous.SimpleLagRateLimBlock simpleLagLimBlock(K = 1, T = Tiq, outMax = iqmin, outMin = iqmax, y_start = ini_Iqwtt, rmin = -999, rmax = +999) annotation(Placement(transformation(extent = {{176, -2}, {196, 18}})));
initial equation
  ini_Pwtt = Pwtt;
  ...
  ini_Qwtt = -Qwtt;
equation
  connect(imReal4in.p1, Uref) annotation(Line(points = {{-58.625, 27.5}, {-69.75, 27.5}, {-69.75, 20}, {-84, 20}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imReal4in.p2, Qref) annotation(Line(points = {{-58.625, 22.5}, {-68.75, 22.5}, {-68.75, 0}, {-84, 0}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Pwtt, imSimpleLag.u) annotation(Line(points = {{-84, -20}, {-84, -19}, {-71, -19}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint1.y, imReal4in.in1) annotation(Line(points = {{-73.1, 50}, {-56.75, 50}, {-56.75, 30.6875}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint2.y, imReal4in.in2) annotation(Line(points = {{-73.1, 58}, {-54.5, 58}, {-54.5, 30.6875}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint3.y, imReal4in.in3) annotation(Line(points = {{-73.1, 66}, {-51.75, 66}, {-51.75, 30.6875}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint4.y, imReal4in.in4) annotation(Line(points = {{-73.1, 74}, {-49.25, 74}, {-49.25, 30.6875}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imReal4in.n, imRelay.u3) annotation(Line(points = {{-47.5, 25}, {-33, 25}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imRelay.u1, imReal4in.in1) annotation(Line(points = {{-33, 31}, {-38, 31}, {-38, 50}, {-56.75, 50}, {-56.75, 30.6875}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imRelay.y, imLimiter.u) annotation(Line(points = {{-23.2, 28}, {-8, 28}, {-8, 30}, {-10.8, 30}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Uwtt, imSimpleLag1.u) annotation(Line(points = {{-84, -40}, {-84, -49}, {-76.6, -49}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(lVRT.Uwtt, imSimpleLag1.y) annotation(Line(points = {{-38.88, -53}, {-46.44, -53}, {-46.44, -49}, {-69.7, -49}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSimpleLag1.u, imLimiter1.u) annotation(Line(points = {{-76.6, -49}, {-62, -49}, {-62, -40}, {-41.2, -40}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(lVRT.F_LVRT, imRelay1.u1) annotation(Line(points = {{-13.68, -48.8}, {2, -48.8}, {2, 42.75}, {28.75, 42.75}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(voltageDepCurrent.Uwtt, imSimpleLag1.y) annotation(Line(points = {{-40.04, -80}, {-46, -80}, {-46, -49}, {-69.7, -49}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(voltageDepCurrent.iqv, imLimiter2.u) annotation(Line(points = {{-12.22, -80}, {-5.2, -80}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imRelay2.u1, imReal4in.in2) annotation(Line(points = {{83, 51}, {-54.5, 51}, {-54.5, 30.6875}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imRelay4.u1, imRelay1.u1) annotation(Line(points = {{158.75, 64.75}, {136, 64.75}, {136, -4}, {2, -4}, {2, 42.75}, {28.75, 42.75}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imRelay5.u1, imReal4in.in4) annotation(Line(points = {{223.625, 62.625}, {208, 62.625}, {208, 74}, {-49.25, 74}, {-49.25, 30.6875}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(F_LVRT, imRelay1.u1) annotation(Line(points = {{124, 20}, {80, 20}, {80, -28}, {2, -28}, {2, 42.75}, {28.75, 42.75}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(imRelay5.y, iQLVRT1.iQstate) annotation(Line(points = {{237.1, 58.5}, {246, 58.5}, {246, -30}, {30, -30}, {30, -67.4}, {42.96, -67.4}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(iQLVRT1.iQcmd, Iqcmd) annotation(Line(points = {{64.56, -74}, {94, -74}, {94, -20}, {124, -20}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint6.y, iQLVRT1.iQpost) annotation(Line(points = {{24.6, -68}, {32, -68}, {32, -74}, {42.96, -74}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imLimiter2.y, iQLVRT1.iqv) annotation(Line(points = {{8.6, -80}, {24, -80}, {24, -80.6}, {42.96, -80.6}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(voltageDrop.Pwt, imSimpleLag.u) annotation(Line(points = {{-19.6, -9.4}, {-76, -9.4}, {-76, -19}, {-71, -19}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(voltageDrop.Uwt, imLimiter1.u) annotation(Line(points = {{-19.6, -24.6}, {-34, -24.6}, {-34, -32}, {-42, -32}, {-42, -40}, {-41.2, -40}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imRelay1.y, ImIntegratornonwindup.u) annotation(Line(points = {{41, 39}, {49, 39}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(iQLVRT1.F_LVRT, imRelay1.u1) annotation(Line(points = {{44.4, -61.68}, {44.4, -42}, {2, -42}, {2, 42.75}, {28.75, 42.75}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  annotation(Icon(coordinateSystem(extent = {{-100, -100}, {260, 80}}, preserveAspectRatio = false), graphics = {Rectangle(extent = {{-80, 40}, {120, -40}}, lineColor = {0, 0, 255}, lineThickness = 0.5), Text(extent = {{-25, 26}, {52, -22}}, lineColor = {0, 0, 255}, lineThickness = 0.5, fillPattern = FillPattern.Solid, textString = "Type 4B
Q Control"), Text(extent = {{-74, 36}, {-54, 30}}, lineColor = {0, 0, 255}, textString = "Qwtt"), Text(extent = {{-74, 22}, {-54, 16}}, lineColor = {0, 0, 255}, textString = "Uref"), Text(extent = {{-74, 3}, {-54, -3}}, lineColor = {0, 0, 255}, textString = "Qref"), Text(extent = {{-74, -17}, {-54, -23}}, lineColor = {0, 0, 255}, textString = "Pwtt"), Text(extent = {{-74, -32}, {-54, -38}}, lineColor = {0, 0, 255}, textString = "Uwtt"), Text(extent = {{96, 22}, {116, 16}}, lineColor = {0, 0, 255}, textString = "LVRT"), Text(extent = {{96, -16}, {116, -22}}, lineColor = {0, 0, 255}, textString = "iQcmd")}), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {260, 80}})), Documentation(revisions = "<html>
<!--DISCLAIMER-->

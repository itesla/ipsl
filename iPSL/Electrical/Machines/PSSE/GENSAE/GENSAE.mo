...
model GENSAE "SALIENT POLE GENERATOR MODEL (EXPONENTIAL SATURATION)"
  ...
  extends BaseClasses.baseMachine(w(start = 0), EFD(start = efd0), XADIFD(start = efd0), PMECH(start = pm0), ANGLE(start = delta0), delta(start = delta0), id(start = id0), iq(start = iq0), ud(start = ud0), uq(start = uq0), Te(start = pm0));
...
protected
  ...
  parameter Real dsat = SE_exp(Epq0, S10, S12, 1, 1.2);
...
equation
  ...
  PSId = PSIppd - Xppd * id;
  PSIq = (-PSIppq) - Xppq * iq;
  XadIfd = K1d * (Epq - PSIkd - (Xpd - Xl) * id) + (Xd - Xpd) * id + (SE_exp(Epq, S10, S12, 1, 1.2) + 1) * Epq;
  Te = PSId * iq - PSIq * id;
  ud = (-PSIq) - R_a * id;
  uq = PSId - R_a * iq;
  //flow, changed from machine base to system bas
  annotation(Placement(transformation(extent = {{74, 6}, {94, 26}}), iconTransformation(extent = {{58, -90}, {74, -74}})), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}})), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Text(extent=  {{-58, 62}, {52, -64}}, lineColor=  {0, 0, 255}, textString=  "GENSAL"), Text(extent=  {{-86, 58}, {-50, 42}}, lineColor=  {0, 0, 255}, textString=  "PMECH"), Text(extent=  {{-88, -44}, {-58, -56}}, lineColor=  {0, 0, 255}, textString=  "EFD"), Text(extent=  {{68, 98}, {98, 82}}, lineColor=  {0, 0, 255}, lineThickness=  0.5, textString=  "SPEED"), Text(extent=  {{66, 78}, {98, 62}}, lineColor=  {0, 0, 255}, lineThickness=  0.5, textString=  "ISORCE"), Text(extent=  {{68, 56}, {98, 42}}, lineColor=  {0, 0, 255}, textString=  "ETERM"), Text(extent=  {{68, 38}, {98, 22}}, lineColor=  {0, 0, 255}, lineThickness=  0.5, textString=  "ANGLE"), Text(extent=  {{64, -24}, {98, -36}}, lineColor=  {0, 0, 255}, lineThickness=  0.5, textString=  "PMECH0"), Text(extent=  {{68, -46}, {98, -56}}, lineColor=  {0, 0, 255}, lineThickness=  0.5, textString=  "PELEC"), Text(extent=  {{68, -66}, {102, -76}}, lineColor=  {0, 0, 255}, lineThickness=  0.5, textString=  "EFD0"), Text(extent=  {{64, -86}, {100, -96}}, lineColor=  {0, 0, 255}, lineThickness=  0.5, textString=  "XADIFD0")}), Documentation(info = "<html>

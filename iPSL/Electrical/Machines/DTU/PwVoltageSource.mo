...
model PwVoltageSource "Developed by DTU"
  ...
  Modelica.Blocks.Interfaces.RealInput Vre_ref annotation (Placement(
        transformation(extent={{-72,33},{-60,47}}), iconTransformation(extent={
            {-72,33},{-60,47}})));
  Modelica.Blocks.Interfaces.RealInput Vim_ref annotation (Placement(
        transformation(extent={{-72,-47},{-60,-33}}), iconTransformation(extent
          ={{-72,-47},{-60,-33}})));

...
model PwGeneratorM2S "Synchronous machine model according to Park's classical theory (Full model description).
  ...
  iPSL.Electrical.Machines.Eurostag.PwExtIntParameters extern(rStatIn_ = rStatIn, lStatIn_ = lStatIn, xDPu_ = XD, xpDPu_ = XPD, xppDPu_ = XSD, tpDO_ = TPD0, tppDO_ = TSD0, xQPu_ = XQ, xpQPu_ = XPQ, xppQPu_ = XSQ, tpQO_ = TPQ0, tppQO_ = TSQ0, tX_ = TX, IENR = IENR);

...
model PwGeneratorM1S_Init "Initialization model for synchronous mahine M1S.
  ...
  parameter Real mQ0Pu;
  parameter Real mD0Pu;
  //parameter Real pNomAlt;
  //parameter Real pNom;
  parameter Real lDPu;
  parameter Real rRotIn;
  parameter Real lRotIn;
  parameter Real rQ1Pu;
  parameter Real lQ1Pu;
  parameter Real rQ2Pu;
  parameter Real lQ2Pu;
  parameter Real mCanPu;
  //parameter Real omega0;

...
model PwGeneratorM1S "Synchronous machine model according to Park's classical theory (Full model description).
  ...
  parameter Real RTfoPu = if transformerIncluded then 0.000185 else 0 "Machine transformer resistance p.u. in the SNTfo base";
  parameter Real XTfoPu = if transformerIncluded then 0.00769 else 0 "Machine transformer resistance p.u. in the SNTfo base";

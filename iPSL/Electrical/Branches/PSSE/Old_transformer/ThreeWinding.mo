...
equation
  ...
  connect(V1.v, No_1.sensored_voltage) annotation(Line(points={{-68.3,
          -21.57},{-68.3,5.215},{-64.64,5.215},{-64.64,3.14}},                                                                  color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(V2.v, No_2.sensored_voltage) annotation(Line(points={{65.57,
          1.7},{65.57,3.5},{62.64,3.5},{62.64,10.86}},                                                                     color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(V3.v, No_3.sensored_voltage) annotation(Line(points={{67.57,
          -48.3},{67.57,-46.5},{64.64,-46.5},{64.64,-39.14}},                                                                    color = {0, 0, 127}, smooth = Smooth.None));

...
model PhaseshiftTwoWindingTransformer_withOLTC
  ...
  Transformer_Tap transformer_Tap(R = R, X = X, G = G, B = B, ti = ti, tj = tj) annotation(Placement(transformation(extent = {{10, -20}, {66, 24}})));
...
equation
  connect(phaseship1.F, F) annotation(Line(points = {{-82.96, 4.24}, {-86.6934, 4.24}, {-86.6934, 6}, {-104, 6}}, color = {0, 0, 255}, thickness = 0.5, smooth = Smooth.None));
  connect(phaseship1.T, transformer_Tap.F) annotation(Line(points = {{-15.32, 4.24}, {-3.03, 4.24}, {-3.03, 4.2}, {15.04, 4.2}}, color = {0, 0, 255}, thickness = 0.5, smooth = Smooth.None));
  connect(transformer_Tap.T, T) annotation(Line(points = {{64.88, 3.76}, {86.44, 3.76}, {86.44, 4}, {96, 4}}, color = {0, 0, 255}, thickness = 0.5, smooth = Smooth.None));
  connect(oLTC.y, transformer_Tap.t1) annotation(Line(points = {{-27.08, 40.82}, {-4, 40.82}, {-4, 11.24}, {12.8, 11.24}}, color = {0, 0, 127}, thickness = 0.5, smooth = Smooth.None));
  connect(V, oLTC.u) annotation(Line(points = {{-100, 42}, {-88.36, 42}, {-88.36, 40.82}, {-62.72, 40.82}}, color = {0, 0, 127}, thickness = 0.5, smooth = Smooth.None));
  annotation(Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics), Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Text(extent=  {{26, 54}, {114, 2}}, lineColor=  {0, 0, 255}, fillColor=  {0, 0, 255}, fillPattern=  FillPattern.Solid, textString=  "*", textStyle=  {TextStyle.Bold}), Ellipse(extent=  {{-74, 44}, {6, -40}}, lineColor=  {0, 0, 255}, lineThickness=  0.5), Ellipse(extent=  {{-10, 44}, {70, -40}}, lineColor=  {0, 0, 255}, lineThickness=  0.5), Line(points=  {{-13, -12}, {-5, -12}, {-5, -6}, {1, -6}, {1, 0}, {9, 0}, {9, 6}, {15, 6}, {15, 12}}, color=  {0, 0, 255}, smooth=  Smooth.None, origin=  {-29, 4}, rotation=  180, thickness=  0.5)}), Documentation(info = "<html>

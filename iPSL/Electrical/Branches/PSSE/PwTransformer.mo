...
model PwTransformer "Two winding fixed transformer composed of an ideal transformer, 
  ...
  2014/12/16"
  iPSL.Connectors.PwPin To annotation (Placement(transformation(extent={{60,-10},
            {80,10}}), iconTransformation(extent={{60,-10},{80,10}})));
  iPSL.Connectors.PwPin From annotation (Placement(transformation(extent={{-80,
...
equation
  To.ir = 1/(Req*Req + Xeq*Xeq)*(Req*(t*t*To.vr - t*From.vr) + Xeq*(t*t*To.vi
     - t*From.vi));
  To.ii = 1/(Req*Req + Xeq*Xeq)*(Req*(t*t*To.vi - t*From.vi) - Xeq*(t*t*To.vr
     - t*From.vr));
  From.ir = (-1/t*(1/(Req*Req + Xeq*Xeq)*(Req*(t*t*To.vr - t*From.vr) + Xeq*(t*
    t*To.vi - t*From.vi)))) + G*From.vr - B*From.vi;
  From.ii = (-1/t*(1/(Req*Req + Xeq*Xeq)*(Req*(t*t*To.vi - t*From.vi) - Xeq*(t*
    t*To.vr - t*From.vr)))) + G*From.vi + B*From.vr;
  annotation (
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
            100}}), graphics={Rectangle(extent={{-60,40},{60,-40}}, lineColor={
          0,0,255}),Ellipse(
          extent={{-28,22},{14,-22}},
          lineColor={0,0,255},

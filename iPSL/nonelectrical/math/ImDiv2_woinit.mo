...
class ImDiv2_woinit "Quotient block. Developed by DTU"
  ...
  Modelica.Blocks.Interfaces.RealOutput n1 annotation(Placement(transformation(extent = {{-61, -30}, {-41, -10}}), iconTransformation(extent = {{39, -10}, {59, 10}})));

...
class ImSine "Output the sine of the input.
              2014/03/10"
...
equation
  n1 = sin(p1);
  annotation(Diagram(graphics), Icon(graphics={  Rectangle(extent=  {{-40, 40}, {40, -40}}, lineColor=  {0, 0, 255}), Text(extent=  {{-12, 10}, {14, -8}}, lineColor=  {0, 0, 255}, textString=  "sin", textStyle=  {TextStyle.Bold})}),

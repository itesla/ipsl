...
extends Modelica.Icons.UnderConstruction;
  ...
  Modelica.Blocks.Sources.Constant imSetPoint1(k=0.9) annotation (Placement(visible = true, transformation(extent = {{-108, -64}, {-88, -44}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant imSetPoint5(k=1) annotation (Placement(visible = true, transformation(extent = {{-106, 8}, {-94, 20}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant imSetPoint6(k=0) annotation (Placement(visible = true, transformation(extent = {{-108, -32}, {-88, -12}}, rotation = 0)));

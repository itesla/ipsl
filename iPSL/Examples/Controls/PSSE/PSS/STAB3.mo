...
model STAB3 "Simple Machine Infinite Bus with Machine, Governor and Excitation system"
  ...
  iPSL.Electrical.Controls.PSSE.ES.SCRX SCRX(
    ...
    E_MAX=5,
    r_cr_fd=0,
    C_SWITCH=false) annotation (Placement(visible = true, transformation(origin = {-94, -38}, extent = {{-18, -16}, {18, 16}}, rotation = 180)));
...
equation
  connect(SCRX.VOTHSG, const.y) annotation(
    Line(points = {{-77, -48}, {-74, -48}, {-74, -36}, {-71.67, -36}, {-71.67, -34}, {-70.2, -34}}, color = {0, 0, 127}));
  connect(generator.EFD, SCRX.EFD) annotation(
    Line(points = {{-105.72, -5.5}, {-116, -5.5}, {-116, -40}, {-113, -40}}, color = {0, 0, 127}));
  connect(SCRX.ECOMP, generator.ETERM) annotation(
    Line(points = {{-77, -40}, {-66, -40}, {-66, 7.5}, {-76.88, 7.5}}, color = {0, 0, 127}));
  connect(generator.XADIFD, SCRX.XADIFD) annotation(
    Line(points = {{-76.88, -10.7}, {-70, -10.7}, {-70, -34}, {-76, -34}}, color = {0, 0, 127}));
  connect(generator.EFD0, SCRX.EFD0) annotation(
    Line(points = {{-76.88, -8.1}, {-74, -8.1}, {-74, -28}, {-77, -28}}, color = {0, 0, 127}));
  connect(SCRX.VOEL, const.y) annotation(
    Line(points = {{-88, -22}, {-71.67, -22}, {-71.67, -34}, {-70.2, -34}}, color = {0, 0, 127}));
  connect(SCRX.VUEL, const.y) annotation(
    Line(points = {{-82, -22}, {-71.67, -22}, {-71.67, -34}, {-70.2, -34}}, color = {0, 0, 127}));

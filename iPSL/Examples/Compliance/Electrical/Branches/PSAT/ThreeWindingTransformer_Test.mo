within iPSL.Examples.Compliance.Electrical.Branches.PSAT;
model ThreeWindingTransformer_Test
   ...
   iPSL.Electrical.Branches.PwLine pwLine4(
    ...
    X=0.1) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Modelica.Blocks.Sources.Sine sine1(amplitude=0.001, freqHz=0.2) annotation(Placement(visible=true, transformation(origin={-107.783,
            15.4652},                                                                                                    extent={{-4.4802,-4.4802},{4.4802,4.4802}}, rotation=0)));
...
equation
  connect(sine1.y,add2.u1) annotation(Line(visible=true, origin={-93.5606,15.4643}, points={{
          -9.29418,0.0009},{-1.4394,0.0009},{6.86692,0.0009},{6.86692,
          2.99154}},                                                                                                    color={0,0,127}));
  connect(add2.u2,sine2.y) annotation(Line(visible=true, origin={-95.6692,1.8029}, points={{8.97552,
          9.06546},{2.2971,9.06546},{2.2971,-5.4041},{-6.78488,-5.4041},
          {-6.78488,-7.3227}},                                                                                                    color={0,0,127}));
  ...
  connect(Bus4.p, lOADPQ1.p) annotation (Line(
      ...
      color={0,0,255},
      smooth=Smooth.None));
  annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}},     preserveAspectRatio=true,initialScale=0.1, grid={5,5}), graphics),

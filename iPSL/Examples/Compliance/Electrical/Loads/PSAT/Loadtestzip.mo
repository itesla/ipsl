  ...
  Modelica.Blocks.Math.Add3 add32 annotation(Placement(visible = true, transformation(origin = {-45.0, -57.0021}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
   iPSL.Electrical.Machines.PSAT.ThirdOrder.Order3
    ...
    xq=1.7) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
   iPSL.Electrical.Loads.PSAT.ZIP ZIP1(Sn = 10, V_0 = 0.993325452568749, Pz = 0.5, Pi = 0.3, Qz = 0.5, Qi = 0.3,
    P_0=0.8,
    Q_0=0.6)                                                                                                     annotation(Placement(visible = true, transformation(origin = {123.3697, -10.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  inner iPSL.Electrical.SystemBase  SysData
    annotation (Placement(transformation(extent={{100,80},{125,100}})));
equation
  connect(pwLine4.n, ZIP1.p) annotation(Line(visible = true, origin = {105.7773, -12.5}, points={{
          -13.7773,-2.5},{3.5924,-2.5},{3.5924,13.5},{17.5924,13.5}}));

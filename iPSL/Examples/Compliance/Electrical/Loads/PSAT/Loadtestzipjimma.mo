  ...
  Modelica.Blocks.Math.Add3 add32 annotation(Placement(visible = true, transformation(origin = {-45.0, -57.0021}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
   iPSL.Electrical.Machines.PSAT.ThirdOrder.Order3
    ...
    xq=1.7) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
   iPSL.Electrical.Loads.PSAT.ZIP_Jimma ZIP_Jimma1(V_0 = 0.993325565105317, Sn = 10, Tf = 0.1,
    P_0=0.8,
    Q_0=0.6)                                                                                          annotation(Placement(visible = true, transformation(origin = {125.0, -5.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  inner iPSL.Electrical.SystemBase  SysData
    annotation (Placement(transformation(extent={{100,80},{135,100}})));
equation
  connect(pwLine4.n, ZIP_Jimma1.p) annotation(Line(visible = true, origin = {107.0, -10.0}, points={{-15,-5},
          {4,-5},{4,16},{18,16}}));

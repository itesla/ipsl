...
model STABNI
  ...
  iPSL.Electrical.Loads.PSSE.Load_variation constantLoad(
    ...
    t1=100,
    angle_0=-0.3061685)
    annotation (Placement(transformation(extent={{0,-40},{24,-16}})));
...
equation
  connect(generator.p, pwLine.p) annotation(Line(points={{-48.6,11},{-50.6,
          11},{-50.6,10},{-31,10}},                                                                                 color = {0, 0, 255}, smooth = Smooth.None));
  ...
  connect(pwFault.p, pwLine4.p)
    annotation (Line(points={{32.3333,-28},{23,-28},{23,-10}},
                                                          color={0,0,255}));
  connect(generator.PMECH0, HYGOV.PMECH0) annotation (Line(points={{-48.88,7.1},
          {-38,7.1},{-38,20},{-28,20},{-28,47},{-36.475,47}}, color={0,0,127}));

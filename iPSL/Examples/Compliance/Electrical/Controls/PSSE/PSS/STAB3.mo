...
equation
  connect(generator.p, pwLine.p) annotation(Line(points={{-48.6,11},{-50.6,11},{
          -50.6,10},{-31,10}},                                                                                      color = {0, 0, 255}, smooth = Smooth.None));
  ...
  connect(pwLine4.n, gENCLS.p) annotation(Line(points={{37,-10},{58,-10},{58,0.834604},
          {67.8,0.834604}},                                                                                       color = {0, 0, 255}, smooth = Smooth.None));
  connect(constantLoad.p, pwLine3.p) annotation(Line(points={{12,-14.8},{12,
          -27.5},{-3,-27.5},{-3,-10}},                                                                              color = {0, 0, 255}, smooth = Smooth.None));
  ...
  connect(HYGOV.PMECH, generator.PMECH) annotation (Line(points={{-74.95,40},{
          -84,40},{-84,17.5},{-77.72,17.5}}, color={0,0,127}));
  connect(generator.EFD, SCRX.EFD) annotation (Line(points={{-77.72,4.5},{-88,
          4.5},{-88,-19.76},{-84.6,-19.76}}, color={0,0,127}));
  connect(SCRX.VOTHSG, const.y) annotation (Line(points={{-48.15,-29.04},{-46,
          -29.04},{-46,-26},{-43.67,-25.2},{-43.67,-24},{-42.2,-24}}, color={0,
          0,127}));

...
model PSS2A
  ...
  iPSL.Electrical.Controls.PSSE.PSS.PSS2A.PSS2A pSS2A(M=1, N=1)
    annotation (Placement(transformation(extent={{16,-4},{-14,4}})));
equation
  ...
  connect(pSS2A.V_S1, add.y) annotation (Line(points={{15.8,2},{54,2},{54,-5},{
          63.7,-5}}, color={0,0,127}));
  connect(pSS2A.V_S2, VCT.y) annotation (Line(points={{15.8,-2},{36,-2},{36,21},

...
model GAST "three phase to ground fault test of GGOV"
  import iPSL;
  ...
  iPSL.Electrical.Controls.PSSE.TG.GAST.GAST gAST(
    R=5,
    T_1=1,
    T_2=2,
    T_3=3,
    ...
    V_MIN=-10,
    D_turb=5)
    annotation (Placement(transformation(extent={{0,-40},{-72,20}})));
equation
  ...
  connect(step.y, add.u2) annotation (Line(points={{79,-50},{70,-50},{70,-36},
          {62,-36}}, color={0,0,127}));
  connect(gAST.SPEED, add.y) annotation (Line(points={{0,5},{32,5},{32,-30},{39,
          -30}}, color={0,0,127}));
  connect(gAST.Reference, const.y) annotation (Line(points={{0,-25},{20,-25},{

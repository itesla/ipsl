...
model IEESGO
 ...
 iPSL.Electrical.Machines.PSSE.GENCLS.GENCLS gENCLS(
    ...
    H=0,
    D=0)
    annotation (Placement(transformation(extent={{108,0},{86,22}})));
  ...
  iPSL.NonElectrical.Math.ImSum2 imSum2_1(
    a0=0,
    a1=1,
    a2=1) annotation (Placement(transformation(extent={{-38,36},{-54,54}})));
  Modelica.Blocks.Sources.Step step(height = -0.002, startTime = 10) annotation(Placement(transformation(extent={{-22,40},
            {-36,54}})));
equation
  connect(generator.p, pwLine.p) annotation(Line(points={{-48.7,11},{-20.6,
          11},{-20.6,10},{-15,10}},                                                                                 color = {0, 0, 255}, smooth = Smooth.None));
  connect(pwLine.n, pwLine1.p) annotation(Line(points={{-1,10},{3.5,10},{
          3.5,24},{29,24}},                                                                             color = {0, 0, 255}, smooth = Smooth.None));
  connect(pwLine1.n, gENCLS.p) annotation(Line(points={{43,24},{74,24},{74,
          10.8346},{83.8,10.8346}},                                                                           color = {0, 0, 255}, smooth = Smooth.None));
  connect(pwLine3.p, pwLine.n) annotation(Line(points={{19,-10},{2.5,-10},
          {2.5,10},{-1,10}},                                                                               color = {0, 0, 255}, smooth = Smooth.None));
  ...
  connect(generator.PMECH0, imSum2_1.p2) annotation (Line(
      points={{-48.96,7.7},{-40,7.7},{-40,43.2},{-41.92,43.2}},
      color={0,0,127},
      smooth=Smooth.None));

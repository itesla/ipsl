...
equation
  ...
  connect(step.y, add.u2) annotation (Line(points={{79,-70},{70,-70},{70,-56},
          {62,-56}}, color={0,0,127}));
  connect(add.y, iEEESGO.SPEED) annotation (Line(points={{39,-50},{20,-50},{20,
          -5},{-1.03333,-5}}, color={0,0,127}));
  connect(iEEESGO.PMECH0, const.y) annotation (Line(points={{-1.03333,25},{22,
          25},{22,30},{39,30}}, color={0,0,127}));

...
equation
  connect(generator.p, pwLine.p) annotation(Line(points={{-48.6,13},{-50.6,
          13},{-50.6,12},{-37,12}},                                                                                 color = {0, 0, 255}, smooth = Smooth.None));
  ...
  connect(pwLine3.p, pwLine.n) annotation(Line(points={{-3,4},{-17.5,4},{
  ...
  connect(pwLine4.n, gENCLS.p) annotation(Line(points={{37,4},{52,4},{52,4.8346},
          {59.8,4.8346}},                                                                                   color = {0, 0, 255}, smooth = Smooth.None));
  connect(constantLoad.p, pwLine3.p) annotation(Line(points={{-16,7.1},{-16,
          -5.5},{-3,-5.5},{-3,4}},                                                                               color = {0, 0, 255}, smooth = Smooth.None));

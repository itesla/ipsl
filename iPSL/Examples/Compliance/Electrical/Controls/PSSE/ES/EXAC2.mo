...
model EXAC2 "SMIB system with one load and GENROE model"
  ...
  iPSL.Electrical.Machines.PSSE.GENCLS.GENCLS gENCLS(
   ...
   iPSL.Electrical.Controls.PSSE.ES.EXAC2.EXAC2 eXAC2_1(
    ...
    K_H=2,
    V_LR=2)
    annotation (Placement(transformation(extent={{-36,-42},{-82,-20}})));
...
equation
  ...
  connect(gENROE.PMECH, gENROE.PMECH0) annotation (Line(points={{-81.6,20},{-92,20},{
          -92,36},{-30,36},{-30,4},{-40.4,4}},      color={0,0,127}));
  connect(gENROE.EFD0, eXAC2_1.EFD0) annotation (Line(points={{-40.4,-4},{-30,
          -4},{-30,-22.75},{-36.2875,-22.75}}, color={0,0,127}));
  connect(gENROE.XADIFD, eXAC2_1.XADIFD) annotation (Line(points={{-40.4,-8},{
          -32,-8},{-32,-25.5},{-36.1437,-25.5}}, color={0,0,127}));
  ...
  connect(eXAC2_1.VOEL, const.y) annotation (Line(points={{-36.2875,-39.25},{
          -28,-39.25},{-28,-36},{-23,-36}}, color={0,0,127}));

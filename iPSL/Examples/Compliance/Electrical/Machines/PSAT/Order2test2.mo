...
model Order2test2
   ...
   iPSL.Electrical.Machines.PSAT.SecondOrder.Order2 order21(Sn = 20, Q_0 = 0.11859436505981, P_0 = 0.160352698692006,
    V_b=400,
    V_0=1,
    angle_0=0,
    Vn=400,
    ...
    xd1=0.302,
    M=10,
    D=0)                                                                                                     annotation(Placement(visible = true, transformation(origin = {-116.9458, 10.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
...
equation
  ...
  connect(order21.p, pwLine2.p) annotation(Line(visible = true, origin = {-98.2365, 9.9248}, points={{-7.7093,
          0.12484},{-6.7635,0.12484},{-6.7635,0.0752},{21.2365,0.0752}}));
 ...
 annotation(__ModelicaAssociation(TestCase(shouldPass=true)),Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}},          preserveAspectRatio=false,  initialScale = 0.1, grid = {5, 5}), graphics={  Text(visible = true, origin = {-70.0, 29.1417},

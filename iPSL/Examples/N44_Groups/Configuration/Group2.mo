...
model Group2 "Machine configuration of synchronous machine with regulators: GENSAL, HYGOV, SCRX;
  ...
  iPSL.Electrical.Machines.PSSE.GENSAL.GENSAL gENSAL(V_0 = 1 "power flow, terminal voltage", angle_0 = 42.77 "power flow, angle in degree", P_0 = 643 "power flow, active power, (MW)", Q_0 = 54.8304 "power flow, reactive power, (Mvar)", M_b = 1357 "system base power rating (MVA)", Tpd0 = 5.0 "T'do (> 0)", Tppd0 = 0.06 "T''do (> 0)", Tppq0 = 0.1 "T''qo (> 0)", H = 3.3 "Inertia", D = 0 "Speed Damping", Xd = 0.75 "d-axis reactance", Xq = 0.5 "q-axis reactance", Xpd = 0.25 "d-axis transient reactance", Xppd = 0.1538 "d-axis subtransient reactance", Xppq = 0.1538 "q-axis subtransient reactance", Xl = 0.1154 "leakage reactance", S10 = 0.1024, S12 = 0.2742, S_b = 1000) annotation(Placement(transformation(extent = {{-80, -28}, {-28, 26}})));

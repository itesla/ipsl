...
record GROUP1
  ...
  replaceable record GENROU_N44 =
      iPSL.Examples.N44_Groups.Configuration.Data.GENROU_data                             annotation(choicesAllMatching);
  GENROU_N44 genrou;
  replaceable record IEEET2_N44 =
      iPSL.Examples.N44_Groups.Configuration.Data.IEEET2_data                             annotation(choicesAllMatching);
  IEEET2_N44 ieeet2;
  replaceable record STAB2A_N44 =
      iPSL.Examples.N44_Groups.Configuration.Data.STAB2A_data                             annotation(choicesAllMatching);
  STAB2A_N44 stab2a;
  replaceable record IEESGO_N44 =
      iPSL.Examples.N44_Groups.Configuration.Data.IEESGO_data                             annotation(choicesAllMatching);
  IEESGO_N44 ieesgo;
  replaceable record INI_GEN_N44 =
      iPSL.Examples.N44_Groups.Configuration.Data.INI_GENROU_data                              annotation(choicesAllMatching);
  INI_GEN_N44 ini_gen;

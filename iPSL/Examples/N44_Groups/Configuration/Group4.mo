...
model Group4 "Machine configuration of synchronous machine with regulators: GENROU, STAB2A, IEEET2, IEESGO;
  ...
  Electrical.Machines.PSSE.GENROU.GENROU gENROU(
    ...
    S12=0.378,
    S_b=1000)
    annotation (Placement(transformation(extent={{-56,-14},{-6,38}})));
  Electrical.Controls.PSSE.TG.IEESGO iEESGO(
    ...
    P_MIN=0 "lower power limit")             annotation (Placement(
        transformation(
...
equation
  connect(iEESGO.PMECH,gENROU. PMECH) annotation (Line(
      points={{-51.5833,38.5},{-56,38.5},{-56,25},{-55.5,25}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(gENROU.SPEED,iEESGO. SPEED) annotation (Line(
      points={{-4,35.4},{-11,35.4},{-11,48},{-81,48},{-81,43.25},{-82.5167,
          43.25}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(gENROU.PELEC,sTAB2A.PELEC) annotation (Line(
      points={{-4,-1},{-9,-1},{-9,5},{-4,5},{-4,-25},{-120,-25},{-120,15.5},
          {-118.632,15.5}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(gENROU.EFD0,sCRX.EFD0) annotation (Line(
      points={{-4,-6.2},{-10,-6.2},{-10,-20},{-82,-20},{-82,-3.865},{
          -82.8667,-3.865}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(gENROU.PMECH0,iEESGO.PMECH0) annotation (Line(
      points={{-4,4.2},{-6,4.2},{-6,50},{-83,50},{-83,33.75},{-82.5167,
          33.75}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(gENROU.ETERM,sCRX.ECOMP) annotation (Line(
      points={{-4,25},{-8,25},{-8,24},{-3,24},{-3,52},{-85,52},{-85,23.855},
          {-82.8667,23.855}},
      color={0,0,127},
      smooth=Smooth.None));

...
equation
  connect(const1.y, add1.u1) annotation(Line(visible = true, origin = {-71.3029, 21.9375}, points = {{-12.9459, 1.0126}, {3.3154, 1.0126}, {3.3154, -1.0127}, {6.3155, -1.0127}}, color = {0, 0, 127}));
  ...
  connect(step1.y, add2.u1) annotation(Line(visible = true, origin = {-95.2638, -5.1548}, points = {{-14.1086, 5.1749}, {3.7029, 5.1749}, {3.7029, -5.17496}, {6.70292, -5.17496}}, color = {0, 0, 127}));
  connect(add2.u2, step2.y) annotation(Line(visible = true, origin = {-101.2558, -21.885}, points = {{12.6949, 8.11496}, {-3.2317, 8.11496}, {-3.2317, -8.115}, {-6.2316, -8.115}}, color = {0, 0, 127}));
  ...
  connect(const.y, PFmodel1.T) annotation(Line(visible = true, origin = {-30.4532, -10.8808}, points = {{-25.3969, -6.1691}, {7.4657, -6.1691}, {7.4657, 6.1691}, {10.4657, 6.1691}}, color = {0, 0, 127}));

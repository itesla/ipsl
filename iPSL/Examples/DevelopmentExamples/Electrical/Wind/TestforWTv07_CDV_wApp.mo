...
model TestforWTv07_CDV_wApp "Developed by DTU"
  ...
  Modelica.Blocks.Sources.Constant imSetPoint1(k=0.9)
    annotation (Placement(transformation(extent={{-108,-44},{-88,-24}})));
  Modelica.Blocks.Sources.Constant imSetPoint5(k=1)
    annotation (Placement(transformation(extent={{-106,-20},{-94,-8}})));
  Modelica.Blocks.Sources.Constant imSetPoint6(k=0)
  ...
  Modelica.Blocks.Sources.Constant imSetPoint2(k=1)
    annotation (Placement(transformation(extent={{6,-52},{26,-32}})));
  Modelica.Blocks.Sources.Step step1(
    offset=0,
    height=-0.5,
    startTime=1)
    annotation (Placement(transformation(extent={{0,-72},{16,-56}})));
  Modelica.Blocks.Sources.Step step2(
    offset=0,
    height=0.5,
    startTime=2)
    annotation (Placement(transformation(extent={{0,-98},{16,-82}})));
...
equation
  ...
  annotation (
    Diagram(coordinateSystem(extent={{-220,-160},{160,100}},

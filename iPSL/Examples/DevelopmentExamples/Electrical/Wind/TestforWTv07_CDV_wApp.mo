...
equation
  connect(imSetPoint5.y, type4B_WT_CDV.Uref) annotation(Line(points = {{-93.4, -14}, {-78, -14}, {-78, -10.8}, {-66.7941, -10.8}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(imSetPoint6.y, type4B_WT_CDV.Qref) annotation(Line(points = {{-85, -20}, {-78, -20}, {-78, -22}, {-66.7941, -22}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(infiniteBus.p, type4B_WT_CDV.WTG_terminal) annotation(Line(points = {{13, -21}, {2, -21}, {2, -22}, {-7.08824, -22}}, color = {0, 0, 255}, smooth = Smooth.None));
  connect(imSetPoint1.y, type4B_WT_CDV.Pref) annotation(Line(points = {{-87, -34}, {-78, -34}, {-78, -33.2}, {-66.7941, -33.2}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  annotation(Diagram(coordinateSystem(extent = {{-220, -160}, {160, 100}}, preserveAspectRatio = false)), Icon(coordinateSystem(extent = {{-220, -160}, {160, 100}})), Documentation(revisions = "<html>
<!--DISCLAIMER-->

...
model Generator
  iPSL.Electrical.Machines.PSSE.GENROU.GENROU generator(Xppd = 0.2, Xppq = 0.2, Xpp = 0.2, Xl = 0.12, V_0 = 1, V_b = 100, M_b = 100, Tpd0 = 5, Tppd0 = 0.05, Tppq0 = 0.1, H = 4, D = 0, Xd = 1.41, Xq = 1.35, Xpd = 0.3, S10 = 0.1, S12 = 0.5, Xpq = 0.6, Tpq0 = 0.7, angle_0 = 4.046276, P_0 = 40, Q_0 = 5.416582) annotation(Placement(transformation(extent = {{-60, 0}, {20, 80}})));
  Modelica.Blocks.Sources.Constant const5(k = 0) annotation(Placement(transformation(extent = {{5, -5}, {-5, 5}}, rotation = 0, origin = {65, -60})));
  iPSL.Electrical.Controls.PSSE.ES.EXST1.EXST1 exst1 annotation(Placement(transformation(extent = {{50, -36}, {-50, 36}}, rotation = 0, origin = {-24, -52})));
...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}})), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Ellipse(extent=  {{-100, 100}, {100, -100}}, lineColor=  {28, 108, 200}), Line(points=  {{-40, -20}}, color=  {28, 108, 200}), Line(points=  {{-40, 0}, {-20, 40}, {20, -42}, {40, 0}}, color=  {28, 108, 200})}), Documentation(info = "<html>

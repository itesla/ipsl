...
equation
  ...
  connect(const5.y, exst1.VOEL) annotation (Line(points={{59.5,-60},{24.8095,
          -60},{24.8095,-60.88}}, color={0,0,127}));
  ...
  connect(exst1.VUEL, exst1.VOEL) annotation (Line(points={{24.8095,-70},{36,
          -70},{36,-60},{24.8095,-60},{24.8095,-60.88}}, color={0,0,127}));
  connect(generator.XADIFD, exst1.XADIFD) annotation (Line(points={{23.2,4},{36,
          4},{36,-42.16},{24.8095,-42.16}}, color={0,0,127}));
  connect(exst1.ECOMP, generator.ETERM) annotation (Line(points={{24.8095,
          -23.44},{48,-23.44},{48,60},{23.2,60}}, color={0,0,127}));
  connect(exst1.ETERM, generator.ETERM) annotation (Line(points={{24.8095,
          -32.08},{34,-32.08},{34,-24},{48,-24},{48,60},{23.2,60}}, color={0,0,
          127}));

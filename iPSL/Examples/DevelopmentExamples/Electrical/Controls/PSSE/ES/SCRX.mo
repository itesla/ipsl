...
model SCRX "SMIB model example of GENROU with Excitation System EXST1"
  import iPSL;
  iPSL.Electrical.Branches.PwLine pwLine(R = 0.001, X = 0.2, G = 0, B = 0) annotation(Placement(transformation(extent = {{-26, -10}, {-6, 10}})));
  iPSL.Electrical.Branches.PwLine pwLine1(R = 0.001, X = 0.2, G = 0, B = 0) annotation(Placement(transformation(extent = {{34, 30}, {54, 50}})));
  iPSL.Electrical.Branches.PwLine2Openings pwLine3(t2 = 100, R = 0.0005, X = 0.1, G = 0, B = 0, t1 = 100) annotation(Placement(transformation(extent = {{16, -50}, {36, -30}})));
  iPSL.Electrical.Branches.PwLine2Openings pwLine4(t2 = 100, R = 0.0005, X = 0.1, G = 0, B = 0, t1 = 100) annotation(Placement(transformation(extent = {{52, -50}, {72, -30}})));
  iPSL.Electrical.Machines.PSSE.GENCLS.GENCLS gENCLS(X_d = 0.2, H = 0, D = 0, V_b = 100, V_0 = 1, angle_0 = 0, M_b = 100, P_0 = 10.01711, Q_0 = 8.006544) annotation(Placement(transformation(extent = {{102, -10}, {92, 14}})));
  iPSL.Electrical.Loads.PSSE.Load_variation constantLoad(S_p(re = 0.5, im = 0.1), S_i(im = 0, re = 0), S_y(re = 0, im = 0), a(re = 1, im = 0), b(re = 0, im = 1), PQBRAK = 0.7, V_0 = 0.9919935, angle_0 = -0.5762684, d_P = 0, t1 = 0, d_t = 0, characteristic = 2) annotation(Placement(transformation(extent = {{12, -60}, {0, -48}})));
  iPSL.Electrical.Events.PwFault pwFault(t1 = 2, t2 = 2.15, R = 0, X = 0) annotation(Placement(transformation(extent = {{56, -66}, {68, -54}})));
  ...
  iPSL.Electrical.Machines.PSSE.GENROU.GENROU gENROE(M_b = 100, Tpd0 = 5, Tppd0 = 0.07, Tpq0 = 0.9, Tppq0 = 0.09, D = 0, Xd = 1.84, Xq = 1.75, Xpd = 0.41, Xpq = 0.6, Xppd = 0.2, Xl = 0.12, S10 = 0.11, S12 = 0.39, V_0 = 1, P_0 = 40, angle_0 = 4.046276, Q_0 = 5.416582, Xppq = 0.2, R_a = 0, Xpp = 0.2, H = 4.28) annotation(Placement(transformation(extent = {{-96, -20}, {-56, 20}})));
  Modelica.Blocks.Sources.Constant const(k = 0) annotation(Placement(transformation(extent = {{4, -4}, {-4, 4}}, rotation = 0, origin = {-36, -36})));
  iPSL.Electrical.Controls.PSSE.ES.SCRX.SCRX sCRX(T_AT_B = 0.1, T_B = 1, K = 100, E_MIN = -10, E_MAX = 10, C_SWITCH = false, r_cr_fd = 0, V_c0 = 1, V_0 = 1, T_E = 0.005) annotation(Placement(transformation(extent = {{-58, -58}, {-92, -30}})));
equation

...
model SEXS "SMIB model example of GENROU with Excitation System EXST1"
  ...
  iPSL.Electrical.Controls.PSSE.ES.SEXS.SEXS sEXS(T_AT_B = 0.1, T_B = 1, K = 100, T_E = 0.1, E_MIN = -10, E_MAX = 10, Ec0 = 1) annotation(Placement(transformation(extent = {{-56, -54}, {-94, -26}})));
  Modelica.Blocks.Sources.Constant const(k = 0) annotation(Placement(transformation(extent = {{4, -4}, {-4, 4}}, rotation = 0, origin = {-36, -40})));
equation

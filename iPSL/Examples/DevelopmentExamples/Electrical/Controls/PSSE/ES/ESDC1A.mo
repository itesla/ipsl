...
model ESDC1A "SMIB system with one load and GENROE model"
  ...
  iPSL.Electrical.Controls.PSSE.ES.ESDC1A.ESDC1A eSDC1A(
    ...
    S_EE_2=0.1,
    T_B=2,
    T_C=10) annotation (Placement(transformation(extent={{-42,-40},{-82,-26}})));
equation
  ...
  connect(gENROE.ETERM, eSDC1A.ECOMP) annotation (Line(points={{-40.4,20},{-38,20},{-38,-28.1},{-43.1111,-28.1}}, color={0,0,127}));

...
model IEESGO "Simple Machine Infinite Bus with Machine, Governor and Excitation system"
  ...
  iPSL.Electrical.Controls.PSSE.TG.IEESGO iEESGO(T_1 = 0.01, T_2 = 0.0, T_3 = 0.15, T_4 = 0.3, T_5 = 8.0, T_6 = 0.4, K_1 = 0.0, K_2 = 0.7, K_3 = 0.43, P_MAX = 1.0, P_MIN = 0.0) annotation(Placement(transformation(extent = {{-54, 34}, {-86, 48}})));
equation

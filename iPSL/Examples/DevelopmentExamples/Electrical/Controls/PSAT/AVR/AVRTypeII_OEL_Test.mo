...
equation
  ...
  connect(order6Type2_Inputs_Outputs.pm0, order6Type2_Inputs_Outputs.pm) annotation(Line(points = {{-60, -15.9}, {32, -15.9}, {32, 108}, {-92, 108}, {-92, 7.5}, {-68, 7.5}}, color = {0, 0, 127}, smooth = Smooth.None));

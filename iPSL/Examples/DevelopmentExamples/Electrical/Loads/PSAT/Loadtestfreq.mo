...
model Loadtestfreq
  ...
  iPSL.Electrical.Branches.PwLine pwLine3(B = 0.001 / 2, G = 0, R = 0.01, X = 0.1) annotation(Placement(visible = true, transformation(origin = {85.0, -35.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  iPSL.Electrical.Branches.PwLine pwLine4(B = 0.001 / 2, G = 0, R = 0.01, X = 0.1) annotation(Placement(visible = true, transformation(origin = {85.0, -15.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  ...
  iPSL.Electrical.Machines.PSAT.ThirdOrder.Order3 order3_Inputs_Outputs1(P_0 = 0.0800989878477798, Q_0 = 0.0570163388727956, Sn = 20, V_b = 400, V_0 = 1, angle_0 = 0, Vn = 400, ra = 0.001, xd1 = 0.302, M = 10, D = 0, xd = 1.9, Td10 = 8, xq = 1.7) annotation(Placement(visible = true, transformation(origin = {3.3113, -20.7513}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  iPSL.Electrical.Loads.PSAT.FrequencyDependentLoad frequencyDependentLoad1(alpha_p = 0, beta_p = 1, beta_q = 1, Sn = 10, V_0 = 0.993325452568749, angle_0 = -0.00746932024404292, alpha_q = 0, Tf = 0.1, P_0 = 0.8, Q_0 = 0.6) annotation(Placement(visible = true, transformation(origin = {123.3697, -45.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  inner iPSL.Electrical.SystemBase SysData annotation(Placement(transformation(extent = {{100, 80}, {125, 100}})));
equation
  connect(pwLine3.n, frequencyDependentLoad1.p) annotation(Line(visible = true, origin = {105.7773, -40.0}, points = {{-13.7773, 5}, {3.5924, 5}, {3.5924, 6}, {17.5924, 6}}));
  ...
  annotation(Diagram(coordinateSystem(extent = {{-148.5, -105.0}, {148.5, 105.0}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5}), graphics = {Text(visible=  true, origin=  {39.8634, 3.4703}, fillPattern=  FillPattern.Solid, extent=  {{-35.0, -5.8583}, {35.0, 5.8583}}, textString=  "SystemSbase=100 MVA", fontName=  "Arial")}), Documentation(info = "<html>

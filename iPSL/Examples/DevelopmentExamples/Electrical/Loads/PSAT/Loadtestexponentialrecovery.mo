...
model Loadtestexponentialrecovery
  ...
  iPSL.Electrical.Loads.PSAT.ExponentialRecovery exponentialRecovery1(V_0 = 0.993325452568749, alpha_t = 1.5, beta_t = 1.5, Sn = 10, P_0 = 0.8, Q_0 = 0.6) annotation(Placement(visible = true, transformation(origin = {125.0, -17.844}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  inner iPSL.Electrical.SystemBase SysData annotation(Placement(transformation(extent = {{100, 80}, {125, 100}})));
equation
  connect(pwLine4.n, exponentialRecovery1.p) annotation(Line(visible = true, origin = {107.0, -16.422}, points = {{-15, 1.422}, {4, 1.422}, {4, 9.578}, {18, 9.578}}));

...
model Loadtestpq
  ...
  iPSL.Electrical.Loads.PSAT.LOADPQ LOADPQ1(Sn = 10, P_0 = 0.8, Q_0 = 0.6) annotation(Placement(visible = true, transformation(origin = {122.1536, -15.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  inner iPSL.Electrical.SystemBase SysData annotation(Placement(transformation(extent = {{50, 80}, {75, 100}})));
equation
  connect(pwLine4.n, LOADPQ1.p) annotation(Line(visible = true, origin = {101.5768, -15.0}, points = {{-9.5768, 0}, {20.5768, 0}, {20.5768, 11}}));

...
model Loadtestmixed
  ...
  iPSL.Electrical.Loads.PSAT.Mixed_Load mixed_Load1(V_0 = 0.993325452568749, Sn = 10, Tpv = 0.1, Tqv = 0.1, Tfv = 0.1, Tft = 0.1, Kpf = 1, Kqf = 1, alpha = 1, beta = 1, angle_0 = -0.00746932024404292, P_0 = 0.8, Q_0 = 0.6) annotation(Placement(visible = true, transformation(origin = {125.0, -40.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  inner iPSL.Electrical.SystemBase SysData annotation(Placement(transformation(extent = {{100, 80}, {125, 100}})));
equation
  connect(mixed_Load1.p, pwLine3.n) annotation(Line(visible = true, origin = {100.5, -37.5}, points = {{24.5, 8.5}, {-2.5, 8.5}, {-2.5, 2.5}, {-8.5, 2.5}}));

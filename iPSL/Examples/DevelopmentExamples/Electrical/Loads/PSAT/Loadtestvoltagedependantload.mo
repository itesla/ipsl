...
model Loadtestvoltagedependantload
  ...
  iPSL.Electrical.Loads.PSAT.VoltDependant voltDepend1(Sn = 10, V_0 = 0.993325452568749, P_0 = 0.8, Q_0 = 0.6) annotation(Placement(visible = true, transformation(origin = {125.0, -45.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  inner iPSL.Electrical.SystemBase SysData annotation(Placement(transformation(extent = {{100, 80}, {125, 100}})));
equation
  connect(pwLine3.n, voltDepend1.p) annotation(Line(visible = true, origin = {107.0, -40.0}, points = {{-15, 5}, {4, 5}, {4, 6}, {18, 6}}));

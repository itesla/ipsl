...
equation
  ...
  connect(pwLine2.p, pwLine1.p) annotation (Line(
      ...
      points={{-0.00000000000000355271,10},{-0.00000000000000355271,5},{-0.00000000000000710542,
          5},{-0.00000000000000710542,0.00000000000000355271},{-0.00000000000000355271,
          0.00000000000000355271},{-0.00000000000000355271,-10}}));
  ...
  connect(order2_Inputs_Outputs1.pm0, add32.u3) annotation (Line(
      visible=true,
      origin={-23.8167,-45.8774},
      points={{8.6,16.21},{36.6,16.21},{36.6,-25.4726},{-50.4,-25.4726},{-50.4,
          -15.4747}},
      color={0,0,127}));
  connect(order2_Inputs_Outputs1.vf0, add31.u3) annotation (Line(
      visible=true,
      origin={-34.4439,0.1797},
      points={{19.2272,-7.8471},{41.2272,-7.8471},{41.2272,0.3938},{-40.4545,
          0.3938},{-40.4545,9.4532},{-39.7728,9.4532}},
      color={0,0,127}));
  connect(add31.y, order2_Inputs_Outputs1.vf) annotation (Line(
      visible=true,
  ...
  connect(add32.y, order2_Inputs_Outputs1.pm) annotation (Line(
      ...
      points={{-6.9512,-19.8711},{-3.9512,-19.8711},{-3.9512,10.0574},{-5.0975,
          10.0574},{-5.0975,9.8136},{27.0488,9.8136}},
      color={0,0,127}));

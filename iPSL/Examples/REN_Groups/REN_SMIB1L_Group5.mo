...
model REN_SMIB1L_Group5
  ...
  iPSL.Examples.REN_Groups.Configuration.RGroup5 group5 annotation (Placement(
        transformation(rotation=0, extent={{-56,-10},{-36,10}})));
  inner Electrical.SystemBase SysData(S_b=1000)
    annotation (Placement(transformation(extent={{-76,62},{-52,82}})));
equation
  ...
  connect(group5.p, pwLine.p) annotation (Line(
      ...
      color={0,0,255},
      smooth=Smooth.None));
  connect(pwFault.p, pwLine4.p) annotation (Line(points={{45.3333,-46},{45.3333,
          -46},{36,-46},{36,-20}}, color={0,0,255}));

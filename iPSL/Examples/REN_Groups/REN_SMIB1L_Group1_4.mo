...
model REN_SMIB1L_Group1_4
  ...
  Electrical.Events.PwFault pwFault(R = 0, X = -0.5, t1 = 10, t2 = 10.15) annotation(Placement(transformation(extent = {{45, -58}, {56, -46}})));
  ...
  Electrical.Branches.PwLine2Openings pwLine3(t2 = 100, t1 = 100, G = 0, B = 0, X = 0.05, R = 0.005) annotation(Placement(transformation(extent = {{7, -30}, {27, -10}})));
  ...
  Electrical.Branches.PwLine2Openings pwLine4(t2 = 100, t1 = 100, G = 0, B = 0, R = 0.005, X = 0.05) annotation(Placement(transformation(extent = {{33, -30}, {53, -10}})));
  Electrical.Machines.PSSE.GENCLS.GENCLS gENCLS(X_d = 0.2, D = 0, V_0 = 1, angle_0 = 0, M_b = 1000, H = 4, P_0 = 45.0213, Q_0 = 32.30648) annotation(Placement(transformation(extent = {{105, -10}, {83, 12}})));
...
equation
  ...
  connect(group1_4.p, pwLine.p) annotation(Line(points = {{-63, 0}, {-18, 0}}, color = {0, 0, 255}, smooth = Smooth.None));

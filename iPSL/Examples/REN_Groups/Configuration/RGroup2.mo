...
model RGroup2 "Machine configuration of synchronous machine with regulators: GENSAL, IEEEX1;
  ...
  Electrical.Machines.PSSE.GENSAL.GENSAL gENSAL(V_0 = 1
      "power flow, terminal voltage",                                                   Tpd0 = 4.9629
      "T'do (> 0)",                                                                                                 Tppd0 = 0.05
      "T''do (> 0)",                                                                                                    Tppq0 = 0.15
      ...
      "d-axis transient reactance",                                                                                                    Xl = 0.1341
      "leakage reactance",                                                                                                    S10 = 0.1, S12 = 0.3, w(start = 0), M_b = 1000, angle_0 = 2.172457, P_0 = 400, Q_0 = 19.23391, Xppd = 0.2, Xppq = 0.2) annotation(Placement(transformation(extent = {{-46, -28}, {6, 26}})));
...
equation
  connect(gENSAL.EFD0, iEEEX1.EFD0) annotation(Line(points = {{8.08, -19.9}, {-4, -19.9}, {-4, -36}, {-106, -36}, {-106, -11.1}, {-99.8154, -11.1}}, color = {0, 0, 127}, smooth = Smooth.None));
...
IEEEX1")}), Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}})), Documentation(info = "<html>

...
equation
  connect(cte.y, iEEEX1.VOTHSG) annotation(Line(points = {{-74.5, 14}, {-64, 14}, {-64, -1.83333}, {-57, -1.83333}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(gENROU.EFD0, iEEEX1.EFD0) annotation(Line(points = {{60.08, -19.9}, {64, -19.9}, {64, -42}, {-62, -42}, {-62, -6.5}, {-57, -6.5}}, color = {0, 0, 127}, smooth = Smooth.None));
...
IEEEX1")}), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}})), Documentation(revisions = "<html>
<!--DISCLAIMER-->

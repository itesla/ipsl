...
model RGroup5 "Machine configuration of synchronous machine with regulators: GENSAL, IEEEX1;
  ...
  S_EE_2 = 0.47,
    Ec0=1)
    annotation (Placement(transformation(extent={{-58,-10},{-10,18}})));
...
equation
  ...
  connect(iEEEX1.VUEL, iEEEX1.VOTHSG) annotation (Line(points={{-57.8154,
          ...
          0,127}));
  connect(iEEEX1.EFD, gENROU.EFD) annotation (Line(points={{-9.07692,4},{
          -9.07692,-14.5},{6.52,-14.5}},
                                      color={0,0,127}));
  annotation (Icon(graphics={
        ...
        Text(
          ...
          textString="GENROU & 
IEEEX1")}), Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,
            -100},{100,100}})),

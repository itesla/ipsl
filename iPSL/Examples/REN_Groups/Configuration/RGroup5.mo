...
model RGroup5 "Machine configuration of synchronous machine with regulators: GENSAL, IEEEX1;
  ...
  Electrical.Machines.PSSE.GENROU.GENROU gENROU(
    ...
    P_0=5,
    Q_0=17.8822,
    M_b=40.400001525878906)
    annotation (Placement(transformation(extent={{6,-28},{58,26}})));
  ...
  Modelica.Blocks.Sources.Constant cte(k=0)
    annotation (Placement(transformation(extent={{-85,9},{-75,19}})));
...
equation
  ...
  connect(gENROU.EFD0, iEEEX1.EFD0) annotation (Line(
      ...
      smooth=Smooth.None));
  connect(p, gENROU.p)
    annotation (Line(points={{110,0},{60.6,-1}}, color={0,0,255}));
  connect(gENROU.PMECH, gENROU.PMECH0) annotation (Line(points={{6.52,12.5},{-2,
          12.5},{-2,52},{68,52},{68,-9.1},{60.08,-9.1}}, color={0,0,127}));
  connect(iEEEX1.ECOMP, gENROU.ETERM) annotation (Line(points={{-57.8154,-0.433333},
          {-66,-0.433333},{-66,-46},{72,-46},{72,12.5},{60.08,12.5}}, color={0,
          0,127}));
  ...
  connect(iEEEX1.VUEL, iEEEX1.VOTHSG) annotation (Line(points={{-57.8154,
          4.23333},{-64,4.23333},{-64,13.5667},{-57.8154,13.5667}}, color={0,0,
          127}));
  connect(iEEEX1.EFD, gENROU.EFD) annotation (Line(points={{-9.07692,4},{-9.07692,
          -14.5},{6.52,-14.5}}, color={0,0,127}));
  annotation (

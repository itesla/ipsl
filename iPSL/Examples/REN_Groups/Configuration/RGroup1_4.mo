...
model RGroup1_4 "Machine configuration of synchronous machine with regulators: GENSAL, HYGOV, ESAC1A;
  ...
  iPSL.Electrical.Controls.PSSE.ES.ESAC1A.ESAC1A eSAC1A(
    ...
    V_RMAX=4.0,
    V_RMIN=-4.0)
    annotation (Placement(transformation(extent={{-114,-26},{-80,0}})));
  Modelica.Blocks.Sources.Constant cte(k=0)
    annotation (Placement(transformation(extent={{-143,-25},{-133,-15}})));
  ...
  Modelica.Blocks.Sources.Constant cte1(k=-9999)
    annotation (Placement(transformation(extent={{-143,-41},{-133,-31}})));
  Modelica.Blocks.Sources.Constant cte2(k=9999)
    annotation (Placement(transformation(extent={{-143,-57},{-133,-47}})));
equation
  ...
  connect(gENSAL.XADIFD, eSAC1A.XADIFD) annotation (Line(
      points={{-25.92,-25.3},{-25.92,-44},{-120,-44},{-120,-24.895},{-97.7761,-24.895}},
  ...
  connect(eSAC1A.ECOMP, gENSAL.ETERM) annotation (Line(points={{-113.63,-6.5},{
          -118,-6.5},{-118,-42},{-26,-42},{-26,12.5},{-25.92,12.5}}, color={0,0,
          127}));
  ...
  connect(hYGOV.PMECH, gENSAL.PMECH) annotation (Line(points={{-74.7,14},{-82,
          14},{-82,12.5},{-79.48,12.5}}, color={0,0,127}));

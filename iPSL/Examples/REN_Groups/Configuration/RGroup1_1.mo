...
model RGroup1_1 "Machine configuration of synchronous machine with regulators: GENSAL, ESST1A, HYGOV, IEEEST; 
  ...
  I_LR = 0.0,
    V_0=1)
    annotation (Placement(transformation(extent={{-94,-22},{-60,4}})));
  ...
  Electrical.Controls.PSSE.PSS.IEEEST.IEEEST iEEEST(
    ...
    L_SMIN=-0.05,
    V_CU=0.0,
    V_CL=0.0) annotation (Placement(transformation(extent={{-136,-12},{
            -106,8}})));
...
equation
  ...
  connect(gENSAL.XADIFD,eSST1A. XADIFD) annotation (Line(
      points={{-1.92,-19.3},{-1.92,-38},{-68,-38},{-68,-21.6019},{-69.3196,
          -21.6019}},
      color={0,0,127},
      smooth=Smooth.None));

...
model RGroup1_1 "Machine configuration of synchronous machine with regulators: GENSAL, ESST1A, HYGOV, IEEEST;
  ...
  //
  Electrical.Machines.PSSE.GENSAL.GENSAL gENSAL(Tpd0 = 8.6, Tppd0 = 0.05, Tppq0 = 0.076, H = 2.7, D = 1.0, Xd = 1.11, Xq = 0.74, Xpd = 0.35, Xppd = 0.285, Xppq = 0.285, Xl = 0.21, S10 = 0.11, S12 = 0.4, V_0 = 1, angle_0 = -0.1014632, P_0 = 5, Q_0 = 17.88221, M_b = 80) annotation(Placement(transformation(extent = {{-56, -22}, {-4, 32}})));
  Electrical.Controls.PSSE.TG.HYGOV hYGOV(R = 0.05, r = 0.4, T_r = 5.0, T_f = 0.05, T_g = 0.5, VELM = 0.167, G_MAX = 0.95, G_MIN = 0.0, T_w = 1.42, A_t = 1.4, D_turb = 0.15, q_NL = 0.08) annotation(Placement(transformation(extent = {{-104, 6}, {-48, 34}})));
  Electrical.Controls.PSSE.ES.ESST1A.ESST1A eSST1A(T_R = 0.04, V_IMAX = 0.3, V_IMIN = -0.3, T_C = 2.0, T_B = 10.0, T_C1 = 0.08, T_B1 = 0.083, K_A = 300.0, T_A = 0.001, V_AMAX = 7.0, V_AMIN = -7.0, V_RMAX = 5.2, V_RMIN = -5.2, K_C = 0.38, K_F = 0.0, T_F = 1.0, K_LR = 0.0, I_LR = 0.0, V_0 = 1) annotation(Placement(transformation(extent = {{-94, -22}, {-60, 4}})));
  Modelica.Blocks.Sources.Constant cte(k = 0) annotation(Placement(transformation(extent = {{-119, -33}, {-109, -23}})));
  Electrical.Controls.PSSE.PSS.IEEEST.IEEEST iEEEST(A_1 = 0.0, A_2 = 0.0, A_3 = 0.0, A_4 = 0.0, A_5 = 0.0, A_6 = 0.0, T_1 = 0.0, T_2 = 0.0, T_3 = 0.0, T_4 = 0.0, T_5 = 0.94, T_6 = 0.94, K_S = -2.979, L_SMAX = 0.05, L_SMIN = -0.05, V_CU = 0.0, V_CL = 0.0) annotation(Placement(transformation(extent = {{-136, -12}, {-106, 8}})));
...
equation
  ...
  connect(gENSAL.XADIFD, eSST1A.XADIFD) annotation(Line(points = {{-1.92, -19.3}, {-1.92, -38}, {-68, -38}, {-68, -19.5625}, {-93.2917, -19.5625}}, color = {0, 0, 127}, smooth = Smooth.None));
...
STAB2A &
SCRX &
HYGOV")}), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}})), Documentation(revisions = "<html>
<!--DISCLAIMER-->

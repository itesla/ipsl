...
model RGroup1 "Machine configuration of synchronous machine with regulators: GENSAL, ESST1A, HYGOV, IEEEST; 
  ...
  D_turb = 0.5,
  q_NL = 0.08)
    annotation (Placement(transformation(extent={{6,14},{62,42}})));
  ...
  Connectors.PwPin p annotation (Placement(transformation(rotation=0, extent={{100,-10},
...
equation
  ...
  connect(eSST1A.ECOMP, gENSAL.ETERM) annotation (Line(points={{-71.86,-58.5},{-82,
          -58.5},{-82,-94},{0,-94},{0,18.5},{-1.92,18.5}},        color={0,0,
          127}));
  ...
  connect(eSST1A.XADIFD, gENSAL.XADIFD) annotation (Line(points={{-33.35,-77.3875},
          {-33.35,-86},{-14,-86},{-14,-28},{-1.92,-28},{-1.92,-19.3}},
        color={0,0,127}));
  ...
  connect(gENSAL.PMECH, hYGOV.PMECH) annotation (Line(points={{-55.48,18.5},{-66,
          18.5},{-66,54},{56,54},{56,28},{63.4,28}},              color={0,0,
          127}));
  connect(hYGOV.PMECH0, gENSAL.PMECH0) annotation (Line(points={{6.7,21},{8,21},
          {8,-3.1},{-1.92,-3.1}},              color={0,0,127}));
  connect(gENSAL.SPEED, hYGOV.SPEED) annotation (Line(points={{-1.92,29.3},{12,29.3},
          {12,35},{6.7,35}},                    color={0,0,127}));
  connect(eSST1A.EFD0, gENSAL.EFD0) annotation (Line(points={{-35.6,-36.175},{-35.6,
          -32},{-6,-32},{-6,-13.9},{-1.92,-13.9}},          color={0,0,127}));
  connect(cte2.y, eSST1A.VOEL) annotation (Line(points={{-70.5,-126},{-45.5,
          -126},{-45.5,-80.3}}, color={0,0,127}));
  connect(cte1.y, eSST1A.VUEL2) annotation (Line(points={{-70.5,-108},{-59.36,
          -108},{-59.36,-79.95}}, color={0,0,127}));
  connect(eSST1A.VUEL1, eSST1A.VUEL2) annotation (Line(points={{-65.66,-80},{
...
STAB2A &
SCRX & 
HYGOV")}), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
            -100},{100,100}})),

...
model ImLimiter "Limit the range of a signal.
              2014/03/10"
...
equation
  n1 = if p1 > Ymax then Ymax elseif p1 < Ymin then Ymin else p1;
  annotation(Icon(graphics={  Rectangle(extent = {{-40, 40}, {40, -40}}, lineColor = {0, 0, 255}), Line(points = {{-24, -20}, {-8, -20}, {6, 20}, {22, 20}}, color = {0, 0, 255}, smooth = Smooth.None, thickness = 0.5)}), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics),

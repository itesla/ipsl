...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics={  Rectangle(extent = {{-54, 34}, {12, -28}}, lineColor = {0, 0, 127}), Line(points = {{-54, 20}, {-36, 20}, {-8, 6}, {12, 6}}, color = {0, 0, 127}, smooth = Smooth.None), Line(points = {{-54, -14}, {-38, -14}}, color = {0, 0, 127}, smooth = Smooth.None), Line(points = {{-38, -14}, {-8, 6}}, color = {0, 0, 127}, pattern = LinePattern.Dot, smooth = Smooth.None), Text(extent = {{-22, 24}, {-4, 16}}, lineColor=
              {0,0,255},                                                                                                    pattern=
              LinePattern.Dot,                                                                                                    fillColor=
              {0,0,255},
            fillPattern=FillPattern.Solid,
          textString="y => 0"),                                                                                                    Text(extent = {{-26, -12}, {-8, -20}}, lineColor = {0, 0, 255}, pattern = LinePattern.Dot, fillColor = {0, 0, 255},

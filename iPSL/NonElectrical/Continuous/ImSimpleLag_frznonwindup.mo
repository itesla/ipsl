...
model ImSimpleLag_frznonwindup
  Real ylim;
  Real x;
  parameter Real T;
  parameter Real min "Min limit";
  parameter Real max "Max limit";
  ...
  Modelica.Blocks.Interfaces.RealInput frz annotation(Placement(transformation(extent = {{-6, -7}, {6, 7}}, rotation = -90, origin = {-40, 47})));
initial equation
  x = initValue;
equation

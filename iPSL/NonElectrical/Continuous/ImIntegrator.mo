...
model ImIntegrator "Output the integral of the input signal.
              2014/03/10"
  ...
  output Modelica.Blocks.Interfaces.RealOutput n1(start = nStartValue) annotation(Placement(transformation(extent = {{39, -10}, {59, 10}}), iconTransformation(extent = {{39, -10}, {59, 10}})));

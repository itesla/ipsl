...
model Order4test2_perturbation
  ...
  PowerSystems.Electrical.Branches.PwLine pwLine1(
    ...
    B=0.001/2) annotation (Placement(visible=true, transformation(
        ...
        rotation=0)));
  PowerSystems.Electrical.Events.PwFault pwFault1(R = 20, X = 1, t1 = 10, t2 = 10.1) annotation(Placement(visible = true, transformation(origin = {132.5, -77.3}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
  ...
  PowerSystems.Electrical.Machines.PSAT.FourthOrder.Order4
    order4_Inputs_Outputs(
    V_b=200,
    V_0=1,
    angle_0=0,
    ...
    Sn=370,
    Vn=200)
    annotation (Placement(transformation(extent={{-15,-25},{5,-5}})));
...
equation
  ...
  connect(order4_Inputs_Outputs.p, pwLine2.p) annotation(Line(points={{6,
          -14.9504},{20.5,-14.9504},{20.5,-15.6714},{32.8634,-15.6714}},                                                                         color = {0, 0, 255}, smooth = Smooth.None));
  connect(order4_Inputs_Outputs.vf0, add31.u3) annotation(Line(points={{-13,-4},{10,-4},
          {10,0},{-65,0},{-65,5.9829},{-57,5.9829}},                                                                                          color = {0, 0, 127}, smooth = Smooth.None));
  connect(order4_Inputs_Outputs.pm0, add32.u3) annotation(Line(points={{-13,-26},{10,
          -26},{10,-75},{-65,-75},{-65,-65.0021},{-57,-65.0021}},                                                                                                 color = {0, 0, 127}, smooth = Smooth.None));
  connect(add32.y, order4_Inputs_Outputs.pm) annotation(Line(points={{-34,-57.0021},{
          -30,-57.0021},{-30,-20},{-15,-20}},                                                                                     color = {0, 0, 127}, smooth = Smooth.None));
  connect(add31.y, order4_Inputs_Outputs.vf) annotation(Line(points={{-34,
          13.9829},{-30,13.9829},{-30,-10},{-15,-10}},                                                                                  color = {0, 0, 127}, smooth = Smooth.None));

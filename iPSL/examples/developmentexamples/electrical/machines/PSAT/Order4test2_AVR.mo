...
equation
  ...
  connect(AVRtypeIII1.vf, order4_Inputs_Outputs.vf) annotation(Line(points={{
          -45.6542,-7.4083},{-40,-7.4083},{-40,10},{-10,10}},                                                                                       color = {0, 0, 127}, smooth = Smooth.None));
  connect(order4_Inputs_Outputs.vf0, AVRtypeIII1.vf0) annotation(Line(points={{-8,16},
          {20,16},{20,35},{-80,35},{-80,-10.4083},{-68.6542,-10.4083}},                                                                                          color = {0, 0, 127}, smooth = Smooth.None));
  connect(order4_Inputs_Outputs.v, AVRtypeIII1.v) annotation(Line(points={{11,8},{
          25,8},{25,25},{-75,25},{-75,-2.4083},{-68.6542,-2.4083}},                                                                                                  color = {0, 0, 127}, smooth = Smooth.None));
  connect(order4_Inputs_Outputs.pm0, order4_Inputs_Outputs.pm) annotation(Line(points={{-8,-6},
          {30,-6},{30,-10},{-20,-10},{-20,0},{-10,0}},                                                                                                    color = {0, 0, 127}, smooth = Smooth.None));
  connect(order4_Inputs_Outputs.p, pwLine2.p) annotation(Line(points={{11,
          5.04964},{20,5.04964},{20,-15.6714},{32.8634,-15.6714}},                                                                          color = {0, 0, 255}, smooth = Smooth.None));

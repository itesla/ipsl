...
equation
  ...
  connect(gENSAL.EFD0,sCRX. EFD0) annotation (Line(
      points={{-1.92,-13.9},{-6,-13.9},{-6,-30},{-92,-30},{-92,-17.53},{
          -93.8583,-17.53}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(gENSAL.ETERM,sCRX. ETERM) annotation (Line(
      points={{-1.92,18.5},{-10,18.5},{-10,-34},{-94,-34},{-94,-12.98},{
          -94.1417,-12.98}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(gENSAL.XADIFD,sCRX. XADIFD) annotation (Line(
      points={{-1.92,-19.3},{-1.92,-38},{-96,-38},{-96,-8.69},{-94.1417,
          -8.69}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(sCRX.ECOMP,sCRX. ETERM) annotation (Line(
      points={{-93.8583,4.31},{-106,4.31},{-106,46},{0,46},{0,18},{-10,18},
          {-10,-34},{-94,-34},{-94,-12.98},{-94.1417,-12.98}},
      color={0,0,127},
      smooth=Smooth.None));

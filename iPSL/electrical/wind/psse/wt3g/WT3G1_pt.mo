...
protected
  ...
  Modelica.Blocks.Interfaces.RealInput Eqcmd=Eqcmd0
   annotation (Placement(transformation(extent={{-120,54},{-82,92}}),
      iconTransformation(extent={{-116,26},{-96,46}})));
...
public
  Modelica.Blocks.Interfaces.RealOutput V=VT
    annotation (Placement(transformation(extent={{108,-30},{126,-12}}),
        iconTransformation(extent={{108,-30},{126,-12}})));
...
public
  Modelica.Blocks.Interfaces.RealOutput Q
    annotation (Placement(transformation(extent={{100,-88},{118,-70}}),
        iconTransformation(extent={{108,-2},{126,16}})));
public

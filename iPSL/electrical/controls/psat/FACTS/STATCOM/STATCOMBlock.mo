...
model STATCOMBlock
  "Static Synchronous Compensator model with Modelica components"
  ...
  Modelica.Blocks.Math.Gain gain( k=Kr)
    annotation (Placement(transformation(extent={{-52,-10},{-32,10}})));
  Modelica.Blocks.Continuous.TransferFunction transferFunction(a={Tr,1},
    initType=Modelica.Blocks.Types.Init.InitialState,
    y_start=io,
    b={1})
    annotation (Placement(transformation(extent={{-8,-10},{12,10}})));
  Modelica.Blocks.Nonlinear.Limiter limiter( uMax=i_max, uMin=i_min,
    limitsAtInit=true)
    annotation (Placement(transformation(extent={{36,-10},{56,10}})));
  Modelica.Blocks.Interfaces.RealOutput i_SH "STATCOM current (pu)"
    annotation (Placement(transformation(extent={{70,-10},{90,10}})));

  Modelica.Blocks.Interfaces.RealInput v=volt "Bus voltage magnitude (pu)"
    annotation (Placement(visible=false,transformation(extent={{-140,-20},{-100,20}}),
...
public
  Modelica.Blocks.Interfaces.RealInput vs_POD "POD signal (pu)"
  ...
  connect(const.y, add3_1.u1) annotation (Line(points={{-107,34},{-100,34},{-100,8},{-92,8}}, color={0,0,127}));
    ...
    Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,
        ...
        Line(
          ...
          smooth=Smooth.None),
        Line(
          points={{-98,4},{-98,24},{-60,24},{-60,-26},{-96,-26},{-98,
              -26},{-98,-8},{-98,-8}},
          color={255,0,0},
          thickness=0.5,
          smooth=Smooth.None)}),

...
public
  ...
  iPSL.NonElectrical.Math.ImSum4 imSum4_1(
    ...
    a2=-1,
    a3=1,
    a4=1) annotation (Placement(transformation(extent={{-56,-14},{-20,26}})));
  ...
  Modelica.Blocks.Interfaces.RealInput EFD0
        ...
        extent={{-17,-17},{17,17}},
        rotation=90,
        origin={-59,-185}), iconTransformation(extent={{-17,-17},{17,17}},
          origin={-121,-161})));
  ...
  iPSL.NonElectrical.Continuous.ImIntegratornonwindup VR1(
    ...
    K=K_IR,
    nStartValue=Efd0*K_G)
    annotation (Placement(transformation(extent={{-26,-38},{20,6}})));
  ...
  iPSL.NonElectrical.Continuous.ImIntegratornonwindup VM1(
    ...
    Ymax=V_MMAX/K_PM,
    Ymin=V_MMIN/K_PM,
    K=K_IR) annotation (Placement(transformation(extent={{148,-42},{194,2}})));
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax=V_RMAX, uMin=V_RMIN)
    annotation (Placement(transformation(extent={{230,2},{250,22}})));
  Modelica.Blocks.Math.Add add2
    annotation (Placement(transformation(extent={{210,6},{222,18}})));
  VE vE annotation (Placement(transformation(extent={{-14,-94},{50,-58}})));
  ...
  Sensors.PwVoltageCurrent
                   pwVoltageCurrent
    annotation (Placement(transformation(extent={{-98,-118},{-34,-18}})));
  iPSL.Connectors.PwPin Gen_terminal(
    vr(start=Vr0),
    vi(start=Vi0),
    ir(start=Ir0),
    ii(start=Ii0)) annotation (Placement(transformation(extent={{-94,38},{-74,
            58}}), iconTransformation(extent={{-94,38},{-74,58}})));
  iPSL.Connectors.PwPin Bus annotation (Placement(transformation(extent={{204,
            38},{224,58}}), iconTransformation(extent={{204,38},{224,58}})));
protected
...
equation
  connect(ECOMP,Vm.p1) annotation (Line(
      points={{-119,-35},{-94,-35},{-94,9},{-78.82,9}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(VOTHSG, imSum4_1.p1) annotation (Line(
      points={{-119,13},{-94,13},{-94,12.4},{-47.18,12.4}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(Vm.n1, imSum4_1.p2) annotation (Line(
      points={{-56.6,9},{-55.61,9},{-55.61,7.6},{-47.18,7.6}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(V_REF.y, imSum4_1.p3) annotation (Line(
      points={{-67.4,-12},{-58,-12},{-58,3.2},{-47.18,3.2}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(XADIFD, iN.IFD) annotation (Line(
      points={{-119,-141},{-92.5,-141},{-92.5,-140.98},{47.68,-140.98}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(VUEL, imSum4_1.p4) annotation (Line(
      points={{-123,-77},{-90,-77},{-90,-1.2},{-47.18,-1.2}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(VR1.n0, add.u2) annotation (Line(
      points={{8.27,-16},{24,-16},{24,0.4},{32.8,0.4}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(Gain1.u, imSum4_1.n1) annotation (Line(
      points={{-14,22},{-30,22},{-30,6},{-29.18,6}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(VR1.p1, imSum4_1.n1) annotation (Line(
      points={{-14.73,-16},{-30,-16},{-30,6},{-29.18,6}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(VM1.n0, add2.u2) annotation (Line(
      points={{182.27,-20},{198,-20},{198,8.4},{208.8,8.4}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(add2.y, limiter1.u) annotation (Line(
      points={{222.6,12},{228,12}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(VM1.p1, add1.y) annotation (Line(
      points={{159.27,-20},{142,-20},{142,7},{138.5,7}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(vE.VE, product1.u1) annotation (Line(
      points={{56.4,-75.64},{81.2,-75.64},{81.2,-74.8},{144.6,-74.8}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(iN.VE, vE.VE) annotation (Line(
      points={{47.68,-129.48},{16,-129.48},{16,-104},{56.4,-104},{56.4,-75.64}},
      color={0,0,127},
      smooth=Smooth.None));
